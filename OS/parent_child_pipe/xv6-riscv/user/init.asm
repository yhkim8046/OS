...
main(void)
{
  ...
  12:	87a50513          	add	a0,a0,-1926 # 888 <malloc+0x104>
  ...
  3a:	85a90913          	add	s2,s2,-1958 # 890 <malloc+0x10c>
  3e:	854a                	mv	a0,s2
  ...
  6e:	87650513          	add	a0,a0,-1930 # 8e0 <malloc+0x15c>
  ...
  8c:	80050513          	add	a0,a0,-2048 # 888 <malloc+0x104>
  90:	00000097          	auipc	ra,0x0
  94:	31c080e7          	jalr	796(ra) # 3ac <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00000517          	auipc	a0,0x0
  9e:	7ee50513          	add	a0,a0,2030 # 888 <malloc+0x104>
  a2:	00000097          	auipc	ra,0x0
  a6:	302080e7          	jalr	770(ra) # 3a4 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00000517          	auipc	a0,0x0
  b0:	7fc50513          	add	a0,a0,2044 # 8a8 <malloc+0x124>
  ...
  ca:	8b258593          	add	a1,a1,-1870 # 978 <argv>
  ce:	00000517          	auipc	a0,0x0
  d2:	7f250513          	add	a0,a0,2034 # 8c0 <malloc+0x13c>
  d6:	00000097          	auipc	ra,0x0
  da:	2c6080e7          	jalr	710(ra) # 39c <exec>
      printf("init: exec sh failed\n");
  de:	00000517          	auipc	a0,0x0
  e2:	7ea50513          	add	a0,a0,2026 # 8c8 <malloc+0x144>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 448:	51c50513          	add	a0,a0,1308 # 960 <digits>
 44c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 54e:	3be70713          	add	a4,a4,958 # 908 <malloc+0x184>
 ...
 5da:	38ab8b93          	add	s7,s7,906 # 960 <digits>
 ...
 630:	2d490913          	add	s2,s2,724 # 900 <malloc+0x17c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7d4:	1b890913          	add	s2,s2,440 # 988 <freep>
  if(p == (char*)-1)
 7d8:	5afd                	li	s5,-1
 ...
 7e8:	1ac78793          	add	a5,a5,428 # 990 <base>
