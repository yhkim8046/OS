...
000000000000011a <grep>:
{
 ...
 140:	9b4a8a93          	add	s5,s5,-1612 # af0 <buf>
 ...
 1ba:	93a50513          	add	a0,a0,-1734 # af0 <buf>
...
00000000000001ec <main>:
{
 ...
 25e:	7de58593          	add	a1,a1,2014 # a38 <malloc+0x102>
 262:	4509                	li	a0,2
 ...
 294:	7c850513          	add	a0,a0,1992 # a58 <malloc+0x122>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 5fa:	4da50513          	add	a0,a0,1242 # ad0 <digits>
 5fe:	883a                	mv	a6,a4
 600:	2705                	addw	a4,a4,1
 602:	02c5f7bb          	remuw	a5,a1,a2
 606:	1782                	sll	a5,a5,0x20
 608:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6ec:	f9d9079b          	addw	a5,s2,-99
 6f0:	0ff7f713          	zext.b	a4,a5
 6f4:	12eb6163          	bltu	s6,a4,816 <vprintf+0x192>
 6f8:	00271793          	sll	a5,a4,0x2
 6fc:	00000717          	auipc	a4,0x0
 700:	37c70713          	add	a4,a4,892 # a78 <malloc+0x142>
 ...
 78c:	348b8b93          	add	s7,s7,840 # ad0 <digits>
 ...
 7e2:	29290913          	add	s2,s2,658 # a70 <malloc+0x13a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 940:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 942:	02051493          	sll	s1,a0,0x20
 946:	9081                	srl	s1,s1,0x20
 948:	04bd                	add	s1,s1,15
 94a:	8091                	srl	s1,s1,0x4
 94c:	0014899b          	addw	s3,s1,1
 950:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
 ...
 986:	16690913          	add	s2,s2,358 # ae8 <freep>
  if(p == (char*)-1)
 98a:	5afd                	li	s5,-1
 ...
 99a:	55a78793          	add	a5,a5,1370 # ef0 <base>
 ...
 a04:	c798                	sw	a4,8(a5)
        p += p->s.size;
 a06:	02071693          	sll	a3,a4,0x20
 a0a:	01c6d713          	srl	a4,a3,0x1c
