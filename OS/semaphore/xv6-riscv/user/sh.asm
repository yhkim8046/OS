...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "(xv6) $ ");
      ...
      14:	30058593          	add	a1,a1,768 # 1310 <malloc+0x104>
      18:	4509                	li	a0,2
      1a:	00001097          	auipc	ra,0x1
      1e:	10c080e7          	jalr	268(ra) # 1126 <fprintf>
  memset(buf, 0, nbuf);
      22:	864a                	mv	a2,s2
      24:	4581                	li	a1,0
      26:	8526                	mv	a0,s1
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2c258593          	add	a1,a1,706 # 1320 <malloc+0x114>
      66:	4509                	li	a0,2
      68:	00001097          	auipc	ra,0x1
      6c:	0be080e7          	jalr	190(ra) # 1126 <fprintf>
  exit(1);
      70:	4505                	li	a0,1
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	29050513          	add	a0,a0,656 # 1328 <malloc+0x11c>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	36470713          	add	a4,a4,868 # 1428 <malloc+0x21c>
    ...
    panic("runcmd");
      ...
      e4:	25050513          	add	a0,a0,592 # 1330 <malloc+0x124>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	23658593          	add	a1,a1,566 # 1338 <malloc+0x12c>
     10a:	4509                	li	a0,2
     10c:	00001097          	auipc	ra,0x1
     110:	01a080e7          	jalr	26(ra) # 1126 <fprintf>
  exit(0);
     114:	4501                	li	a0,0
    ...
    runcmd(rcmd->cmd);
     ...
     152:	1fa58593          	add	a1,a1,506 # 1348 <malloc+0x13c>
     156:	4509                	li	a0,2
     158:	00001097          	auipc	ra,0x1
     15c:	fce080e7          	jalr	-50(ra) # 1126 <fprintf>
      exit(1);
     160:	4505                	li	a0,1
    ...
    if(fork1() == 0){
     ...
     1e8:	17450513          	add	a0,a0,372 # 1358 <malloc+0x14c>
...
execcmd(void)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     28a:	f86080e7          	jalr	-122(ra) # 120c <malloc>
     28e:	84aa                	mv	s1,a0
...
redircmd(struct cmd *subcmd, char *file, char *efile, int mode, int fd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     2d4:	f3c080e7          	jalr	-196(ra) # 120c <malloc>
     2d8:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
...
pipecmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     32e:	ee2080e7          	jalr	-286(ra) # 120c <malloc>
     332:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     334:	4661                	li	a2,24
     336:	4581                	li	a1,0
...
listcmd(struct cmd *left, struct cmd *right)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     374:	e9c080e7          	jalr	-356(ra) # 120c <malloc>
     378:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     37a:	4661                	li	a2,24
     37c:	4581                	li	a1,0
...
backcmd(struct cmd *subcmd)
{
  ...
  cmd = malloc(sizeof(*cmd));
     ...
     3b6:	e5a080e7          	jalr	-422(ra) # 120c <malloc>
     3ba:	84aa                	mv	s1,a0
  memset(cmd, 0, sizeof(*cmd));
     3bc:	4641                	li	a2,16
     3be:	4581                	li	a1,0
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	0d498993          	add	s3,s3,212 # 14d0 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	06e98993          	add	s3,s3,110 # 14d0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	00298993          	add	s3,s3,2 # 14d0 <whitespace>
     4d6:	00001a97          	auipc	s5,0x1
     4da:	ff2a8a93          	add	s5,s5,-14 # 14c8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	f8c98993          	add	s3,s3,-116 # 14d0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b6:	dcea8a93          	add	s5,s5,-562 # 1380 <malloc+0x174>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c8:	d9c50513          	add	a0,a0,-612 # 1360 <malloc+0x154>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	cec60613          	add	a2,a2,-788 # 1388 <malloc+0x17c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6dc:	cd0b0b13          	add	s6,s6,-816 # 13a8 <malloc+0x19c>
  ...
  return ret;
     ...
     70a:	c8a50513          	add	a0,a0,-886 # 1390 <malloc+0x184>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c3050513          	add	a0,a0,-976 # 1398 <malloc+0x18c>
...
0000000000000792 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b2:	c0260613          	add	a2,a2,-1022 # 13b0 <malloc+0x1a4>
     7b6:	85ce                	mv	a1,s3
     7b8:	854a                	mv	a0,s2
...
0000000000000800 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     822:	b9aa0a13          	add	s4,s4,-1126 # 13b8 <malloc+0x1ac>
  ...
  if(peek(ps, es, ";")){
     ...
     858:	b6c60613          	add	a2,a2,-1172 # 13c0 <malloc+0x1b4>
     85c:	85ce                	mv	a1,s3
     85e:	854a                	mv	a0,s2
...
00000000000008a8 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8be:	ace60613          	add	a2,a2,-1330 # 1388 <malloc+0x17c>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ee:	aee60613          	add	a2,a2,-1298 # 13d8 <malloc+0x1cc>
     8f2:	85ca                	mv	a1,s2
     8f4:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96c:	ad870713          	add	a4,a4,-1320 # 1440 <malloc+0x234>
...
00000000000009e4 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a18:	90460613          	add	a2,a2,-1788 # 1318 <malloc+0x10c>
     a1c:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4e:	9ae58593          	add	a1,a1,-1618 # 13f8 <malloc+0x1ec>
     a52:	4509                	li	a0,2
     a54:	00000097          	auipc	ra,0x0
     a58:	6d2080e7          	jalr	1746(ra) # 1126 <fprintf>
    panic("syntax");
     a5c:	00001517          	auipc	a0,0x1
     a60:	93450513          	add	a0,a0,-1740 # 1390 <malloc+0x184>
...
0000000000000a6c <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	98c48493          	add	s1,s1,-1652 # 1408 <malloc+0x1fc>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	a3e48493          	add	s1,s1,-1474 # 14e0 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	9eaa0a13          	add	s4,s4,-1558 # 14e0 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b1a:	9cd50513          	add	a0,a0,-1587 # 14e3 <buf.0+0x3>
     b1e:	00000097          	auipc	ra,0x0
     b22:	326080e7          	jalr	806(ra) # e44 <chdir>
     b26:	fa0551e3          	bgez	a0,ac8 <main+0x5c>
        fprintf(2, "cannot cd %s\n", buf+3);
     b2a:	00001617          	auipc	a2,0x1
     b2e:	9b960613          	add	a2,a2,-1607 # 14e3 <buf.0+0x3>
     b32:	00001597          	auipc	a1,0x1
     b36:	8de58593          	add	a1,a1,-1826 # 1410 <malloc+0x204>
     b3a:	4509                	li	a0,2
     b3c:	00000097          	auipc	ra,0x0
     b40:	5ea080e7          	jalr	1514(ra) # 1126 <fprintf>
     b44:	b751                	j	ac8 <main+0x5c>
      runcmd(parsecmd(buf));
     b46:	00001517          	auipc	a0,0x1
     b4a:	99a50513          	add	a0,a0,-1638 # 14e0 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  neg = 0;
  if(sgn && xx < 0){
     eba:	c299                	beqz	a3,ec0 <printint+0x12>
     ebc:	0805cb63          	bltz	a1,f52 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ed0:	5e450513          	add	a0,a0,1508 # 14b0 <digits>
     ed4:	883a                	mv	a6,a4
     ...
     ef4:	fec7f0e3          	bgeu	a5,a2,ed4 <printint+0x26>
  if(neg)
     ef8:	00088c63          	beqz	a7,f10 <printint+0x62>
    buf[i++] = '-';
  ...
  while(--i >= 0)
     f10:	02e05c63          	blez	a4,f48 <printint+0x9a>
     f14:	f04a                	sd	s2,32(sp)
     f16:	ec4e                	sd	s3,24(sp)
     f18:	fc040793          	add	a5,s0,-64
     f1c:	00e78933          	add	s2,a5,a4
     f20:	fff78993          	add	s3,a5,-1
     f24:	99ba                	add	s3,s3,a4
     f26:	377d                	addw	a4,a4,-1
     f28:	1702                	sll	a4,a4,0x20
     f2a:	9301                	srl	a4,a4,0x20
...
{
     f5a:	715d                	add	sp,sp,-80
     f5c:	e486                	sd	ra,72(sp)
     f5e:	e0a2                	sd	s0,64(sp)
     f60:	f84a                	sd	s2,48(sp)
     f62:	0880                	add	s0,sp,80
  char *s;
  int c, i, state;
  ...
  for(i = 0; fmt[i]; i++){
     ...
     f68:	1a090a63          	beqz	s2,111c <vprintf+0x1c2>
  ...
  state = 0;
     ...
     f86:	4b55                	li	s6,21
     f88:	a839                	j	fa6 <vprintf+0x4c>
        putc(fd, c);
     f8a:	85ca                	mv	a1,s2
     f8c:	8556                	mv	a0,s5
     f8e:	00000097          	auipc	ra,0x0
     f92:	efe080e7          	jalr	-258(ra) # e8c <putc>
     f96:	a019                	j	f9c <vprintf+0x42>
    } else if(state == '%'){
     f98:	01498d63          	beq	s3,s4,fb2 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
     f9c:	0485                	add	s1,s1,1
     f9e:	fff4c903          	lbu	s2,-1(s1)
     fa2:	16090763          	beqz	s2,1110 <vprintf+0x1b6>
    if(state == 0){
     fa6:	fe0999e3          	bnez	s3,f98 <vprintf+0x3e>
      if(c == '%'){
     faa:	ff4910e3          	bne	s2,s4,f8a <vprintf+0x30>
        state = '%';
     fae:	89d2                	mv	s3,s4
     fb0:	b7f5                	j	f9c <vprintf+0x42>
      if(c == 'd'){
     fb2:	13490463          	beq	s2,s4,10da <vprintf+0x180>
     fb6:	f9d9079b          	addw	a5,s2,-99
     fba:	0ff7f793          	zext.b	a5,a5
     fbe:	12fb6763          	bltu	s6,a5,10ec <vprintf+0x192>
     fc2:	f9d9079b          	addw	a5,s2,-99
     fc6:	0ff7f713          	zext.b	a4,a5
     fca:	12eb6163          	bltu	s6,a4,10ec <vprintf+0x192>
     fce:	00271793          	sll	a5,a4,0x2
     fd2:	00000717          	auipc	a4,0x0
     fd6:	48670713          	add	a4,a4,1158 # 1458 <malloc+0x24c>
     ...
     ff4:	ebe080e7          	jalr	-322(ra) # eae <printint>
     ff8:	8bca                	mv	s7,s2
      } else {
    ...
    1010:	ea2080e7          	jalr	-350(ra) # eae <printint>
    1014:	8bca                	mv	s7,s2
      state = 0;
    1016:	4981                	li	s3,0
    1018:	b751                	j	f9c <vprintf+0x42>
    ...
    102c:	e86080e7          	jalr	-378(ra) # eae <printint>
    1030:	8bca                	mv	s7,s2
      state = 0;
    1032:	4981                	li	s3,0
    1034:	b7a5                	j	f9c <vprintf+0x42>
    1036:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    1038:	008b8c13          	add	s8,s7,8
    103c:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    1040:	03000593          	li	a1,48
    1044:	8556                	mv	a0,s5
    1046:	00000097          	auipc	ra,0x0
    104a:	e46080e7          	jalr	-442(ra) # e8c <putc>
  putc(fd, 'x');
    104e:	07800593          	li	a1,120
    1052:	8556                	mv	a0,s5
    1054:	00000097          	auipc	ra,0x0
    1058:	e38080e7          	jalr	-456(ra) # e8c <putc>
    105c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    105e:	00000b97          	auipc	s7,0x0
    1062:	452b8b93          	add	s7,s7,1106 # 14b0 <digits>
    1066:	03c9d793          	srl	a5,s3,0x3c
    106a:	97de                	add	a5,a5,s7
    106c:	0007c583          	lbu	a1,0(a5)
    1070:	8556                	mv	a0,s5
    1072:	00000097          	auipc	ra,0x0
    1076:	e1a080e7          	jalr	-486(ra) # e8c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    107a:	0992                	sll	s3,s3,0x4
    107c:	397d                	addw	s2,s2,-1
    107e:	fe0914e3          	bnez	s2,1066 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    1082:	8be2                	mv	s7,s8
      state = 0;
    1084:	4981                	li	s3,0
    1086:	6c02                	ld	s8,0(sp)
    1088:	bf11                	j	f9c <vprintf+0x42>
        s = va_arg(ap, char*);
    108a:	008b8993          	add	s3,s7,8
    108e:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    1092:	02090163          	beqz	s2,10b4 <vprintf+0x15a>
        while(*s != 0){
    1096:	00094583          	lbu	a1,0(s2)
    109a:	c9a5                	beqz	a1,110a <vprintf+0x1b0>
          putc(fd, *s);
    109c:	8556                	mv	a0,s5
    109e:	00000097          	auipc	ra,0x0
    10a2:	dee080e7          	jalr	-530(ra) # e8c <putc>
          s++;
    10a6:	0905                	add	s2,s2,1
        while(*s != 0){
    10a8:	00094583          	lbu	a1,0(s2)
    10ac:	f9e5                	bnez	a1,109c <vprintf+0x142>
        s = va_arg(ap, char*);
    10ae:	8bce                	mv	s7,s3
      state = 0;
    10b0:	4981                	li	s3,0
    10b2:	b5ed                	j	f9c <vprintf+0x42>
          s = "(null)";
    10b4:	00000917          	auipc	s2,0x0
    10b8:	36c90913          	add	s2,s2,876 # 1420 <malloc+0x214>
        while(*s != 0){
    10bc:	02800593          	li	a1,40
    10c0:	bff1                	j	109c <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    10c2:	008b8913          	add	s2,s7,8
    10c6:	000bc583          	lbu	a1,0(s7)
    10ca:	8556                	mv	a0,s5
    10cc:	00000097          	auipc	ra,0x0
    10d0:	dc0080e7          	jalr	-576(ra) # e8c <putc>
    10d4:	8bca                	mv	s7,s2
      state = 0;
    10d6:	4981                	li	s3,0
    10d8:	b5d1                	j	f9c <vprintf+0x42>
        putc(fd, c);
    10da:	02500593          	li	a1,37
    10de:	8556                	mv	a0,s5
    10e0:	00000097          	auipc	ra,0x0
    10e4:	dac080e7          	jalr	-596(ra) # e8c <putc>
      state = 0;
    10e8:	4981                	li	s3,0
    10ea:	bd4d                	j	f9c <vprintf+0x42>
        putc(fd, '%');
    10ec:	02500593          	li	a1,37
    10f0:	8556                	mv	a0,s5
    10f2:	00000097          	auipc	ra,0x0
    10f6:	d9a080e7          	jalr	-614(ra) # e8c <putc>
        putc(fd, c);
    10fa:	85ca                	mv	a1,s2
    10fc:	8556                	mv	a0,s5
    10fe:	00000097          	auipc	ra,0x0
    1102:	d8e080e7          	jalr	-626(ra) # e8c <putc>
      state = 0;
    1106:	4981                	li	s3,0
    1108:	bd51                	j	f9c <vprintf+0x42>
        s = va_arg(ap, char*);
    110a:	8bce                	mv	s7,s3
      state = 0;
    110c:	4981                	li	s3,0
    110e:	b579                	j	f9c <vprintf+0x42>
    ...
    1122:	6161                	add	sp,sp,80
    1124:	8082                	ret

0000000000001126 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    1126:	715d                	add	sp,sp,-80
    1128:	ec06                	sd	ra,24(sp)
    112a:	e822                	sd	s0,16(sp)
    112c:	1000                	add	s0,sp,32
    112e:	e010                	sd	a2,0(s0)
    1130:	e414                	sd	a3,8(s0)
    1132:	e818                	sd	a4,16(s0)
    1134:	ec1c                	sd	a5,24(s0)
    1136:	03043023          	sd	a6,32(s0)
    113a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    113e:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    1142:	8622                	mv	a2,s0
    1144:	00000097          	auipc	ra,0x0
    1148:	e16080e7          	jalr	-490(ra) # f5a <vprintf>
}
...
0000000000001154 <printf>:

void
printf(const char *fmt, ...)
{
    1154:	711d                	add	sp,sp,-96
    1156:	ec06                	sd	ra,24(sp)
    1158:	e822                	sd	s0,16(sp)
    115a:	1000                	add	s0,sp,32
    115c:	e40c                	sd	a1,8(s0)
    115e:	e810                	sd	a2,16(s0)
    1160:	ec14                	sd	a3,24(s0)
    1162:	f018                	sd	a4,32(s0)
    1164:	f41c                	sd	a5,40(s0)
    1166:	03043823          	sd	a6,48(s0)
    116a:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    116e:	00840613          	add	a2,s0,8
    1172:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    1176:	85aa                	mv	a1,a0
    1178:	4505                	li	a0,1
    117a:	00000097          	auipc	ra,0x0
    117e:	de0080e7          	jalr	-544(ra) # f5a <vprintf>
}
    1182:	60e2                	ld	ra,24(sp)
    1184:	6442                	ld	s0,16(sp)
    1186:	6125                	add	sp,sp,96
    1188:	8082                	ret

000000000000118a <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    118a:	1141                	add	sp,sp,-16
    118c:	e422                	sd	s0,8(sp)
    118e:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1190:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    1194:	00000797          	auipc	a5,0x0
    1198:	3447b783          	ld	a5,836(a5) # 14d8 <freep>
    119c:	a02d                	j	11c6 <free+0x3c>
  ...
  if(p + p->s.size == bp){
    ...
    11b8:	a091                	j	11fc <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11ba:	6398                	ld	a4,0(a5)
    11bc:	00e7e463          	bltu	a5,a4,11c4 <free+0x3a>
    11c0:	00e6ea63          	bltu	a3,a4,11d4 <free+0x4a>
{
    11c4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    11c6:	fed7fae3          	bgeu	a5,a3,11ba <free+0x30>
    11ca:	6398                	ld	a4,0(a5)
    11cc:	00e6e463          	bltu	a3,a4,11d4 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    11d0:	fee7eae3          	bltu	a5,a4,11c4 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    11d4:	ff852583          	lw	a1,-8(a0)
    11d8:	6390                	ld	a2,0(a5)
    11da:	02059813          	sll	a6,a1,0x20
    11de:	01c85713          	srl	a4,a6,0x1c
    11e2:	9736                	add	a4,a4,a3
    11e4:	fae60de3          	beq	a2,a4,119e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    11e8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    11ec:	4790                	lw	a2,8(a5)
    11ee:	02061593          	sll	a1,a2,0x20
    11f2:	01c5d713          	srl	a4,a1,0x1c
    11f6:	973e                	add	a4,a4,a5
    11f8:	fae68ae3          	beq	a3,a4,11ac <free+0x22>
    p->s.ptr = bp->s.ptr;
    11fc:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    11fe:	00000717          	auipc	a4,0x0
    1202:	2cf73d23          	sd	a5,730(a4) # 14d8 <freep>
}
    1206:	6422                	ld	s0,8(sp)
    1208:	0141                	add	sp,sp,16
    120a:	8082                	ret

000000000000120c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    ...
    1216:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1218:	02051493          	sll	s1,a0,0x20
    121c:	9081                	srl	s1,s1,0x20
    121e:	04bd                	add	s1,s1,15
    1220:	8091                	srl	s1,s1,0x4
    1222:	0014899b          	addw	s3,s1,1
    1226:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    1228:	00000517          	auipc	a0,0x0
    122c:	2b053503          	ld	a0,688(a0) # 14d8 <freep>
    1230:	c915                	beqz	a0,1264 <malloc+0x58>
    base.s.ptr = freep = prevp = &base;
    base.s.size = 0;
  }
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    1232:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    1234:	4798                	lw	a4,8(a5)
    1236:	08977e63          	bgeu	a4,s1,12d2 <malloc+0xc6>
  ...
  if(nu < 4096)
    1242:	8a4e                	mv	s4,s3
    1244:	0009871b          	sext.w	a4,s3
    1248:	6685                	lui	a3,0x1
    124a:	00d77363          	bgeu	a4,a3,1250 <malloc+0x44>
    124e:	6a05                	lui	s4,0x1
    1250:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    1254:	004a1a1b          	sllw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    125c:	28090913          	add	s2,s2,640 # 14d8 <freep>
  if(p == (char*)-1)
    1260:	5afd                	li	s5,-1
    1262:	a091                	j	12a6 <malloc+0x9a>
    ...
    1270:	2dc78793          	add	a5,a5,732 # 1548 <base>
    1274:	00000717          	auipc	a4,0x0
    1278:	26f73223          	sd	a5,612(a4) # 14d8 <freep>
    127c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    127e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    1282:	b7c1                	j	1242 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    1284:	6398                	ld	a4,0(a5)
    1286:	e118                	sd	a4,0(a0)
    1288:	a08d                	j	12ea <malloc+0xde>
  hp->s.size = nu;
    128a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    128e:	0541                	add	a0,a0,16
    1290:	00000097          	auipc	ra,0x0
    1294:	efa080e7          	jalr	-262(ra) # 118a <free>
  return freep;
    1298:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    129c:	c13d                	beqz	a0,1302 <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    129e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    12a0:	4798                	lw	a4,8(a5)
    12a2:	02977463          	bgeu	a4,s1,12ca <malloc+0xbe>
    if(p == freep)
    12a6:	00093703          	ld	a4,0(s2)
    12aa:	853e                	mv	a0,a5
    12ac:	fef719e3          	bne	a4,a5,129e <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    12b0:	8552                	mv	a0,s4
    12b2:	00000097          	auipc	ra,0x0
    12b6:	baa080e7          	jalr	-1110(ra) # e5c <sbrk>
  if(p == (char*)-1)
    12ba:	fd5518e3          	bne	a0,s5,128a <malloc+0x7e>
        return 0;
    12be:	4501                	li	a0,0
