...
forktest(void)
{
  ...
  3e:	40650513          	add	a0,a0,1030 # 440 <rwsematest+0xe>
  ...
  68:	42c50513          	add	a0,a0,1068 # 490 <rwsematest+0x5e>
  ...
  8a:	3ca50513          	add	a0,a0,970 # 450 <rwsematest+0x1e>
  ...
  a4:	3c850513          	add	a0,a0,968 # 468 <rwsematest+0x36>
  ...
  e4:	3a050513          	add	a0,a0,928 # 480 <rwsematest+0x4e>
