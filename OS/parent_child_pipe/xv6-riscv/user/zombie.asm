...
printint(int fd, int xx, int base, int sgn)
{
 ...
 37a:	4a250513          	add	a0,a0,1186 # 818 <digits>
 37e:	883a                	mv	a6,a4
 380:	2705                	addw	a4,a4,1
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 50c:	310b8b93          	add	s7,s7,784 # 818 <digits>
 ...
 562:	25a90913          	add	s2,s2,602 # 7b8 <malloc+0x102>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 6c0:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
 6c2:	02051493          	sll	s1,a0,0x20
 6c6:	9081                	srl	s1,s1,0x20
 6c8:	04bd                	add	s1,s1,15
 6ca:	8091                	srl	s1,s1,0x4
 6cc:	0014899b          	addw	s3,s1,1
 ...
 706:	12e90913          	add	s2,s2,302 # 830 <freep>
  if(p == (char*)-1)
 70a:	5afd                	li	s5,-1
 ...
 71a:	12278793          	add	a5,a5,290 # 838 <base>
 ...
 784:	c798                	sw	a4,8(a5)
        p += p->s.size;
 786:	02071693          	sll	a3,a4,0x20
 78a:	01c6d713          	srl	a4,a3,0x1c
