...
wc(int fd, char *name)
{
  ...
  32:	9bad8d93          	add	s11,s11,-1606 # 9e8 <buf>
    for(i=0; i<n; i++){
      c++;
      if(buf[i] == '\n')
  36:	4aa9                	li	s5,10
  ...
  3c:	8e8a0a13          	add	s4,s4,-1816 # 920 <malloc+0x104>
        inword = 0;
  40:	4b81                	li	s7,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  8e:	95e48493          	add	s1,s1,-1698 # 9e8 <buf>
  ...
  aa:	89a50513          	add	a0,a0,-1894 # 940 <malloc+0x124>
  ...
  d8:	85c50513          	add	a0,a0,-1956 # 930 <malloc+0x114>
...
main(int argc, char *argv[])
{
 ...
 15a:	7d258593          	add	a1,a1,2002 # 928 <malloc+0x10c>
 15e:	4501                	li	a0,0
 ...
 17a:	7da50513          	add	a0,a0,2010 # 950 <malloc+0x134>
...
putc(int fd, char c)
{
 49c:	1101                	add	sp,sp,-32
 49e:	ec06                	sd	ra,24(sp)
 4a0:	e822                	sd	s0,16(sp)
 4a2:	1000                	add	s0,sp,32
 4a4:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
 4a8:	4605                	li	a2,1
 4aa:	fef40593          	add	a1,s0,-17
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 4e0:	4ec50513          	add	a0,a0,1260 # 9c8 <digits>
 4e4:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5e6:	38e70713          	add	a4,a4,910 # 970 <malloc+0x154>
 ...
 672:	35ab8b93          	add	s7,s7,858 # 9c8 <digits>
 ...
 6c8:	2a490913          	add	s2,s2,676 # 968 <malloc+0x14c>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 86c:	17890913          	add	s2,s2,376 # 9e0 <freep>
  if(p == (char*)-1)
 870:	5afd                	li	s5,-1
 ...
 880:	36c78793          	add	a5,a5,876 # be8 <base>
 ...
 8ea:	c798                	sw	a4,8(a5)
        p += p->s.size;
 8ec:	02071693          	sll	a3,a4,0x20
 8f0:	01c6d713          	srl	a4,a3,0x1c
