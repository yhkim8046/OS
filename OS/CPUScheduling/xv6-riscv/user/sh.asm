...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2ba58593          	add	a1,a1,698 # 1318 <malloc+0x10c>
      66:	4509                	li	a0,2
...
00000000000009e4 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a18:	90c60613          	add	a2,a2,-1780 # 1320 <malloc+0x114>
     a1c:	85a6                	mv	a1,s1
