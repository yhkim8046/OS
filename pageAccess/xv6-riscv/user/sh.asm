...
getcmd(char *buf, int nbuf)
{
  ...
  fprintf(2, "(xv6)$ ");
      ...
      14:	2f058593          	add	a1,a1,752 # 1300 <malloc+0x104>
      18:	4509                	li	a0,2
...
panic(char *s)
{
  ...
  fprintf(2, "%s\n", s);
      ...
      62:	2aa58593          	add	a1,a1,682 # 1308 <malloc+0x10c>
      66:	4509                	li	a0,2
...
fork1(void)
{
  ...
  return pid;
    ...
    panic("fork");
      ...
      9c:	28050513          	add	a0,a0,640 # 1318 <malloc+0x11c>
...
00000000000000a8 <runcmd>:
{
  ...
  switch(cmd->type){
      ...
      c8:	35470713          	add	a4,a4,852 # 1418 <malloc+0x21c>
    ...
    panic("runcmd");
      ...
      e4:	24050513          	add	a0,a0,576 # 1320 <malloc+0x124>
    ...
    fprintf(2, "exec %s failed\n", ecmd->argv[0]);
     ...
     106:	22658593          	add	a1,a1,550 # 1328 <malloc+0x12c>
     10a:	4509                	li	a0,2
  ...
  exit(0);
    ...
    runcmd(rcmd->cmd);
     ...
     152:	1ea58593          	add	a1,a1,490 # 1338 <malloc+0x13c>
     156:	4509                	li	a0,2
    ...
    if(fork1() == 0){
     ...
     1e8:	16450513          	add	a0,a0,356 # 1348 <malloc+0x14c>
...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     400:	0c498993          	add	s3,s3,196 # 14c0 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     466:	05e98993          	add	s3,s3,94 # 14c0 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d2:	ff298993          	add	s3,s3,-14 # 14c0 <whitespace>
     4d6:	00001a97          	auipc	s5,0x1
     4da:	fe2a8a93          	add	s5,s5,-30 # 14b8 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     548:	f7c98993          	add	s3,s3,-132 # 14c0 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5b6:	dbea8a93          	add	s5,s5,-578 # 1370 <malloc+0x174>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c8:	d8c50513          	add	a0,a0,-628 # 1350 <malloc+0x154>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a0:	cdc60613          	add	a2,a2,-804 # 1378 <malloc+0x17c>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6dc:	cc0b0b13          	add	s6,s6,-832 # 1398 <malloc+0x19c>
  ...
  return ret;
     ...
     70a:	c7a50513          	add	a0,a0,-902 # 1380 <malloc+0x184>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     76c:	c2050513          	add	a0,a0,-992 # 1388 <malloc+0x18c>
...
0000000000000792 <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7b2:	bf260613          	add	a2,a2,-1038 # 13a0 <malloc+0x1a4>
     7b6:	85ce                	mv	a1,s3
     7b8:	854a                	mv	a0,s2
...
0000000000000800 <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     822:	b8aa0a13          	add	s4,s4,-1142 # 13a8 <malloc+0x1ac>
  ...
  if(peek(ps, es, ";")){
     ...
     858:	b5c60613          	add	a2,a2,-1188 # 13b0 <malloc+0x1b4>
     85c:	85ce                	mv	a1,s3
     85e:	854a                	mv	a0,s2
...
00000000000008a8 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8be:	abe60613          	add	a2,a2,-1346 # 1378 <malloc+0x17c>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ee:	ade60613          	add	a2,a2,-1314 # 13c8 <malloc+0x1cc>
     8f2:	85ca                	mv	a1,s2
     8f4:	8526                	mv	a0,s1
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     96c:	ac870713          	add	a4,a4,-1336 # 1430 <malloc+0x234>
...
00000000000009e4 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a18:	8fc60613          	add	a2,a2,-1796 # 1310 <malloc+0x114>
     a1c:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4e:	99e58593          	add	a1,a1,-1634 # 13e8 <malloc+0x1ec>
     a52:	4509                	li	a0,2
     a54:	00000097          	auipc	ra,0x0
     a58:	6c2080e7          	jalr	1730(ra) # 1116 <fprintf>
    panic("syntax");
     a5c:	00001517          	auipc	a0,0x1
     a60:	92450513          	add	a0,a0,-1756 # 1380 <malloc+0x184>
...
0000000000000a6c <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a80:	97c48493          	add	s1,s1,-1668 # 13f8 <malloc+0x1fc>
     a84:	4589                	li	a1,2
     a86:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa6:	a2e48493          	add	s1,s1,-1490 # 14d0 <buf.0>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     afa:	9daa0a13          	add	s4,s4,-1574 # 14d0 <buf.0>
     afe:	8552                	mv	a0,s4
     ...
     b1a:	9bd50513          	add	a0,a0,-1603 # 14d3 <buf.0+0x3>
     b1e:	00000097          	auipc	ra,0x0
     b22:	326080e7          	jalr	806(ra) # e44 <chdir>
     b26:	fa0551e3          	bgez	a0,ac8 <main+0x5c>
        fprintf(2, "cannot cd %s\n", buf+3);
     b2a:	00001617          	auipc	a2,0x1
     b2e:	9a960613          	add	a2,a2,-1623 # 14d3 <buf.0+0x3>
     b32:	00001597          	auipc	a1,0x1
     b36:	8ce58593          	add	a1,a1,-1842 # 1400 <malloc+0x204>
     b3a:	4509                	li	a0,2
     ...
     b4a:	98a50513          	add	a0,a0,-1654 # 14d0 <buf.0>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ec0:	5e450513          	add	a0,a0,1508 # 14a0 <digits>
     ec4:	883a                	mv	a6,a4
     ec6:	2705                	addw	a4,a4,1
     ec8:	02c5f7bb          	remuw	a5,a1,a2
     ecc:	1782                	sll	a5,a5,0x20
     ece:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     fc6:	48670713          	add	a4,a4,1158 # 1448 <malloc+0x24c>
  ...
  putc(fd, 'x');
    ...
    1052:	452b8b93          	add	s7,s7,1106 # 14a0 <digits>
    1056:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    106a:	0992                	sll	s3,s3,0x4
    106c:	397d                	addw	s2,s2,-1
    ...
    10a8:	36c90913          	add	s2,s2,876 # 1410 <malloc+0x214>
        while(*s != 0){
...
{
    1116:	715d                	add	sp,sp,-80
    1118:	ec06                	sd	ra,24(sp)
    111a:	e822                	sd	s0,16(sp)
    111c:	1000                	add	s0,sp,32
...
free(void *ap)
{
    117a:	1141                	add	sp,sp,-16
    117c:	e422                	sd	s0,8(sp)
    117e:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    1180:	ff050693          	add	a3,a0,-16
    ...
    11b0:	00e6ea63          	bltu	a3,a4,11c4 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    11ca:	02059813          	sll	a6,a1,0x20
    11ce:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    11de:	02061593          	sll	a1,a2,0x20
    11e2:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    11fc:	7139                	add	sp,sp,-64
    11fe:	fc06                	sd	ra,56(sp)
    1200:	f822                	sd	s0,48(sp)
    1202:	f426                	sd	s1,40(sp)
    1204:	ec4e                	sd	s3,24(sp)
    1206:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1208:	02051493          	sll	s1,a0,0x20
    120c:	9081                	srl	s1,s1,0x20
    120e:	04bd                	add	s1,s1,15
    1210:	8091                	srl	s1,s1,0x4
    1212:	0014899b          	addw	s3,s1,1
    1216:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    124c:	28090913          	add	s2,s2,640 # 14c8 <freep>
  if(p == (char*)-1)
    1250:	5afd                	li	s5,-1
    ...
    1260:	2dc78793          	add	a5,a5,732 # 1538 <base>
  ...
  if(p == (char*)-1)
    ...
    12ca:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12cc:	02071693          	sll	a3,a4,0x20
    12d0:	01c6d713          	srl	a4,a3,0x1c
