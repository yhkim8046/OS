...
000000000000011a <grep>:
{
 ...
 140:	9bca8a93          	add	s5,s5,-1604 # af8 <buf>
 ...
 1ba:	94250513          	add	a0,a0,-1726 # af8 <buf>
...
00000000000001ec <main>:
{
 ...
 25e:	7e658593          	add	a1,a1,2022 # a40 <malloc+0x102>
 262:	4509                	li	a0,2
 ...
 294:	7d050513          	add	a0,a0,2000 # a60 <malloc+0x122>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 602:	4da50513          	add	a0,a0,1242 # ad8 <digits>
 606:	883a                	mv	a6,a4
 608:	2705                	addw	a4,a4,1
 60a:	02c5f7bb          	remuw	a5,a1,a2
 60e:	1782                	sll	a5,a5,0x20
 610:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 6f4:	f9d9079b          	addw	a5,s2,-99
 6f8:	0ff7f713          	zext.b	a4,a5
 6fc:	12eb6163          	bltu	s6,a4,81e <vprintf+0x192>
 700:	00271793          	sll	a5,a4,0x2
 704:	00000717          	auipc	a4,0x0
 708:	37c70713          	add	a4,a4,892 # a80 <malloc+0x142>
 ...
 794:	348b8b93          	add	s7,s7,840 # ad8 <digits>
 ...
 7ea:	29290913          	add	s2,s2,658 # a78 <malloc+0x13a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 98e:	16690913          	add	s2,s2,358 # af0 <freep>
  if(p == (char*)-1)
 992:	5afd                	li	s5,-1
 ...
 9a2:	55a78793          	add	a5,a5,1370 # ef8 <base>
