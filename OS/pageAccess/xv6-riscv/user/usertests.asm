...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	dc250513          	add	a0,a0,-574 # 5e00 <malloc+0x104>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	70878793          	add	a5,a5,1800 # 9760 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e1068693          	add	a3,a3,-496 # be70 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	da050513          	add	a0,a0,-608 # 5e20 <malloc+0x124>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d9050513          	add	a0,a0,-624 # 5e38 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d9250513          	add	a0,a0,-622 # 5e58 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d5a50513          	add	a0,a0,-678 # 5e40 <malloc+0x144>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d6650513          	add	a0,a0,-666 # 5e68 <malloc+0x16c>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d6450513          	add	a0,a0,-668 # 5e90 <malloc+0x194>
     134:	00005097          	auipc	ra,0x5
     138:	7f0080e7          	jalr	2032(ra) # 5924 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	d5050513          	add	a0,a0,-688 # 5e90 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	d4c58593          	add	a1,a1,-692 # 5ea0 <malloc+0x1a4>
     15c:	00005097          	auipc	ra,0x5
     160:	798080e7          	jalr	1944(ra) # 58f4 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d2850513          	add	a0,a0,-728 # 5e90 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d2c58593          	add	a1,a1,-724 # 5ea8 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	cfc50513          	add	a0,a0,-772 # 5e90 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	ce650513          	add	a0,a0,-794 # 5eb0 <malloc+0x1b4>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c5c50513          	add	a0,a0,-932 # 5ed8 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	c48a8a93          	add	s5,s5,-952 # 5ed8 <malloc+0x1dc>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	bd8a0a13          	add	s4,s4,-1064 # be70 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	bd650513          	add	a0,a0,-1066 # 5ee8 <malloc+0x1ec>
     ...
     338:	bd450513          	add	a0,a0,-1068 # 5f08 <malloc+0x20c>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	bb0a0a13          	add	s4,s4,-1104 # 5f20 <malloc+0x224>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	b0c50513          	add	a0,a0,-1268 # 5f28 <malloc+0x22c>
     ...
     43e:	b0650513          	add	a0,a0,-1274 # 5f40 <malloc+0x244>
     ...
     45c:	b1850513          	add	a0,a0,-1256 # 5f70 <malloc+0x274>
     ...
     476:	b2e50513          	add	a0,a0,-1234 # 5fa0 <malloc+0x2a4>
     ...
     494:	b2050513          	add	a0,a0,-1248 # 5fb0 <malloc+0x2b4>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	b12a0a13          	add	s4,s4,-1262 # 5fe0 <malloc+0x2e4>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	9d2a8a93          	add	s5,s5,-1582 # 5ea8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a6c50513          	add	a0,a0,-1428 # 5fe8 <malloc+0x2ec>
     ...
     59e:	a6650513          	add	a0,a0,-1434 # 6000 <malloc+0x304>
     ...
     5b8:	9ec50513          	add	a0,a0,-1556 # 5fa0 <malloc+0x2a4>
     ...
     5d2:	a6250513          	add	a0,a0,-1438 # 6030 <malloc+0x334>
     ...
     5f0:	a5c50513          	add	a0,a0,-1444 # 6048 <malloc+0x34c>
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	85e58593          	add	a1,a1,-1954 # 5ea0 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	83250513          	add	a0,a0,-1998 # 5e90 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	80650513          	add	a0,a0,-2042 # 5e90 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	7f250513          	add	a0,a0,2034 # 5e90 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	9fc58593          	add	a1,a1,-1540 # 60d8 <malloc+0x3dc>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	77250513          	add	a0,a0,1906 # 5e90 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	91650513          	add	a0,a0,-1770 # 6078 <malloc+0x37c>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	91a50513          	add	a0,a0,-1766 # 6098 <malloc+0x39c>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     796:	91650513          	add	a0,a0,-1770 # 60a8 <malloc+0x3ac>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	91a50513          	add	a0,a0,-1766 # 60c8 <malloc+0x3cc>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c6:	8e650513          	add	a0,a0,-1818 # 60a8 <malloc+0x3ac>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	90050513          	add	a0,a0,-1792 # 60e0 <malloc+0x3e4>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	90250513          	add	a0,a0,-1790 # 6100 <malloc+0x404>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	8ee50513          	add	a0,a0,-1810 # 6120 <malloc+0x424>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	8fe98993          	add	s3,s3,-1794 # 6148 <malloc+0x44c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	92ea8a93          	add	s5,s5,-1746 # 6180 <malloc+0x484>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	88850513          	add	a0,a0,-1912 # 6120 <malloc+0x424>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5be58593          	add	a1,a1,1470 # be70 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	84c50513          	add	a0,a0,-1972 # 6120 <malloc+0x424>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	82a50513          	add	a0,a0,-2006 # 6128 <malloc+0x42c>
    ...
    exit(1);
     ...
     920:	83c50513          	add	a0,a0,-1988 # 6158 <malloc+0x45c>
     ...
     93e:	85650513          	add	a0,a0,-1962 # 6190 <malloc+0x494>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	86250513          	add	a0,a0,-1950 # 61b8 <malloc+0x4bc>
    ...
    printf("%s: read failed\n", s);
     ...
     976:	86650513          	add	a0,a0,-1946 # 61d8 <malloc+0x4dc>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	86250513          	add	a0,a0,-1950 # 61f0 <malloc+0x4f4>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	85050513          	add	a0,a0,-1968 # 6210 <malloc+0x514>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	49c90913          	add	s2,s2,1180 # be70 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	7fe50513          	add	a0,a0,2046 # 6210 <malloc+0x514>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	44a90913          	add	s2,s2,1098 # be70 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	7be50513          	add	a0,a0,1982 # 6218 <malloc+0x51c>
    ...
    exit(1);
     ...
     a7c:	7c050513          	add	a0,a0,1984 # 6238 <malloc+0x53c>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	7cc50513          	add	a0,a0,1996 # 6260 <malloc+0x564>
  ...
  if(unlink("big") < 0){
     ...
     ac4:	75050513          	add	a0,a0,1872 # 6210 <malloc+0x514>
     ...
     af0:	79450513          	add	a0,a0,1940 # 6280 <malloc+0x584>
     ...
     b0e:	79e50513          	add	a0,a0,1950 # 62a8 <malloc+0x5ac>
     ...
     b2c:	79850513          	add	a0,a0,1944 # 62c0 <malloc+0x5c4>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	7a450513          	add	a0,a0,1956 # 62e8 <malloc+0x5ec>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	78e50513          	add	a0,a0,1934 # 6300 <malloc+0x604>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	7a658593          	add	a1,a1,1958 # 6330 <malloc+0x634>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	75a50513          	add	a0,a0,1882 # 6300 <malloc+0x604>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	74450513          	add	a0,a0,1860 # 6300 <malloc+0x604>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	72e50513          	add	a0,a0,1838 # 6300 <malloc+0x604>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	79258593          	add	a1,a1,1938 # 6378 <malloc+0x67c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	26e58593          	add	a1,a1,622 # be70 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  if(write(fd, buf, 10) != 10){
     ...
     c30:	24458593          	add	a1,a1,580 # be70 <buf>
     c34:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	6b250513          	add	a0,a0,1714 # 6300 <malloc+0x604>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	6a250513          	add	a0,a0,1698 # 6310 <malloc+0x614>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	6ae50513          	add	a0,a0,1710 # 6338 <malloc+0x63c>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	6b250513          	add	a0,a0,1714 # 6358 <malloc+0x65c>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	6be50513          	add	a0,a0,1726 # 6380 <malloc+0x684>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	6c250513          	add	a0,a0,1730 # 63a0 <malloc+0x6a4>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	6c650513          	add	a0,a0,1734 # 63c0 <malloc+0x6c4>
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	5d258593          	add	a1,a1,1490 # 6330 <malloc+0x634>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	66a58593          	add	a1,a1,1642 # 63e8 <malloc+0x6ec>
     d86:	00005517          	auipc	a0,0x5
     d8a:	65a50513          	add	a0,a0,1626 # 63e0 <malloc+0x6e4>
  ...
  unlink("lf1");
     ...
     d9e:	64650513          	add	a0,a0,1606 # 63e0 <malloc+0x6e4>
     da2:	00005097          	auipc	ra,0x5
     da6:	b82080e7          	jalr	-1150(ra) # 5924 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	63450513          	add	a0,a0,1588 # 63e0 <malloc+0x6e4>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	62650513          	add	a0,a0,1574 # 63e8 <malloc+0x6ec>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	09658593          	add	a1,a1,150 # be70 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	5ee58593          	add	a1,a1,1518 # 63e8 <malloc+0x6ec>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	5d850513          	add	a0,a0,1496 # 63e8 <malloc+0x6ec>
     e18:	00005097          	auipc	ra,0x5
     e1c:	b0c080e7          	jalr	-1268(ra) # 5924 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	5c058593          	add	a1,a1,1472 # 63e0 <malloc+0x6e4>
     e28:	00005517          	auipc	a0,0x5
     e2c:	5c050513          	add	a0,a0,1472 # 63e8 <malloc+0x6ec>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	5a458593          	add	a1,a1,1444 # 63e0 <malloc+0x6e4>
     e44:	00005517          	auipc	a0,0x5
     e48:	6ac50513          	add	a0,a0,1708 # 64f0 <malloc+0x7f4>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	58a50513          	add	a0,a0,1418 # 63f0 <malloc+0x6f4>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	58650513          	add	a0,a0,1414 # 6408 <malloc+0x70c>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	58250513          	add	a0,a0,1410 # 6420 <malloc+0x724>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	58650513          	add	a0,a0,1414 # 6440 <malloc+0x744>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	59a50513          	add	a0,a0,1434 # 6470 <malloc+0x774>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	59650513          	add	a0,a0,1430 # 6488 <malloc+0x78c>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	59250513          	add	a0,a0,1426 # 64a0 <malloc+0x7a4>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	59e50513          	add	a0,a0,1438 # 64c8 <malloc+0x7cc>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	5b250513          	add	a0,a0,1458 # 64f8 <malloc+0x7fc>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	56ca0a13          	add	s4,s4,1388 # 6518 <malloc+0x81c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	51a50513          	add	a0,a0,1306 # 6518 <malloc+0x81c>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	4b250513          	add	a0,a0,1202 # 6520 <malloc+0x824>
    ...
    1092:	4b250513          	add	a0,a0,1202 # 6540 <malloc+0x844>
    ...
    10ae:	4b650513          	add	a0,a0,1206 # 6560 <malloc+0x864>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	4a498993          	add	s3,s3,1188 # 6580 <malloc+0x884>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	47850513          	add	a0,a0,1144 # 6590 <malloc+0x894>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	add	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1cdb>
...
badarg(char *s)
{
    ...
    1184:	35048493          	add	s1,s1,848 # c350 <buf+0x4e0>
  for(int i = 0; i < 50000; i++){
    ...
    1192:	caa98993          	add	s3,s3,-854 # 5e38 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	57078793          	add	a5,a5,1392 # 7788 <malloc+0x1a8c>
  ...
  if(pid == 0){
    ...
    1252:	50a78793          	add	a5,a5,1290 # 8758 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	50268693          	add	a3,a3,1282 # 9758 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    1278:	f5c78793          	add	a5,a5,-164 # 81d0 <malloc+0x24d4>
    ...
    129c:	ba050513          	add	a0,a0,-1120 # 5e38 <malloc+0x13c>
    ...
    12b4:	38850513          	add	a0,a0,904 # 6638 <malloc+0x93c>
    ...
    12d4:	2e050513          	add	a0,a0,736 # 65b0 <malloc+0x8b4>
    ...
    12f4:	2e050513          	add	a0,a0,736 # 65d0 <malloc+0x8d4>
    ...
    1316:	2de50513          	add	a0,a0,734 # 65f0 <malloc+0x8f4>
    ...
    1336:	2e650513          	add	a0,a0,742 # 6618 <malloc+0x91c>
    ...
    1350:	76450513          	add	a0,a0,1892 # 6ab0 <malloc+0xdb4>
  ...
  if(st != 747){
    ...
    139a:	2ca50513          	add	a0,a0,714 # 6660 <malloc+0x964>
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	ad050513          	add	a0,a0,-1328 # 5e90 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    13f6:	a9ea0a13          	add	s4,s4,-1378 # 5e90 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	2c6a8a93          	add	s5,s5,710 # 66c0 <malloc+0x9c4>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    1476:	21e50513          	add	a0,a0,542 # 6690 <malloc+0x994>
    ...
    1492:	21a50513          	add	a0,a0,538 # 66a8 <malloc+0x9ac>
    ...
    14b0:	22450513          	add	a0,a0,548 # 66d0 <malloc+0x9d4>
    ...
    14d6:	9bea0a13          	add	s4,s4,-1602 # 5e90 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    14da:	00005a97          	auipc	s5,0x5
    14de:	216a8a93          	add	s5,s5,534 # 66f0 <malloc+0x9f4>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1528:	96c50513          	add	a0,a0,-1684 # 5e90 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    1546:	16650513          	add	a0,a0,358 # 66a8 <malloc+0x9ac>
    ...
    1564:	19850513          	add	a0,a0,408 # 66f8 <malloc+0x9fc>
...
000000000000157a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    158a:	8b278793          	add	a5,a5,-1870 # 5e38 <malloc+0x13c>
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	00005797          	auipc	a5,0x5
    1596:	18678793          	add	a5,a5,390 # 6718 <malloc+0xa1c>
    159a:	fcf43423          	sd	a5,-56(s0)
    159e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a2:	00005517          	auipc	a0,0x5
    15a6:	17e50513          	add	a0,a0,382 # 6720 <malloc+0xa24>
  ...
  if(pid == 0) {
    ...
    15d6:	14e50513          	add	a0,a0,334 # 6720 <malloc+0xa24>
    ...
    15f2:	15250513          	add	a0,a0,338 # 6740 <malloc+0xa44>
    ...
    1610:	08450513          	add	a0,a0,132 # 6690 <malloc+0x994>
    ...
    162c:	10050513          	add	a0,a0,256 # 6728 <malloc+0xa2c>
    ...
    164a:	7f250513          	add	a0,a0,2034 # 5e38 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    167e:	0d650513          	add	a0,a0,214 # 6750 <malloc+0xa54>
    ...
    169a:	0d250513          	add	a0,a0,210 # 6768 <malloc+0xa6c>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    16ae:	07650513          	add	a0,a0,118 # 6720 <malloc+0xa24>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d8:	b0450513          	add	a0,a0,-1276 # 61d8 <malloc+0x4dc>
    ...
    16f4:	fb850513          	add	a0,a0,-72 # 66a8 <malloc+0x9ac>
  ...
  unlink("echo-ok");
    ...
    170e:	01650513          	add	a0,a0,22 # 6720 <malloc+0xa24>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1738:	04c50513          	add	a0,a0,76 # 6780 <malloc+0xa84>
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	6d4a8a93          	add	s5,s5,1748 # be70 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	6b870713          	add	a4,a4,1720 # be70 <buf>
    ...
    1800:	f9c50513          	add	a0,a0,-100 # 6798 <malloc+0xa9c>
    ...
    182e:	646b0b13          	add	s6,s6,1606 # be70 <buf>
    ...
    1842:	42da8a93          	add	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    188e:	f2650513          	add	a0,a0,-218 # 67b0 <malloc+0xab4>
    ...
    18aa:	f2250513          	add	a0,a0,-222 # 67c8 <malloc+0xacc>
    ...
    18dc:	f0850513          	add	a0,a0,-248 # 67e0 <malloc+0xae4>
    ...
    1928:	edc50513          	add	a0,a0,-292 # 6800 <malloc+0xb04>
...
000000000000193e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    199a:	cfa50513          	add	a0,a0,-774 # 6690 <malloc+0x994>
    ...
    19b6:	e6650513          	add	a0,a0,-410 # 6818 <malloc+0xb1c>
    ...
    19d2:	e6250513          	add	a0,a0,-414 # 6830 <malloc+0xb34>
...
00000000000019f2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a4a:	c4a50513          	add	a0,a0,-950 # 6690 <malloc+0x994>
    ...
    1a6e:	c2650513          	add	a0,a0,-986 # 6690 <malloc+0x994>
...
0000000000001a8c <forkfork>:
{
    ...
    1ae8:	d6c50513          	add	a0,a0,-660 # 6850 <malloc+0xb54>
    ...
    1afa:	dde080e7          	jalr	-546(ra) # 58d4 <exit>
{
    ...
    1b40:	d2450513          	add	a0,a0,-732 # 6860 <malloc+0xb64>
...
0000000000001b56 <reparent2>:
{
  ...
  exit(0);
    ...
    1b8e:	f2650513          	add	a0,a0,-218 # 6ab0 <malloc+0xdb4>
...
0000000000001bbe <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c2c:	e8850513          	add	a0,a0,-376 # 6ab0 <malloc+0xdb4>
    ...
    1c58:	ad450513          	add	a0,a0,-1324 # 6728 <malloc+0xa2c>
    ...
    1cca:	bba50513          	add	a0,a0,-1094 # 6880 <malloc+0xb84>
    ...
    1cfe:	b9e50513          	add	a0,a0,-1122 # 6898 <malloc+0xb9c>
    ...
    1d60:	b6450513          	add	a0,a0,-1180 # 68c0 <malloc+0xbc4>
...
0000000000001de4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e04:	0a850513          	add	a0,a0,168 # 5ea8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c55fed>
    ...
    1e40:	06cb0b13          	add	s6,s6,108 # 5ea8 <malloc+0x1ac>
      link("cat", "x");
    1e44:	00005c17          	auipc	s8,0x5
    1e48:	aa4c0c13          	add	s8,s8,-1372 # 68e8 <malloc+0xbec>
    1e4c:	a825                	j	1e84 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e4e:	85a6                	mv	a1,s1
    1e50:	00005517          	auipc	a0,0x5
    1e54:	84050513          	add	a0,a0,-1984 # 6690 <malloc+0x994>
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4c:	b6850513          	add	a0,a0,-1176 # 6ab0 <malloc+0xdb4>
    ...
    1f8e:	ee6b0b13          	add	s6,s6,-282 # be70 <buf>
    ...
    2002:	8f250513          	add	a0,a0,-1806 # 68f0 <malloc+0xbf4>
    ...
    2022:	eea50513          	add	a0,a0,-278 # 5f08 <malloc+0x20c>
...
0000000000002040 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2070:	8e450513          	add	a0,a0,-1820 # 6950 <malloc+0xc54>
    ...
    2094:	87850513          	add	a0,a0,-1928 # 6908 <malloc+0xc0c>
    ...
    20b0:	87450513          	add	a0,a0,-1932 # 6920 <malloc+0xc24>
    ...
    20cc:	87050513          	add	a0,a0,-1936 # 6938 <malloc+0xc3c>
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	add	s3,s3,848 # c350 <buf+0x4e0>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	sll	s2,s2,0x3
    213e:	48090913          	add	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e600>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2182:	51250513          	add	a0,a0,1298 # 6690 <malloc+0x994>
    ...
    21a4:	7d850513          	add	a0,a0,2008 # 6978 <malloc+0xc7c>
...
00000000000021c4 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2226:	46e50513          	add	a0,a0,1134 # 6690 <malloc+0x994>
    ...
    2252:	74a50513          	add	a0,a0,1866 # 6998 <malloc+0xc9c>
...
0000000000002272 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2282:	73250513          	add	a0,a0,1842 # 69b0 <malloc+0xcb4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    22b4:	70050513          	add	a0,a0,1792 # 69b0 <malloc+0xcb4>
  ...
  close(fd);
    ...
    22da:	38278793          	add	a5,a5,898 # 8658 <args.1>
    22de:	00006697          	auipc	a3,0x6
    22e2:	47268693          	add	a3,a3,1138 # 8750 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22e6:	00004717          	auipc	a4,0x4
    22ea:	6da70713          	add	a4,a4,1754 # 69c0 <malloc+0xcc4>
    ...
    233e:	76650513          	add	a0,a0,1894 # 6aa0 <malloc+0xda4>
    ...
    2362:	76250513          	add	a0,a0,1890 # 6ac0 <malloc+0xdc4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    23c0:	72450513          	add	a0,a0,1828 # 6ae0 <malloc+0xde4>
    ...
    23dc:	2b850513          	add	a0,a0,696 # 6690 <malloc+0x994>
...
00000000000023fc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2476:	31678793          	add	a5,a5,790 # 7788 <malloc+0x1a8c>
  ...
  if(ret != -1){
    ...
    24b8:	65450513          	add	a0,a0,1620 # 6b08 <malloc+0xe0c>
    ...
    24d6:	0de50513          	add	a0,a0,222 # 65b0 <malloc+0x8b4>
    ...
    24f4:	0e050513          	add	a0,a0,224 # 65d0 <malloc+0x8d4>
    ...
    2514:	0e050513          	add	a0,a0,224 # 65f0 <malloc+0x8f4>
    ...
    2532:	0ea50513          	add	a0,a0,234 # 6618 <malloc+0x91c>
...
0000000000002548 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    257e:	5ce50513          	add	a0,a0,1486 # 6b48 <malloc+0xe4c>
  ...
  if(n >= 0){
    ...
    25ae:	5be50513          	add	a0,a0,1470 # 6b68 <malloc+0xe6c>
    ...
    25cc:	54850513          	add	a0,a0,1352 # 6b10 <malloc+0xe14>
    ...
    25e8:	54450513          	add	a0,a0,1348 # 6b28 <malloc+0xe2c>
    ...
    2602:	55250513          	add	a0,a0,1362 # 6b50 <malloc+0xe54>
  ...
  if(n >= 0){
    ...
    2662:	53a50513          	add	a0,a0,1338 # 6b98 <malloc+0xe9c>
    ...
    267c:	4d850513          	add	a0,a0,1240 # 6b50 <malloc+0xe54>
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2702:	4c250513          	add	a0,a0,1218 # 6bc0 <malloc+0xec4>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2766:	47e50513          	add	a0,a0,1150 # 6be0 <malloc+0xee4>
  ...
  if(c != a + 1){
    ...
    27ca:	47a50513          	add	a0,a0,1146 # 6c40 <malloc+0xf44>
    ...
    27ec:	41850513          	add	a0,a0,1048 # 6c00 <malloc+0xf04>
    ...
    2808:	41c50513          	add	a0,a0,1052 # 6c20 <malloc+0xf24>
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2952:	31250513          	add	a0,a0,786 # 6c60 <malloc+0xf64>
    ...
    296e:	33e50513          	add	a0,a0,830 # 6ca8 <malloc+0xfac>
    ...
    298e:	33e50513          	add	a0,a0,830 # 6cc8 <malloc+0xfcc>
    ...
    29ae:	35e50513          	add	a0,a0,862 # 6d08 <malloc+0x100c>
    ...
    29ca:	37250513          	add	a0,a0,882 # 6d38 <malloc+0x103c>
    ...
    29ea:	38a50513          	add	a0,a0,906 # 6d70 <malloc+0x1074>
...
0000000000002a00 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2a24:	37850513          	add	a0,a0,888 # 6d98 <malloc+0x109c>
    2a28:	00003097          	auipc	ra,0x3
    2a2c:	eec080e7          	jalr	-276(ra) # 5914 <open>
    2a30:	84aa                	mv	s1,a0
  unlink("sbrk");
    2a32:	00004517          	auipc	a0,0x4
    2a36:	36650513          	add	a0,a0,870 # 6d98 <malloc+0x109c>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a8a:	31a50513          	add	a0,a0,794 # 6da0 <malloc+0x10a4>
    ...
    2aa6:	31650513          	add	a0,a0,790 # 6db8 <malloc+0x10bc>
    ...
    2ac2:	cda50513          	add	a0,a0,-806 # 6798 <malloc+0xa9c>
...
0000000000002ad8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2aec:	2e850513          	add	a0,a0,744 # 6dd0 <malloc+0x10d4>
  ...
  close(fd);
    ...
    2b34:	b7850513          	add	a0,a0,-1160 # 66a8 <malloc+0x9ac>
...
0000000000002b4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b82:	f3250513          	add	a0,a0,-206 # 6ab0 <malloc+0xdb4>
  ...
  if(pid == 0){
    ...
    2bd8:	edc50513          	add	a0,a0,-292 # 6ab0 <malloc+0xdb4>
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addw	a5,a5,-2048 # a800 <uninit+0x10a0>
    ...
    2c38:	e7c50513          	add	a0,a0,-388 # 6ab0 <malloc+0xdb4>
...
0000000000002d34 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2d40:	0511                	add	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1184>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2dac:	d0850513          	add	a0,a0,-760 # 6ab0 <malloc+0xdb4>
    ...
    2e00:	03c50513          	add	a0,a0,60 # 5e38 <malloc+0x13c>
    2e04:	faa43c23          	sd	a0,-72(s0)
    2e08:	00003797          	auipc	a5,0x3
    2e0c:	0a078793          	add	a5,a5,160 # 5ea8 <malloc+0x1ac>
...
0000000000002e2e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2e3e:	16e50513          	add	a0,a0,366 # 6fa8 <malloc+0x12ac>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e50:	fb450513          	add	a0,a0,-76 # 6e00 <malloc+0x1104>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e66:	ff650513          	add	a0,a0,-10 # 6e58 <malloc+0x115c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e84:	05050513          	add	a0,a0,80 # 6ed0 <malloc+0x11d4>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2ea0:	0a450513          	add	a0,a0,164 # 6f40 <malloc+0x1244>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2eb2:	0ea50513          	add	a0,a0,234 # 6f98 <malloc+0x129c>
  ...
  unlink("12345678901234");
    ...
    2f30:	eac50513          	add	a0,a0,-340 # 6dd8 <malloc+0x10dc>
    ...
    2f4c:	ed850513          	add	a0,a0,-296 # 6e20 <malloc+0x1124>
    ...
    2f68:	f2450513          	add	a0,a0,-220 # 6e88 <malloc+0x118c>
    ...
    2f84:	f8050513          	add	a0,a0,-128 # 6f00 <malloc+0x1204>
    ...
    2fa0:	fc450513          	add	a0,a0,-60 # 6f60 <malloc+0x1264>
...
0000000000002fd2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2fe2:	01250513          	add	a0,a0,18 # 6ff0 <malloc+0x12f4>
  ...
  if(chdir("iputdir") < 0){
    ...
    2ff6:	ffe50513          	add	a0,a0,-2 # 6ff0 <malloc+0x12f4>
  ...
  if(unlink("../iputdir") < 0){
    ...
    300a:	02a50513          	add	a0,a0,42 # 7030 <malloc+0x1334>
  ...
  if(chdir("/") < 0){
    ...
    301e:	04650513          	add	a0,a0,70 # 7060 <malloc+0x1364>
    ...
    303e:	fbe50513          	add	a0,a0,-66 # 6ff8 <malloc+0x12fc>
    ...
    305a:	fba50513          	add	a0,a0,-70 # 7010 <malloc+0x1314>
    ...
    3076:	fce50513          	add	a0,a0,-50 # 7040 <malloc+0x1344>
    ...
    3092:	fda50513          	add	a0,a0,-38 # 7068 <malloc+0x136c>
...
00000000000030a8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    30c6:	f2e50513          	add	a0,a0,-210 # 6ff0 <malloc+0x12f4>
    ...
    30da:	f1a50513          	add	a0,a0,-230 # 6ff0 <malloc+0x12f4>
    ...
    30ee:	f4650513          	add	a0,a0,-186 # 7030 <malloc+0x1334>
    ...
    310e:	58650513          	add	a0,a0,1414 # 6690 <malloc+0x994>
    ...
    312a:	ed250513          	add	a0,a0,-302 # 6ff8 <malloc+0x12fc>
    ...
    3146:	f3e50513          	add	a0,a0,-194 # 7080 <malloc+0x1384>
    ...
    3162:	ee250513          	add	a0,a0,-286 # 7040 <malloc+0x1344>
...
0000000000003190 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    31a0:	efc50513          	add	a0,a0,-260 # 7098 <malloc+0x139c>
  ...
  if(chdir("dir0") < 0){
    ...
    31b4:	ee850513          	add	a0,a0,-280 # 7098 <malloc+0x139c>
  ...
  if(chdir("..") < 0){
    ...
    31c8:	ef450513          	add	a0,a0,-268 # 70b8 <malloc+0x13bc>
  ...
  if(unlink("dir0") < 0){
    ...
    31dc:	ec050513          	add	a0,a0,-320 # 7098 <malloc+0x139c>
    ...
    31fc:	e0050513          	add	a0,a0,-512 # 6ff8 <malloc+0x12fc>
    ...
    3218:	e8c50513          	add	a0,a0,-372 # 70a0 <malloc+0x13a4>
    ...
    3234:	e9050513          	add	a0,a0,-368 # 70c0 <malloc+0x13c4>
    ...
    3250:	e8c50513          	add	a0,a0,-372 # 70d8 <malloc+0x13dc>
...
0000000000003266 <subdir>:
{
  ...
  unlink("ff");
    ...
    3278:	fac50513          	add	a0,a0,-84 # 7220 <malloc+0x1524>
    327c:	00002097          	auipc	ra,0x2
    3280:	6a8080e7          	jalr	1704(ra) # 5924 <unlink>
  if(mkdir("dd") != 0){
    3284:	00004517          	auipc	a0,0x4
    3288:	e6c50513          	add	a0,a0,-404 # 70f0 <malloc+0x13f4>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e7450513          	add	a0,a0,-396 # 7110 <malloc+0x1414>
  ...
  write(fd, "ff", 2);
    ...
    32b8:	f6c58593          	add	a1,a1,-148 # 7220 <malloc+0x1524>
  ...
  if(unlink("dd") >= 0){
    ...
    32d2:	e2250513          	add	a0,a0,-478 # 70f0 <malloc+0x13f4>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    32e6:	e8650513          	add	a0,a0,-378 # 7168 <malloc+0x146c>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32fe:	e9650513          	add	a0,a0,-362 # 7190 <malloc+0x1494>
  ...
  write(fd, "FF", 2);
    ...
    3316:	eae58593          	add	a1,a1,-338 # 71c0 <malloc+0x14c4>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3332:	e9a50513          	add	a0,a0,-358 # 71c8 <malloc+0x14cc>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	b2a58593          	add	a1,a1,-1238 # be70 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    337a:	ea258593          	add	a1,a1,-350 # 7218 <malloc+0x151c>
    337e:	00004517          	auipc	a0,0x4
    3382:	e1250513          	add	a0,a0,-494 # 7190 <malloc+0x1494>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3396:	dfe50513          	add	a0,a0,-514 # 7190 <malloc+0x1494>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ac:	de850513          	add	a0,a0,-536 # 7190 <malloc+0x1494>
  ...
  if(chdir("dd") != 0){
    ...
    33c0:	d3450513          	add	a0,a0,-716 # 70f0 <malloc+0x13f4>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    33d4:	ee050513          	add	a0,a0,-288 # 72b0 <malloc+0x15b4>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    33e8:	efc50513          	add	a0,a0,-260 # 72e0 <malloc+0x15e4>
  ...
  if(chdir("./..") != 0){
    ...
    33fc:	f1850513          	add	a0,a0,-232 # 7310 <malloc+0x1614>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3412:	e0a50513          	add	a0,a0,-502 # 7218 <malloc+0x151c>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	a4a58593          	add	a1,a1,-1462 # be70 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    344c:	d4850513          	add	a0,a0,-696 # 7190 <malloc+0x1494>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3464:	f4050513          	add	a0,a0,-192 # 73a0 <malloc+0x16a4>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    347c:	f5850513          	add	a0,a0,-168 # 73d0 <malloc+0x16d4>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3494:	c6050513          	add	a0,a0,-928 # 70f0 <malloc+0x13f4>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    34aa:	c4a50513          	add	a0,a0,-950 # 70f0 <malloc+0x13f4>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    34c0:	c3450513          	add	a0,a0,-972 # 70f0 <malloc+0x13f4>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    34d4:	f9058593          	add	a1,a1,-112 # 7460 <malloc+0x1764>
    34d8:	00004517          	auipc	a0,0x4
    34dc:	ec850513          	add	a0,a0,-312 # 73a0 <malloc+0x16a4>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34f0:	f7458593          	add	a1,a1,-140 # 7460 <malloc+0x1764>
    34f4:	00004517          	auipc	a0,0x4
    34f8:	edc50513          	add	a0,a0,-292 # 73d0 <malloc+0x16d4>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    350c:	d1058593          	add	a1,a1,-752 # 7218 <malloc+0x151c>
    3510:	00004517          	auipc	a0,0x4
    3514:	c0050513          	add	a0,a0,-1024 # 7110 <malloc+0x1414>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3528:	e7c50513          	add	a0,a0,-388 # 73a0 <malloc+0x16a4>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    353c:	e9850513          	add	a0,a0,-360 # 73d0 <malloc+0x16d4>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3550:	ccc50513          	add	a0,a0,-820 # 7218 <malloc+0x151c>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3564:	e7050513          	add	a0,a0,-400 # 73d0 <malloc+0x16d4>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3578:	e2c50513          	add	a0,a0,-468 # 73a0 <malloc+0x16a4>
  ...
  if(chdir("dd/ff") == 0){
    ...
    358c:	b8850513          	add	a0,a0,-1144 # 7110 <malloc+0x1414>
  ...
  if(chdir("dd/xx") == 0){
    ...
    35a0:	01450513          	add	a0,a0,20 # 75b0 <malloc+0x18b4>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    35b4:	c6850513          	add	a0,a0,-920 # 7218 <malloc+0x151c>
  ...
  if(unlink("dd/ff") != 0){
    ...
    35c8:	b4c50513          	add	a0,a0,-1204 # 7110 <malloc+0x1414>
  ...
  if(unlink("dd") == 0){
    ...
    35dc:	b1850513          	add	a0,a0,-1256 # 70f0 <malloc+0x13f4>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35f0:	03450513          	add	a0,a0,52 # 7620 <malloc+0x1924>
  ...
  if(unlink("dd") < 0){
    ...
    3604:	af050513          	add	a0,a0,-1296 # 70f0 <malloc+0x13f4>
    ...
    3626:	ad650513          	add	a0,a0,-1322 # 70f8 <malloc+0x13fc>
    ...
    3642:	ada50513          	add	a0,a0,-1318 # 7118 <malloc+0x141c>
    ...
    365e:	ade50513          	add	a0,a0,-1314 # 7138 <malloc+0x143c>
    ...
    367a:	afa50513          	add	a0,a0,-1286 # 7170 <malloc+0x1474>
    ...
    3696:	b0e50513          	add	a0,a0,-1266 # 71a0 <malloc+0x14a4>
    ...
    36b2:	b2a50513          	add	a0,a0,-1238 # 71d8 <malloc+0x14dc>
    ...
    36ce:	b2e50513          	add	a0,a0,-1234 # 71f8 <malloc+0x14fc>
    ...
    36ea:	b4250513          	add	a0,a0,-1214 # 7228 <malloc+0x152c>
    ...
    3706:	b4e50513          	add	a0,a0,-1202 # 7250 <malloc+0x1554>
    ...
    3722:	b5250513          	add	a0,a0,-1198 # 7270 <malloc+0x1574>
    ...
    373e:	b5e50513          	add	a0,a0,-1186 # 7298 <malloc+0x159c>
    ...
    375a:	b6a50513          	add	a0,a0,-1174 # 72c0 <malloc+0x15c4>
    ...
    3776:	b7e50513          	add	a0,a0,-1154 # 72f0 <malloc+0x15f4>
    ...
    3792:	b8a50513          	add	a0,a0,-1142 # 7318 <malloc+0x161c>
    ...
    37ae:	b8650513          	add	a0,a0,-1146 # 7330 <malloc+0x1634>
    ...
    37ca:	b8a50513          	add	a0,a0,-1142 # 7350 <malloc+0x1654>
    ...
    37e6:	b8e50513          	add	a0,a0,-1138 # 7370 <malloc+0x1674>
    ...
    3802:	bb250513          	add	a0,a0,-1102 # 73b0 <malloc+0x16b4>
    ...
    381e:	bc650513          	add	a0,a0,-1082 # 73e0 <malloc+0x16e4>
    ...
    383a:	bca50513          	add	a0,a0,-1078 # 7400 <malloc+0x1704>
    ...
    3856:	bce50513          	add	a0,a0,-1074 # 7420 <malloc+0x1724>
    ...
    3872:	bd250513          	add	a0,a0,-1070 # 7440 <malloc+0x1744>
    ...
    388e:	be650513          	add	a0,a0,-1050 # 7470 <malloc+0x1774>
    ...
    38aa:	bf250513          	add	a0,a0,-1038 # 7498 <malloc+0x179c>
    ...
    38c6:	bfe50513          	add	a0,a0,-1026 # 74c0 <malloc+0x17c4>
    ...
    38e2:	c0a50513          	add	a0,a0,-1014 # 74e8 <malloc+0x17ec>
    ...
    38fe:	c0e50513          	add	a0,a0,-1010 # 7508 <malloc+0x180c>
    ...
    391a:	c1250513          	add	a0,a0,-1006 # 7528 <malloc+0x182c>
    ...
    3936:	c1e50513          	add	a0,a0,-994 # 7550 <malloc+0x1854>
    ...
    3952:	c2250513          	add	a0,a0,-990 # 7570 <malloc+0x1874>
    ...
    396e:	c2650513          	add	a0,a0,-986 # 7590 <malloc+0x1894>
    ...
    398a:	c3250513          	add	a0,a0,-974 # 75b8 <malloc+0x18bc>
    ...
    39a6:	8ae50513          	add	a0,a0,-1874 # 7250 <malloc+0x1554>
    ...
    39c2:	c1a50513          	add	a0,a0,-998 # 75d8 <malloc+0x18dc>
    ...
    39de:	c1e50513          	add	a0,a0,-994 # 75f8 <malloc+0x18fc>
    ...
    39fa:	c3250513          	add	a0,a0,-974 # 7628 <malloc+0x192c>
    ...
    3a16:	c3650513          	add	a0,a0,-970 # 7648 <malloc+0x194c>
...
0000000000003a2c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3a3c:	c2850513          	add	a0,a0,-984 # 7660 <malloc+0x1964>
  ...
  if(chdir("dots") != 0){
    ...
    3a4e:	c1650513          	add	a0,a0,-1002 # 7660 <malloc+0x1964>
  ...
  if(unlink(".") == 0){
    ...
    3a60:	a9450513          	add	a0,a0,-1388 # 64f0 <malloc+0x7f4>
  ...
  if(unlink("..") == 0){
    ...
    3a72:	64a50513          	add	a0,a0,1610 # 70b8 <malloc+0x13bc>
  ...
  if(chdir("/") != 0){
    ...
    3a84:	5e050513          	add	a0,a0,1504 # 7060 <malloc+0x1364>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a96:	c3650513          	add	a0,a0,-970 # 76c8 <malloc+0x19cc>
  ...
  if(unlink("dots/..") == 0){
    ...
    3aa8:	c4c50513          	add	a0,a0,-948 # 76f0 <malloc+0x19f4>
  ...
  if(unlink("dots") != 0){
    ...
    3aba:	baa50513          	add	a0,a0,-1110 # 7660 <malloc+0x1964>
    ...
    3ad8:	b9450513          	add	a0,a0,-1132 # 7668 <malloc+0x196c>
    ...
    3af4:	b9050513          	add	a0,a0,-1136 # 7680 <malloc+0x1984>
    ...
    3b10:	b8c50513          	add	a0,a0,-1140 # 7698 <malloc+0x199c>
    ...
    3b2c:	b8850513          	add	a0,a0,-1144 # 76b0 <malloc+0x19b4>
    ...
    3b48:	52450513          	add	a0,a0,1316 # 7068 <malloc+0x136c>
    ...
    3b64:	b7050513          	add	a0,a0,-1168 # 76d0 <malloc+0x19d4>
    ...
    3b80:	b7c50513          	add	a0,a0,-1156 # 76f8 <malloc+0x19fc>
    ...
    3b9c:	b8050513          	add	a0,a0,-1152 # 7718 <malloc+0x1a1c>
...
0000000000003bb2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3bc8:	b7450513          	add	a0,a0,-1164 # 7738 <malloc+0x1a3c>
  ...
  if(chdir("dirfile") == 0){
    ...
    3be4:	b5850513          	add	a0,a0,-1192 # 7738 <malloc+0x1a3c>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3bf8:	b8c50513          	add	a0,a0,-1140 # 7780 <malloc+0x1a84>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3c10:	b7450513          	add	a0,a0,-1164 # 7780 <malloc+0x1a84>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3c24:	b6050513          	add	a0,a0,-1184 # 7780 <malloc+0x1a84>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3c38:	b4c50513          	add	a0,a0,-1204 # 7780 <malloc+0x1a84>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c4c:	b3858593          	add	a1,a1,-1224 # 7780 <malloc+0x1a84>
    3c50:	00002517          	auipc	a0,0x2
    3c54:	39050513          	add	a0,a0,912 # 5fe0 <malloc+0x2e4>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c68:	ad450513          	add	a0,a0,-1324 # 7738 <malloc+0x1a3c>
  ...
  fd = open(".", O_RDWR);
    ...
    3c7e:	87650513          	add	a0,a0,-1930 # 64f0 <malloc+0x7f4>
  ...
  fd = open(".", 0);
    ...
    3c94:	86050513          	add	a0,a0,-1952 # 64f0 <malloc+0x7f4>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ca8:	20458593          	add	a1,a1,516 # 5ea8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    3cd4:	a7050513          	add	a0,a0,-1424 # 7740 <malloc+0x1a44>
    ...
    3cf0:	a7450513          	add	a0,a0,-1420 # 7760 <malloc+0x1a64>
    ...
    3d0c:	a8850513          	add	a0,a0,-1400 # 7790 <malloc+0x1a94>
    ...
    3d28:	a6c50513          	add	a0,a0,-1428 # 7790 <malloc+0x1a94>
    ...
    3d44:	a7850513          	add	a0,a0,-1416 # 77b8 <malloc+0x1abc>
    ...
    3d60:	a8450513          	add	a0,a0,-1404 # 77e0 <malloc+0x1ae4>
    ...
    3d7c:	a9050513          	add	a0,a0,-1392 # 7808 <malloc+0x1b0c>
    ...
    3d98:	a9c50513          	add	a0,a0,-1380 # 7830 <malloc+0x1b34>
    ...
    3db4:	aa050513          	add	a0,a0,-1376 # 7850 <malloc+0x1b54>
    ...
    3dd0:	aac50513          	add	a0,a0,-1364 # 7878 <malloc+0x1b7c>
...
0000000000003de6 <iref>:
{
    ...
    3e04:	a90a0a13          	add	s4,s4,-1392 # 7890 <malloc+0x1b94>
    mkdir("");
    3e08:	00003497          	auipc	s1,0x3
    3e0c:	59048493          	add	s1,s1,1424 # 7398 <malloc+0x169c>
    link("README", "");
    3e10:	00002a97          	auipc	s5,0x2
    3e14:	1d0a8a93          	add	s5,s5,464 # 5fe0 <malloc+0x2e4>
    fd = open("xx", O_CREATE);
    3e18:	00004997          	auipc	s3,0x4
    3e1c:	97098993          	add	s3,s3,-1680 # 7788 <malloc+0x1a8c>
    3e20:	a891                	j	3e74 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3e22:	85da                	mv	a1,s6
    3e24:	00004517          	auipc	a0,0x4
    3e28:	a7450513          	add	a0,a0,-1420 # 7898 <malloc+0x1b9c>
    ...
    3e44:	a7050513          	add	a0,a0,-1424 # 78b0 <malloc+0x1bb4>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3ed8:	1e498993          	add	s3,s3,484 # 70b8 <malloc+0x13bc>
    unlink("irefd");
    3edc:	00004917          	auipc	s2,0x4
    3ee0:	9b490913          	add	s2,s2,-1612 # 7890 <malloc+0x1b94>
    chdir("..");
    3ee4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3f00:	16450513          	add	a0,a0,356 # 7060 <malloc+0x1364>
...
0000000000003f20 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3f30:	99c50513          	add	a0,a0,-1636 # 78c8 <malloc+0x1bcc>
  ...
  if(pid == 0){
    ...
    3f54:	97850513          	add	a0,a0,-1672 # 78c8 <malloc+0x1bcc>
    ...
    3f6a:	98250513          	add	a0,a0,-1662 # 78e8 <malloc+0x1bec>
    ...
    3f86:	94e50513          	add	a0,a0,-1714 # 78d0 <malloc+0x1bd4>
    ...
    3fa2:	6f250513          	add	a0,a0,1778 # 6690 <malloc+0x994>
  ...
  if(unlink("oidir") != 0){
    ...
    3fd0:	8fc50513          	add	a0,a0,-1796 # 78c8 <malloc+0x1bcc>
    ...
    3fe4:	8a050513          	add	a0,a0,-1888 # 6880 <malloc+0xb84>
...
0000000000004012 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4022:	8f250513          	add	a0,a0,-1806 # 7910 <malloc+0x1c14>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    404e:	8c650513          	add	a0,a0,-1850 # 7910 <malloc+0x1c14>
  ...
  sleep(10); // one second
    ...
    4086:	7ce50513          	add	a0,a0,1998 # 6850 <malloc+0xb54>
    ...
    40a0:	87448493          	add	s1,s1,-1932 # 7910 <malloc+0x1c14>
    40a4:	4581                	li	a1,0
    40a6:	8526                	mv	a0,s1
    ...
    40c8:	84c50513          	add	a0,a0,-1972 # 7910 <malloc+0x1c14>
...
00000000000040e8 <killstatus>:
{
  ...
  exit(0);
    ...
    414e:	54650513          	add	a0,a0,1350 # 6690 <malloc+0x994>
    ...
    4174:	7b050513          	add	a0,a0,1968 # 7920 <malloc+0x1c24>
...
000000000000418a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    41b4:	6a050513          	add	a0,a0,1696 # 6850 <malloc+0xb54>
  ...
  if(pid2 == 0)
    ...
    41e2:	4b250513          	add	a0,a0,1202 # 6690 <malloc+0x994>
  ...
  if(pid3 == 0){
    ...
    4226:	c8658593          	add	a1,a1,-890 # 5ea8 <malloc+0x1ac>
    ...
    4250:	44450513          	add	a0,a0,1092 # 6690 <malloc+0x994>
    ...
    426c:	6d850513          	add	a0,a0,1752 # 7940 <malloc+0x1c44>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	be858593          	add	a1,a1,-1048 # be70 <buf>
    ...
    42a8:	6b450513          	add	a0,a0,1716 # 7958 <malloc+0x1c5c>
  ...
  printf("kill... ");
    ...
    42d4:	6a050513          	add	a0,a0,1696 # 7970 <malloc+0x1c74>
  ...
  printf("wait... ");
    ...
    4302:	68250513          	add	a0,a0,1666 # 7980 <malloc+0x1c84>
...
000000000000432e <reparent>:
{
  ...
  exit(0);
    ...
    4382:	31250513          	add	a0,a0,786 # 6690 <malloc+0x994>
    ...
    439e:	47e50513          	add	a0,a0,1150 # 6818 <malloc+0xb1c>
...
00000000000043de <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4414:	38850513          	add	a0,a0,904 # 6798 <malloc+0xa9c>
    ...
    4448:	a6458593          	add	a1,a1,-1436 # 5ea8 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    450c:	48850513          	add	a0,a0,1160 # 7990 <malloc+0x1c94>
    ...
    4528:	16c50513          	add	a0,a0,364 # 6690 <malloc+0x994>
    ...
    4574:	44050513          	add	a0,a0,1088 # 79b0 <malloc+0x1cb4>
...
0000000000004594 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4618:	3cc50513          	add	a0,a0,972 # 79e0 <malloc+0x1ce4>
...
0000000000004638 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    46da:	33a50513          	add	a0,a0,826 # 7a10 <malloc+0x1d14>
    ...
    46f6:	34650513          	add	a0,a0,838 # 7a38 <malloc+0x1d3c>
  ...
  fd = open("sharedfd", 0);
    ...
    473a:	2ca50513          	add	a0,a0,714 # 7a00 <malloc+0x1d04>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    477a:	2e250513          	add	a0,a0,738 # 7a58 <malloc+0x1d5c>
  ...
  unlink("sharedfd");
    ...
    47b6:	24e50513          	add	a0,a0,590 # 7a00 <malloc+0x1d04>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    47dc:	2a850513          	add	a0,a0,680 # 7a80 <malloc+0x1d84>
...
00000000000047fc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4820:	27c78793          	add	a5,a5,636 # 7a98 <malloc+0x1d9c>
    4824:	f6f43823          	sd	a5,-144(s0)
    4828:	00003797          	auipc	a5,0x3
    482c:	27878793          	add	a5,a5,632 # 7aa0 <malloc+0x1da4>
    4830:	f6f43c23          	sd	a5,-136(s0)
    4834:	00003797          	auipc	a5,0x3
    4838:	27478793          	add	a5,a5,628 # 7aa8 <malloc+0x1dac>
    483c:	f8f43023          	sd	a5,-128(s0)
    4840:	00003797          	auipc	a5,0x3
    4844:	27078793          	add	a5,a5,624 # 7ab0 <malloc+0x1db4>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    489c:	5d8a0a13          	add	s4,s4,1496 # be70 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    48b2:	20250513          	add	a0,a0,514 # 6ab0 <malloc+0xdb4>
    ...
    492c:	19050513          	add	a0,a0,400 # 7ab8 <malloc+0x1dbc>
    ...
    4946:	18650513          	add	a0,a0,390 # 7ac8 <malloc+0x1dcc>
    ...
    496c:	17850513          	add	a0,a0,376 # 7ae0 <malloc+0x1de4>
    ...
    499c:	4d878793          	add	a5,a5,1240 # be70 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49f4:	10050513          	add	a0,a0,256 # 7af0 <malloc+0x1df4>
...
0000000000004a28 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a56:	0b6b8b93          	add	s7,s7,182 # 7b08 <malloc+0x1e0c>
  for(i = 0; i < N; i++){
    ...
    4a98:	07c50513          	add	a0,a0,124 # 7b10 <malloc+0x1e14>
    ...
    4ab6:	05650513          	add	a0,a0,86 # 7b08 <malloc+0x1e0c>
  ...
  fd = open(".", 0);
    ...
    4aee:	a0650513          	add	a0,a0,-1530 # 64f0 <malloc+0x7f4>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b66:	fce50513          	add	a0,a0,-50 # 7b30 <malloc+0x1e34>
    ...
    4b86:	fce50513          	add	a0,a0,-50 # 7b50 <malloc+0x1e54>
  ...
  for(i = 0; i < N; i++){
    ...
    4bbe:	fbe50513          	add	a0,a0,-66 # 7b78 <malloc+0x1e7c>
    ...
    4bda:	aba50513          	add	a0,a0,-1350 # 6690 <malloc+0x994>
...
0000000000004d84 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	0b090913          	add	s2,s2,176 # be70 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4e0c:	da850513          	add	a0,a0,-600 # 7bb0 <malloc+0x1eb4>
  ...
  for(i = 0; ; i++){
    ...
    4e22:	05290913          	add	s2,s2,82 # be70 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e70:	d5450513          	add	a0,a0,-684 # 7bc0 <malloc+0x1ec4>
    ...
    4e8c:	d5850513          	add	a0,a0,-680 # 7be0 <malloc+0x1ee4>
    ...
    4ea8:	d5c50513          	add	a0,a0,-676 # 7c00 <malloc+0x1f04>
    ...
    4ec4:	d6050513          	add	a0,a0,-672 # 7c20 <malloc+0x1f24>
    ...
    4ee0:	d6450513          	add	a0,a0,-668 # 7c40 <malloc+0x1f44>
    ...
    4efc:	d6050513          	add	a0,a0,-672 # 7c58 <malloc+0x1f5c>
  ...
  unlink("bigfile.dat");
    ...
    4f2a:	c8a50513          	add	a0,a0,-886 # 7bb0 <malloc+0x1eb4>
    ...
    4f4e:	d2e50513          	add	a0,a0,-722 # 7c78 <malloc+0x1f7c>
...
0000000000004f64 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f84:	d1850513          	add	a0,a0,-744 # 7c98 <malloc+0x1f9c>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fa4:	d08c8c93          	add	s9,s9,-760 # 7ca8 <malloc+0x1fac>
    name[0] = 'f';
    ...
    5014:	ca850513          	add	a0,a0,-856 # 7cb8 <malloc+0x1fbc>
  ...
  printf("fsfull test finished\n");
    ...
    508a:	c5250513          	add	a0,a0,-942 # 7cd8 <malloc+0x1fdc>
    ...
    50b8:	dbca8a93          	add	s5,s5,-580 # be70 <buf>
      if(cc < BSIZE)
    ...
    50e0:	bec50513          	add	a0,a0,-1044 # 7cc8 <malloc+0x1fcc>
...
00000000000050fe <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5172:	b8250513          	add	a0,a0,-1150 # 7cf0 <malloc+0x1ff4>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    518a:	d2258593          	add	a1,a1,-734 # 5ea8 <malloc+0x1ac>
    ...
    51a0:	b7450513          	add	a0,a0,-1164 # 7d10 <malloc+0x2014>
    ...
    51ba:	b4250513          	add	a0,a0,-1214 # 7cf8 <malloc+0x1ffc>
    ...
    51d4:	b2850513          	add	a0,a0,-1240 # 7cf8 <malloc+0x1ffc>
  ...
  unlink("junk");
    ...
    51f8:	afc50513          	add	a0,a0,-1284 # 7cf0 <malloc+0x1ff4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    524e:	c5e98993          	add	s3,s3,-930 # 5ea8 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    5280:	ae450513          	add	a0,a0,-1308 # 7d60 <malloc+0x2064>
    ...
    52a0:	a8450513          	add	a0,a0,-1404 # 7d20 <malloc+0x2024>
    ...
    52c0:	a8450513          	add	a0,a0,-1404 # 7d40 <malloc+0x2044>
  ...
  while(1){
    ...
    5314:	a7050513          	add	a0,a0,-1424 # 7d80 <malloc+0x2084>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5360:	a4450513          	add	a0,a0,-1468 # 7da0 <malloc+0x20a4>
  ...
  if(pid == 0) {
    ...
    5390:	a3c50513          	add	a0,a0,-1476 # 7dc8 <malloc+0x20cc>
    ...
    53b4:	a0050513          	add	a0,a0,-1536 # 7db0 <malloc+0x20b4>
    ...
    53dc:	9f850513          	add	a0,a0,-1544 # 7dd0 <malloc+0x20d4>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5426:	dce78793          	add	a5,a5,-562 # 81f0 <malloc+0x24f4>
    542a:	bd040713          	add	a4,s0,-1072
    542e:	00003317          	auipc	t1,0x3
    5432:	1b230313          	add	t1,t1,434 # 85e0 <malloc+0x28e4>
  ...
  printf("usertests starting\n");
    ...
    5466:	a2e50513          	add	a0,a0,-1490 # 7e90 <malloc+0x2194>
  ...
  if(fail){
    ...
    54a0:	9ac50513          	add	a0,a0,-1620 # 7e48 <malloc+0x214c>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54d0:	90c58593          	add	a1,a1,-1780 # 7dd8 <malloc+0x20dc>
    ...
    54e6:	d0e78793          	add	a5,a5,-754 # 81f0 <malloc+0x24f4>
    54ea:	bd040713          	add	a4,s0,-1072
    54ee:	00003317          	auipc	t1,0x3
    54f2:	0f230313          	add	t1,t1,242 # 85e0 <malloc+0x28e4>
    ...
    5526:	98650513          	add	a0,a0,-1658 # 7ea8 <malloc+0x21ac>
    552a:	00000097          	auipc	ra,0x0
    552e:	71a080e7          	jalr	1818(ra) # 5c44 <printf>
        printf("SOME TESTS FAILED\n");
    5532:	00003a97          	auipc	s5,0x3
    5536:	8fea8a93          	add	s5,s5,-1794 # 7e30 <malloc+0x2134>
        if(continuous != 2)
    553a:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    553c:	00003b17          	auipc	s6,0x3
    5540:	8d4b0b13          	add	s6,s6,-1836 # 7e10 <malloc+0x2114>
    5544:	a8f5                	j	5640 <main+0x256>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    5546:	00003597          	auipc	a1,0x3
    554a:	89a58593          	add	a1,a1,-1894 # 7de0 <malloc+0x20e4>
    ...
    5584:	86850513          	add	a0,a0,-1944 # 7de8 <malloc+0x20ec>
  ...
  if(fail){
    ...
    55f6:	83e50513          	add	a0,a0,-1986 # 7e30 <malloc+0x2134>
    ...
    5610:	86c50513          	add	a0,a0,-1940 # 7e78 <malloc+0x217c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    59c0:	c7c50513          	add	a0,a0,-900 # 8638 <digits>
    59c4:	883a                	mv	a6,a4
    59c6:	2705                	addw	a4,a4,1
    59c8:	02c5f7bb          	remuw	a5,a1,a2
    59cc:	1782                	sll	a5,a5,0x20
    59ce:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5b52:	aeab8b93          	add	s7,s7,-1302 # 8638 <digits>
    5b56:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b6a:	0992                	sll	s3,s3,0x4
    5b6c:	397d                	addw	s2,s2,-1
    ...
    5ba8:	62490913          	add	s2,s2,1572 # 81c8 <malloc+0x24cc>
        while(*s != 0){
    5bac:	02800593          	li	a1,40
    5bb0:	bff1                	j	5b8c <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5bb2:	008b8913          	add	s2,s7,8
...
{
    5c16:	715d                	add	sp,sp,-80
    5c18:	ec06                	sd	ra,24(sp)
    5c1a:	e822                	sd	s0,16(sp)
    5c1c:	1000                	add	s0,sp,32
...
{
    5c44:	711d                	add	sp,sp,-96
    5c46:	ec06                	sd	ra,24(sp)
    5c48:	e822                	sd	s0,16(sp)
    5c4a:	1000                	add	s0,sp,32
...
free(void *ap)
{
    ...
    5c7e:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c80:	ff050693          	add	a3,a0,-16
    ...
    5cb0:	00e6ea63          	bltu	a3,a4,5cc4 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5cca:	02059813          	sll	a6,a1,0x20
    5cce:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    5cde:	02061593          	sll	a1,a2,0x20
    5ce2:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5d08:	02051493          	sll	s1,a0,0x20
    5d0c:	9081                	srl	s1,s1,0x20
    5d0e:	04bd                	add	s1,s1,15
    5d10:	8091                	srl	s1,s1,0x4
    5d12:	0014899b          	addw	s3,s1,1
    5d16:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d4c:	90890913          	add	s2,s2,-1784 # 8650 <freep>
  if(p == (char*)-1)
    5d50:	5afd                	li	s5,-1
    ...
    5d60:	11478793          	add	a5,a5,276 # ee70 <base>
  ...
  if(p == (char*)-1)
    ...
    5dca:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5dcc:	02071693          	sll	a3,a4,0x20
    5dd0:	01c6d713          	srl	a4,a3,0x1c
