 ...
 */
    ...
    lo = x % 127773;
      16:	66fd                	lui	a3,0x1f
      18:	31d68693          	add	a3,a3,797 # 1f31d <__global_pointer$+0x1d414>
      1c:	02d7e733          	rem	a4,a5,a3
    x = 16807 * lo - 2836 * hi;
      20:	6611                	lui	a2,0x4
      22:	1a760613          	add	a2,a2,423 # 41a7 <__global_pointer$+0x229e>
      26:	02c70733          	mul	a4,a4,a2
    hi = x / 127773;
      2a:	02d7c7b3          	div	a5,a5,a3
    x = 16807 * lo - 2836 * hi;
      2e:	76fd                	lui	a3,0xfffff
      30:	4ec68693          	add	a3,a3,1260 # fffffffffffff4ec <__global_pointer$+0xffffffffffffd5e3>
...
rand(void)
{
    ...
    return (do_rand(&rand_next));
      ...
      64:	6b050513          	add	a0,a0,1712 # 1710 <rand_next>
...
go(int which_child)
{
  ...
  mkdir("grindir");
      ...
      96:	29e50513          	add	a0,a0,670 # 1330 <malloc+0x106>
      9a:	00001097          	auipc	ra,0x1
      9e:	dd8080e7          	jalr	-552(ra) # e72 <mkdir>
  if(chdir("grindir") != 0){
      a2:	00001517          	auipc	a0,0x1
      a6:	28e50513          	add	a0,a0,654 # 1330 <malloc+0x106>
    ...
    printf("grind: chdir grindir failed\n");
      ...
      c0:	27c50513          	add	a0,a0,636 # 1338 <malloc+0x10e>
  ...
  chdir("/");
      ...
      e2:	28250513          	add	a0,a0,642 # 1360 <malloc+0x136>
      e6:	00001097          	auipc	ra,0x1
      ea:	d94080e7          	jalr	-620(ra) # e7a <chdir>
      ee:	00001997          	auipc	s3,0x1
      f2:	28298993          	add	s3,s3,642 # 1370 <malloc+0x146>
      f6:	c489                	beqz	s1,100 <go+0x88>
      f8:	00001997          	auipc	s3,0x1
      fc:	27098993          	add	s3,s3,624 # 1368 <malloc+0x13e>
  uint64 iters = 0;
     100:	4481                	li	s1,0
  int fd = -1;
     102:	5a7d                	li	s4,-1
     104:	00001917          	auipc	s2,0x1
     108:	53c90913          	add	s2,s2,1340 # 1640 <malloc+0x416>
    ...
    if(what == 1){
     ...
     116:	26650513          	add	a0,a0,614 # 1378 <malloc+0x14e>
    ...
    int what = rand() % 23;
     ...
     174:	21850513          	add	a0,a0,536 # 1388 <malloc+0x15e>
     ...
     18e:	1ee50513          	add	a0,a0,494 # 1378 <malloc+0x14e>
     ...
     1a0:	19450513          	add	a0,a0,404 # 1330 <malloc+0x106>
     ...
     1fc:	1b050513          	add	a0,a0,432 # 13a8 <malloc+0x17e>
     ...
     21e:	19e50513          	add	a0,a0,414 # 13b8 <malloc+0x18e>
     ...
     236:	4ee58593          	add	a1,a1,1262 # 1720 <buf.0>
     23a:	8552                	mv	a0,s4
     ...
     24e:	4d658593          	add	a1,a1,1238 # 1720 <buf.0>
     252:	8552                	mv	a0,s4
     ...
     28e:	15650513          	add	a0,a0,342 # 13e0 <malloc+0x1b6>
     ...
     2cc:	13850513          	add	a0,a0,312 # 1400 <malloc+0x1d6>
     ...
     2de:	12e50513          	add	a0,a0,302 # 1408 <malloc+0x1de>
     2e2:	00001097          	auipc	ra,0x1
     2e6:	b78080e7          	jalr	-1160(ra) # e5a <unlink>
      link("../grindir/./../a", "../b");
     2ea:	00001597          	auipc	a1,0x1
     2ee:	0b658593          	add	a1,a1,182 # 13a0 <malloc+0x176>
     2f2:	00001517          	auipc	a0,0x1
     2f6:	11e50513          	add	a0,a0,286 # 1410 <malloc+0x1e6>
     ...
     308:	12450513          	add	a0,a0,292 # 1428 <malloc+0x1fe>
     30c:	00001097          	auipc	ra,0x1
     310:	b4e080e7          	jalr	-1202(ra) # e5a <unlink>
      link(".././b", "/grindir/../a");
     314:	00001597          	auipc	a1,0x1
     318:	09458593          	add	a1,a1,148 # 13a8 <malloc+0x17e>
     31c:	00001517          	auipc	a0,0x1
     320:	11c50513          	add	a0,a0,284 # 1438 <malloc+0x20e>
     ...
     354:	0f050513          	add	a0,a0,240 # 1440 <malloc+0x216>
     ...
     3a2:	0a250513          	add	a0,a0,162 # 1440 <malloc+0x216>
     ...
     3b4:	a5a080e7          	jalr	-1446(ra) # e0a <exit>
      ...
      sbrk(6011);
     3b8:	6505                	lui	a0,0x1
     3ba:	77b50513          	add	a0,a0,1915 # 177b <buf.0+0x5b>
     ...
     402:	06250513          	add	a0,a0,98 # 1460 <malloc+0x236>
     ...
     42e:	02e50513          	add	a0,a0,46 # 1458 <malloc+0x22e>
     ...
     450:	ff450513          	add	a0,a0,-12 # 1440 <malloc+0x216>
     ...
     46a:	00a50513          	add	a0,a0,10 # 1470 <malloc+0x246>
     ...
     4b8:	f8c50513          	add	a0,a0,-116 # 1440 <malloc+0x216>
     ...
     514:	f7850513          	add	a0,a0,-136 # 1488 <malloc+0x25e>
     ...
     540:	f6458593          	add	a1,a1,-156 # 14a0 <malloc+0x276>
     ...
     642:	e0250513          	add	a0,a0,-510 # 1440 <malloc+0x216>
     ...
     65c:	e9850513          	add	a0,a0,-360 # 14f0 <malloc+0x2c6>
     ...
     670:	e8450513          	add	a0,a0,-380 # 14f0 <malloc+0x2c6>
     ...
     688:	e1c58593          	add	a1,a1,-484 # 14a0 <malloc+0x276>
     ...
     6ce:	e2650513          	add	a0,a0,-474 # 14f0 <malloc+0x2c6>
     6d2:	00000097          	auipc	ra,0x0
     6d6:	788080e7          	jalr	1928(ra) # e5a <unlink>
     6da:	bc81                	j	12a <go+0xb2>
        printf("grind: create c failed\n");
     6dc:	00001517          	auipc	a0,0x1
     6e0:	e1c50513          	add	a0,a0,-484 # 14f8 <malloc+0x2ce>
     ...
     6fa:	e1a50513          	add	a0,a0,-486 # 1510 <malloc+0x2e6>
     ...
     714:	e1850513          	add	a0,a0,-488 # 1528 <malloc+0x2fe>
     ...
     730:	e1450513          	add	a0,a0,-492 # 1540 <malloc+0x316>
     ...
     74a:	e2250513          	add	a0,a0,-478 # 1568 <malloc+0x33e>
     ...
     832:	dda58593          	add	a1,a1,-550 # 1608 <malloc+0x3de>
     ...
     856:	dbe50513          	add	a0,a0,-578 # 1610 <malloc+0x3e6>
     ...
     870:	c1c58593          	add	a1,a1,-996 # 1488 <malloc+0x25e>
     874:	4509                	li	a0,2
     ...
     88c:	c0058593          	add	a1,a1,-1024 # 1488 <malloc+0x25e>
     890:	4509                	li	a0,2
     ...
     8e8:	cac58593          	add	a1,a1,-852 # 1590 <malloc+0x366>
     8ec:	4509                	li	a0,2
     ...
     95c:	ae858593          	add	a1,a1,-1304 # 1440 <malloc+0x216>
     960:	4509                	li	a0,2
     ...
     9a8:	bec58593          	add	a1,a1,-1044 # 1590 <malloc+0x366>
     9ac:	4509                	li	a0,2
     ...
     9ec:	ba858593          	add	a1,a1,-1112 # 1590 <malloc+0x366>
     9f0:	4509                	li	a0,2
     ...
     a54:	9f058593          	add	a1,a1,-1552 # 1440 <malloc+0x216>
     a58:	4509                	li	a0,2
...
iter()
{
  ...
  unlink("a");
     ...
     a78:	9e450513          	add	a0,a0,-1564 # 1458 <malloc+0x22e>
     a7c:	00000097          	auipc	ra,0x0
     a80:	3de080e7          	jalr	990(ra) # e5a <unlink>
  unlink("b");
     a84:	00001517          	auipc	a0,0x1
     a88:	98450513          	add	a0,a0,-1660 # 1408 <malloc+0x1de>
  ...
  if(pid1 == 0){
    ...
    printf("grind: fork failed\n");
     ...
     ac4:	98050513          	add	a0,a0,-1664 # 1440 <malloc+0x216>
  ...
  if(pid2 == 0){
    ...
    rand_next = 7177;
     aec:	6789                	lui	a5,0x2
     aee:	c0978793          	add	a5,a5,-1015 # 1c09 <__BSS_END__+0xf1>
    ...
    printf("grind: fork failed\n");
     ...
     b08:	93c50513          	add	a0,a0,-1732 # 1440 <malloc+0x216>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     eee:	80e50513          	add	a0,a0,-2034 # 16f8 <digits>
     ef2:	883a                	mv	a6,a4
  ...
  while(--i >= 0)
     ...
     f36:	fc040793          	add	a5,s0,-64
     f3a:	00e78933          	add	s2,a5,a4
     f3e:	fff78993          	add	s3,a5,-1
     f42:	99ba                	add	s3,s3,a4
     f44:	377d                	addw	a4,a4,-1
     f46:	1702                	sll	a4,a4,0x20
     f48:	9301                	srl	a4,a4,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  for(i = 0; fmt[i]; i++){
    ...
    if(state == 0){
     ...
     ff4:	6b070713          	add	a4,a4,1712 # 16a0 <malloc+0x476>
  ...
  putc(fd, 'x');
    ...
    1080:	67cb8b93          	add	s7,s7,1660 # 16f8 <digits>
    1084:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    1098:	0992                	sll	s3,s3,0x4
    109a:	397d                	addw	s2,s2,-1
    ...
    10d6:	56690913          	add	s2,s2,1382 # 1638 <malloc+0x40e>
        while(*s != 0){
    10da:	02800593          	li	a1,40
    10de:	bff1                	j	10ba <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    10e0:	008b8913          	add	s2,s7,8
...
{
    1144:	715d                	add	sp,sp,-80
    1146:	ec06                	sd	ra,24(sp)
    1148:	e822                	sd	s0,16(sp)
    114a:	1000                	add	s0,sp,32
...
{
    1172:	711d                	add	sp,sp,-96
    1174:	ec06                	sd	ra,24(sp)
    1176:	e822                	sd	s0,16(sp)
    1178:	1000                	add	s0,sp,32
...
free(void *ap)
{
    11a8:	1141                	add	sp,sp,-16
    11aa:	e422                	sd	s0,8(sp)
    11ac:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    11ae:	ff050693          	add	a3,a0,-16
    ...
    11de:	00e6ea63          	bltu	a3,a4,11f2 <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    11f8:	02059813          	sll	a6,a1,0x20
    11fc:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    120c:	02061593          	sll	a1,a2,0x20
    1210:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
    122a:	7139                	add	sp,sp,-64
    122c:	fc06                	sd	ra,56(sp)
    122e:	f822                	sd	s0,48(sp)
    1230:	f426                	sd	s1,40(sp)
    1232:	ec4e                	sd	s3,24(sp)
    1234:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    1236:	02051493          	sll	s1,a0,0x20
    123a:	9081                	srl	s1,s1,0x20
    123c:	04bd                	add	s1,s1,15
    123e:	8091                	srl	s1,s1,0x4
    1240:	0014899b          	addw	s3,s1,1
    1244:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    127a:	4a290913          	add	s2,s2,1186 # 1718 <freep>
  if(p == (char*)-1)
    127e:	5afd                	li	s5,-1
    ...
    128e:	87e78793          	add	a5,a5,-1922 # 1b08 <base>
  ...
  if(p == (char*)-1)
    ...
    12f8:	c798                	sw	a4,8(a5)
        p += p->s.size;
    12fa:	02071693          	sll	a3,a4,0x20
    12fe:	01c6d713          	srl	a4,a3,0x1c
