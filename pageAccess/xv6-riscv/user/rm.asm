...
main(int argc, char *argv[])
{
  ...
  44:	7d058593          	add	a1,a1,2000 # 810 <malloc+0x102>
  48:	4509                	li	a0,2
  ...
  62:	7ca58593          	add	a1,a1,1994 # 828 <malloc+0x11a>
  66:	4509                	li	a0,2
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3d2:	4da50513          	add	a0,a0,1242 # 8a8 <digits>
 3d6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4d8:	37c70713          	add	a4,a4,892 # 850 <malloc+0x142>
 ...
 564:	348b8b93          	add	s7,s7,840 # 8a8 <digits>
 ...
 5ba:	29290913          	add	s2,s2,658 # 848 <malloc+0x13a>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 75e:	16690913          	add	s2,s2,358 # 8c0 <freep>
  if(p == (char*)-1)
 762:	5afd                	li	s5,-1
 ...
 772:	15a78793          	add	a5,a5,346 # 8c8 <base>
