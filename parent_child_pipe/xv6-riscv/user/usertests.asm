...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	dba50513          	add	a0,a0,-582 # 5df8 <malloc+0x104>
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	70078793          	add	a5,a5,1792 # 9758 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e0868693          	add	a3,a3,-504 # be68 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	d9850513          	add	a0,a0,-616 # 5e18 <malloc+0x124>
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d8850513          	add	a0,a0,-632 # 5e30 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d8a50513          	add	a0,a0,-630 # 5e50 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d5250513          	add	a0,a0,-686 # 5e38 <malloc+0x144>
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d5e50513          	add	a0,a0,-674 # 5e60 <malloc+0x16c>
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d5c50513          	add	a0,a0,-676 # 5e88 <malloc+0x194>
     134:	00005097          	auipc	ra,0x5
     138:	7f0080e7          	jalr	2032(ra) # 5924 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	d4850513          	add	a0,a0,-696 # 5e88 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	d4458593          	add	a1,a1,-700 # 5e98 <malloc+0x1a4>
     15c:	00005097          	auipc	ra,0x5
     160:	798080e7          	jalr	1944(ra) # 58f4 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d2050513          	add	a0,a0,-736 # 5e88 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d2458593          	add	a1,a1,-732 # 5ea0 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	cf450513          	add	a0,a0,-780 # 5e88 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	cde50513          	add	a0,a0,-802 # 5ea8 <malloc+0x1b4>
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c5450513          	add	a0,a0,-940 # 5ed0 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	c40a8a93          	add	s5,s5,-960 # 5ed0 <malloc+0x1dc>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	bd0a0a13          	add	s4,s4,-1072 # be68 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	bce50513          	add	a0,a0,-1074 # 5ee0 <malloc+0x1ec>
     ...
     338:	bcc50513          	add	a0,a0,-1076 # 5f00 <malloc+0x20c>
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	ba8a0a13          	add	s4,s4,-1112 # 5f18 <malloc+0x224>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	b0450513          	add	a0,a0,-1276 # 5f20 <malloc+0x22c>
     ...
     43e:	afe50513          	add	a0,a0,-1282 # 5f38 <malloc+0x244>
     ...
     45c:	b1050513          	add	a0,a0,-1264 # 5f68 <malloc+0x274>
     ...
     476:	b2650513          	add	a0,a0,-1242 # 5f98 <malloc+0x2a4>
     ...
     494:	b1850513          	add	a0,a0,-1256 # 5fa8 <malloc+0x2b4>
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	b0aa0a13          	add	s4,s4,-1270 # 5fd8 <malloc+0x2e4>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	9caa8a93          	add	s5,s5,-1590 # 5ea0 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a6450513          	add	a0,a0,-1436 # 5fe0 <malloc+0x2ec>
     ...
     59e:	a5e50513          	add	a0,a0,-1442 # 5ff8 <malloc+0x304>
     ...
     5b8:	9e450513          	add	a0,a0,-1564 # 5f98 <malloc+0x2a4>
     ...
     5d2:	a5a50513          	add	a0,a0,-1446 # 6028 <malloc+0x334>
     ...
     5f0:	a5450513          	add	a0,a0,-1452 # 6040 <malloc+0x34c>
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	85658593          	add	a1,a1,-1962 # 5e98 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	82a50513          	add	a0,a0,-2006 # 5e88 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	7fe50513          	add	a0,a0,2046 # 5e88 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	7ea50513          	add	a0,a0,2026 # 5e88 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	9f458593          	add	a1,a1,-1548 # 60d0 <malloc+0x3dc>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	76a50513          	add	a0,a0,1898 # 5e88 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	90e50513          	add	a0,a0,-1778 # 6070 <malloc+0x37c>
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	91250513          	add	a0,a0,-1774 # 6090 <malloc+0x39c>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     796:	90e50513          	add	a0,a0,-1778 # 60a0 <malloc+0x3ac>
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	91250513          	add	a0,a0,-1774 # 60c0 <malloc+0x3cc>
    ...
    printf("%s: read %d bytes, wanted 0\n", s, n);
     ...
     7c6:	8de50513          	add	a0,a0,-1826 # 60a0 <malloc+0x3ac>
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	8f850513          	add	a0,a0,-1800 # 60d8 <malloc+0x3e4>
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	8fa50513          	add	a0,a0,-1798 # 60f8 <malloc+0x404>
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	8e650513          	add	a0,a0,-1818 # 6118 <malloc+0x424>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	8f698993          	add	s3,s3,-1802 # 6140 <malloc+0x44c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	926a8a93          	add	s5,s5,-1754 # 6178 <malloc+0x484>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	88050513          	add	a0,a0,-1920 # 6118 <malloc+0x424>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5b658593          	add	a1,a1,1462 # be68 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	84450513          	add	a0,a0,-1980 # 6118 <malloc+0x424>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	82250513          	add	a0,a0,-2014 # 6120 <malloc+0x42c>
    ...
    exit(1);
     ...
     920:	83450513          	add	a0,a0,-1996 # 6150 <malloc+0x45c>
     ...
     93e:	84e50513          	add	a0,a0,-1970 # 6188 <malloc+0x494>
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	85a50513          	add	a0,a0,-1958 # 61b0 <malloc+0x4bc>
    ...
    printf("%s: read failed\n", s);
     ...
     976:	85e50513          	add	a0,a0,-1954 # 61d0 <malloc+0x4dc>
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	85a50513          	add	a0,a0,-1958 # 61e8 <malloc+0x4f4>
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	84850513          	add	a0,a0,-1976 # 6208 <malloc+0x514>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	49490913          	add	s2,s2,1172 # be68 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	7f650513          	add	a0,a0,2038 # 6208 <malloc+0x514>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	44290913          	add	s2,s2,1090 # be68 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	7b650513          	add	a0,a0,1974 # 6210 <malloc+0x51c>
    ...
    exit(1);
     ...
     a7c:	7b850513          	add	a0,a0,1976 # 6230 <malloc+0x53c>
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	7c450513          	add	a0,a0,1988 # 6258 <malloc+0x564>
  ...
  if(unlink("big") < 0){
     ...
     ac4:	74850513          	add	a0,a0,1864 # 6208 <malloc+0x514>
     ...
     af0:	78c50513          	add	a0,a0,1932 # 6278 <malloc+0x584>
     ...
     b0e:	79650513          	add	a0,a0,1942 # 62a0 <malloc+0x5ac>
     ...
     b2c:	79050513          	add	a0,a0,1936 # 62b8 <malloc+0x5c4>
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	79c50513          	add	a0,a0,1948 # 62e0 <malloc+0x5ec>
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	78650513          	add	a0,a0,1926 # 62f8 <malloc+0x604>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	79e58593          	add	a1,a1,1950 # 6328 <malloc+0x634>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	75250513          	add	a0,a0,1874 # 62f8 <malloc+0x604>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	73c50513          	add	a0,a0,1852 # 62f8 <malloc+0x604>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	72650513          	add	a0,a0,1830 # 62f8 <malloc+0x604>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	78a58593          	add	a1,a1,1930 # 6370 <malloc+0x67c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	26658593          	add	a1,a1,614 # be68 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  if(write(fd, buf, 10) != 10){
     ...
     c30:	23c58593          	add	a1,a1,572 # be68 <buf>
     c34:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	6aa50513          	add	a0,a0,1706 # 62f8 <malloc+0x604>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	69a50513          	add	a0,a0,1690 # 6308 <malloc+0x614>
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	6a650513          	add	a0,a0,1702 # 6330 <malloc+0x63c>
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	6aa50513          	add	a0,a0,1706 # 6350 <malloc+0x65c>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	6b650513          	add	a0,a0,1718 # 6378 <malloc+0x684>
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	6ba50513          	add	a0,a0,1722 # 6398 <malloc+0x6a4>
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	6be50513          	add	a0,a0,1726 # 63b8 <malloc+0x6c4>
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	5ca58593          	add	a1,a1,1482 # 6328 <malloc+0x634>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	66258593          	add	a1,a1,1634 # 63e0 <malloc+0x6ec>
     d86:	00005517          	auipc	a0,0x5
     d8a:	65250513          	add	a0,a0,1618 # 63d8 <malloc+0x6e4>
  ...
  unlink("lf1");
     ...
     d9e:	63e50513          	add	a0,a0,1598 # 63d8 <malloc+0x6e4>
     da2:	00005097          	auipc	ra,0x5
     da6:	b82080e7          	jalr	-1150(ra) # 5924 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	62c50513          	add	a0,a0,1580 # 63d8 <malloc+0x6e4>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	61e50513          	add	a0,a0,1566 # 63e0 <malloc+0x6ec>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	08e58593          	add	a1,a1,142 # be68 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	5e658593          	add	a1,a1,1510 # 63e0 <malloc+0x6ec>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	5d050513          	add	a0,a0,1488 # 63e0 <malloc+0x6ec>
     e18:	00005097          	auipc	ra,0x5
     e1c:	b0c080e7          	jalr	-1268(ra) # 5924 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	5b858593          	add	a1,a1,1464 # 63d8 <malloc+0x6e4>
     e28:	00005517          	auipc	a0,0x5
     e2c:	5b850513          	add	a0,a0,1464 # 63e0 <malloc+0x6ec>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	59c58593          	add	a1,a1,1436 # 63d8 <malloc+0x6e4>
     e44:	00005517          	auipc	a0,0x5
     e48:	6a450513          	add	a0,a0,1700 # 64e8 <malloc+0x7f4>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	58250513          	add	a0,a0,1410 # 63e8 <malloc+0x6f4>
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	57e50513          	add	a0,a0,1406 # 6400 <malloc+0x70c>
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	57a50513          	add	a0,a0,1402 # 6418 <malloc+0x724>
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	57e50513          	add	a0,a0,1406 # 6438 <malloc+0x744>
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	59250513          	add	a0,a0,1426 # 6468 <malloc+0x774>
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	58e50513          	add	a0,a0,1422 # 6480 <malloc+0x78c>
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	58a50513          	add	a0,a0,1418 # 6498 <malloc+0x7a4>
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	59650513          	add	a0,a0,1430 # 64c0 <malloc+0x7cc>
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	5aa50513          	add	a0,a0,1450 # 64f0 <malloc+0x7fc>
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	564a0a13          	add	s4,s4,1380 # 6510 <malloc+0x81c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	51250513          	add	a0,a0,1298 # 6510 <malloc+0x81c>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	4aa50513          	add	a0,a0,1194 # 6518 <malloc+0x824>
    ...
    1092:	4aa50513          	add	a0,a0,1194 # 6538 <malloc+0x844>
    ...
    10ae:	4ae50513          	add	a0,a0,1198 # 6558 <malloc+0x864>
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	49c98993          	add	s3,s3,1180 # 6578 <malloc+0x884>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	47050513          	add	a0,a0,1136 # 6588 <malloc+0x894>
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	add	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1ce3>
...
badarg(char *s)
{
    ...
    1184:	35048493          	add	s1,s1,848 # c350 <buf+0x4e8>
  for(int i = 0; i < 50000; i++){
    ...
    1192:	ca298993          	add	s3,s3,-862 # 5e30 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	56878793          	add	a5,a5,1384 # 7780 <malloc+0x1a8c>
  ...
  if(pid == 0){
    ...
    1252:	50278793          	add	a5,a5,1282 # 8750 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	4fa68693          	add	a3,a3,1274 # 9750 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    1278:	f5478793          	add	a5,a5,-172 # 81c8 <malloc+0x24d4>
    ...
    129c:	b9850513          	add	a0,a0,-1128 # 5e30 <malloc+0x13c>
    ...
    12b4:	38050513          	add	a0,a0,896 # 6630 <malloc+0x93c>
    ...
    12d4:	2d850513          	add	a0,a0,728 # 65a8 <malloc+0x8b4>
    ...
    12f4:	2d850513          	add	a0,a0,728 # 65c8 <malloc+0x8d4>
    ...
    1316:	2d650513          	add	a0,a0,726 # 65e8 <malloc+0x8f4>
    ...
    1336:	2de50513          	add	a0,a0,734 # 6610 <malloc+0x91c>
    ...
    1350:	75c50513          	add	a0,a0,1884 # 6aa8 <malloc+0xdb4>
  ...
  if(st != 747){
    ...
    139a:	2c250513          	add	a0,a0,706 # 6658 <malloc+0x964>
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	ac850513          	add	a0,a0,-1336 # 5e88 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    13f6:	a96a0a13          	add	s4,s4,-1386 # 5e88 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	2bea8a93          	add	s5,s5,702 # 66b8 <malloc+0x9c4>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    1476:	21650513          	add	a0,a0,534 # 6688 <malloc+0x994>
    ...
    1492:	21250513          	add	a0,a0,530 # 66a0 <malloc+0x9ac>
    ...
    14b0:	21c50513          	add	a0,a0,540 # 66c8 <malloc+0x9d4>
    ...
    14d6:	9b6a0a13          	add	s4,s4,-1610 # 5e88 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    14da:	00005a97          	auipc	s5,0x5
    14de:	20ea8a93          	add	s5,s5,526 # 66e8 <malloc+0x9f4>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1528:	96450513          	add	a0,a0,-1692 # 5e88 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    1546:	15e50513          	add	a0,a0,350 # 66a0 <malloc+0x9ac>
    ...
    1564:	19050513          	add	a0,a0,400 # 66f0 <malloc+0x9fc>
...
000000000000157a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    158a:	8aa78793          	add	a5,a5,-1878 # 5e30 <malloc+0x13c>
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	00005797          	auipc	a5,0x5
    1596:	17e78793          	add	a5,a5,382 # 6710 <malloc+0xa1c>
    159a:	fcf43423          	sd	a5,-56(s0)
    159e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a2:	00005517          	auipc	a0,0x5
    15a6:	17650513          	add	a0,a0,374 # 6718 <malloc+0xa24>
  ...
  if(pid == 0) {
    ...
    15d6:	14650513          	add	a0,a0,326 # 6718 <malloc+0xa24>
    ...
    15f2:	14a50513          	add	a0,a0,330 # 6738 <malloc+0xa44>
    ...
    1610:	07c50513          	add	a0,a0,124 # 6688 <malloc+0x994>
    ...
    162c:	0f850513          	add	a0,a0,248 # 6720 <malloc+0xa2c>
    ...
    164a:	7ea50513          	add	a0,a0,2026 # 5e30 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    167e:	0ce50513          	add	a0,a0,206 # 6748 <malloc+0xa54>
    ...
    169a:	0ca50513          	add	a0,a0,202 # 6760 <malloc+0xa6c>
  ...
  fd = open("echo-ok", O_RDONLY);
    ...
    16ae:	06e50513          	add	a0,a0,110 # 6718 <malloc+0xa24>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d8:	afc50513          	add	a0,a0,-1284 # 61d0 <malloc+0x4dc>
    ...
    16f4:	fb050513          	add	a0,a0,-80 # 66a0 <malloc+0x9ac>
  ...
  unlink("echo-ok");
    ...
    170e:	00e50513          	add	a0,a0,14 # 6718 <malloc+0xa24>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1738:	04450513          	add	a0,a0,68 # 6778 <malloc+0xa84>
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	6cca8a93          	add	s5,s5,1740 # be68 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	6b070713          	add	a4,a4,1712 # be68 <buf>
    ...
    1800:	f9450513          	add	a0,a0,-108 # 6790 <malloc+0xa9c>
    ...
    182e:	63eb0b13          	add	s6,s6,1598 # be68 <buf>
    ...
    1842:	42da8a93          	add	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    188e:	f1e50513          	add	a0,a0,-226 # 67a8 <malloc+0xab4>
    ...
    18aa:	f1a50513          	add	a0,a0,-230 # 67c0 <malloc+0xacc>
    ...
    18dc:	f0050513          	add	a0,a0,-256 # 67d8 <malloc+0xae4>
    ...
    1928:	ed450513          	add	a0,a0,-300 # 67f8 <malloc+0xb04>
...
000000000000193e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    199a:	cf250513          	add	a0,a0,-782 # 6688 <malloc+0x994>
    ...
    19b6:	e5e50513          	add	a0,a0,-418 # 6810 <malloc+0xb1c>
    ...
    19d2:	e5a50513          	add	a0,a0,-422 # 6828 <malloc+0xb34>
...
00000000000019f2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a4a:	c4250513          	add	a0,a0,-958 # 6688 <malloc+0x994>
    ...
    1a6e:	c1e50513          	add	a0,a0,-994 # 6688 <malloc+0x994>
...
0000000000001a8c <forkfork>:
{
    ...
    1ae8:	d6450513          	add	a0,a0,-668 # 6848 <malloc+0xb54>
    ...
    1afa:	dde080e7          	jalr	-546(ra) # 58d4 <exit>
{
    ...
    1b40:	d1c50513          	add	a0,a0,-740 # 6858 <malloc+0xb64>
...
0000000000001b56 <reparent2>:
{
  ...
  exit(0);
    ...
    1b8e:	f1e50513          	add	a0,a0,-226 # 6aa8 <malloc+0xdb4>
...
0000000000001bbe <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c2c:	e8050513          	add	a0,a0,-384 # 6aa8 <malloc+0xdb4>
    ...
    1c58:	acc50513          	add	a0,a0,-1332 # 6720 <malloc+0xa2c>
    ...
    1cca:	bb250513          	add	a0,a0,-1102 # 6878 <malloc+0xb84>
    ...
    1cfe:	b9650513          	add	a0,a0,-1130 # 6890 <malloc+0xb9c>
    ...
    1d60:	b5c50513          	add	a0,a0,-1188 # 68b8 <malloc+0xbc4>
...
0000000000001de4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e04:	0a050513          	add	a0,a0,160 # 5ea0 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c55ff5>
    ...
    1e40:	064b0b13          	add	s6,s6,100 # 5ea0 <malloc+0x1ac>
      link("cat", "x");
    1e44:	00005c17          	auipc	s8,0x5
    1e48:	a9cc0c13          	add	s8,s8,-1380 # 68e0 <malloc+0xbec>
    1e4c:	a825                	j	1e84 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e4e:	85a6                	mv	a1,s1
    1e50:	00005517          	auipc	a0,0x5
    1e54:	83850513          	add	a0,a0,-1992 # 6688 <malloc+0x994>
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4c:	b6050513          	add	a0,a0,-1184 # 6aa8 <malloc+0xdb4>
    ...
    1f8e:	edeb0b13          	add	s6,s6,-290 # be68 <buf>
    ...
    2002:	8ea50513          	add	a0,a0,-1814 # 68e8 <malloc+0xbf4>
    ...
    2022:	ee250513          	add	a0,a0,-286 # 5f00 <malloc+0x20c>
...
0000000000002040 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2070:	8dc50513          	add	a0,a0,-1828 # 6948 <malloc+0xc54>
    ...
    2094:	87050513          	add	a0,a0,-1936 # 6900 <malloc+0xc0c>
    ...
    20b0:	86c50513          	add	a0,a0,-1940 # 6918 <malloc+0xc24>
    ...
    20cc:	86850513          	add	a0,a0,-1944 # 6930 <malloc+0xc3c>
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	add	s3,s3,848 # c350 <buf+0x4e8>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	sll	s2,s2,0x3
    213e:	48090913          	add	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e608>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2182:	50a50513          	add	a0,a0,1290 # 6688 <malloc+0x994>
    ...
    21a4:	7d050513          	add	a0,a0,2000 # 6970 <malloc+0xc7c>
...
00000000000021c4 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2226:	46650513          	add	a0,a0,1126 # 6688 <malloc+0x994>
    ...
    2252:	74250513          	add	a0,a0,1858 # 6990 <malloc+0xc9c>
...
0000000000002272 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2282:	72a50513          	add	a0,a0,1834 # 69a8 <malloc+0xcb4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    22b4:	6f850513          	add	a0,a0,1784 # 69a8 <malloc+0xcb4>
  ...
  close(fd);
    ...
    22da:	37a78793          	add	a5,a5,890 # 8650 <args.1>
    22de:	00006697          	auipc	a3,0x6
    22e2:	46a68693          	add	a3,a3,1130 # 8748 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22e6:	00004717          	auipc	a4,0x4
    22ea:	6d270713          	add	a4,a4,1746 # 69b8 <malloc+0xcc4>
    ...
    233e:	75e50513          	add	a0,a0,1886 # 6a98 <malloc+0xda4>
    ...
    2362:	75a50513          	add	a0,a0,1882 # 6ab8 <malloc+0xdc4>
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    23c0:	71c50513          	add	a0,a0,1820 # 6ad8 <malloc+0xde4>
    ...
    23dc:	2b050513          	add	a0,a0,688 # 6688 <malloc+0x994>
...
00000000000023fc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2476:	30e78793          	add	a5,a5,782 # 7780 <malloc+0x1a8c>
  ...
  if(ret != -1){
    ...
    24b8:	64c50513          	add	a0,a0,1612 # 6b00 <malloc+0xe0c>
    ...
    24d6:	0d650513          	add	a0,a0,214 # 65a8 <malloc+0x8b4>
    ...
    24f4:	0d850513          	add	a0,a0,216 # 65c8 <malloc+0x8d4>
    ...
    2514:	0d850513          	add	a0,a0,216 # 65e8 <malloc+0x8f4>
    ...
    2532:	0e250513          	add	a0,a0,226 # 6610 <malloc+0x91c>
...
0000000000002548 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    257e:	5c650513          	add	a0,a0,1478 # 6b40 <malloc+0xe4c>
  ...
  if(n >= 0){
    ...
    25ae:	5b650513          	add	a0,a0,1462 # 6b60 <malloc+0xe6c>
    ...
    25cc:	54050513          	add	a0,a0,1344 # 6b08 <malloc+0xe14>
    ...
    25e8:	53c50513          	add	a0,a0,1340 # 6b20 <malloc+0xe2c>
    ...
    2602:	54a50513          	add	a0,a0,1354 # 6b48 <malloc+0xe54>
  ...
  if(n >= 0){
    ...
    2662:	53250513          	add	a0,a0,1330 # 6b90 <malloc+0xe9c>
    ...
    267c:	4d050513          	add	a0,a0,1232 # 6b48 <malloc+0xe54>
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    2702:	4ba50513          	add	a0,a0,1210 # 6bb8 <malloc+0xec4>
  ...
  for(i = 0; i < 5000; i++){
    ...
    2766:	47650513          	add	a0,a0,1142 # 6bd8 <malloc+0xee4>
  ...
  if(c != a + 1){
    ...
    27ca:	47250513          	add	a0,a0,1138 # 6c38 <malloc+0xf44>
    ...
    27ec:	41050513          	add	a0,a0,1040 # 6bf8 <malloc+0xf04>
    ...
    2808:	41450513          	add	a0,a0,1044 # 6c18 <malloc+0xf24>
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
  ...
  if(c != a){
    ...
    2952:	30a50513          	add	a0,a0,778 # 6c58 <malloc+0xf64>
    ...
    296e:	33650513          	add	a0,a0,822 # 6ca0 <malloc+0xfac>
    ...
    298e:	33650513          	add	a0,a0,822 # 6cc0 <malloc+0xfcc>
    ...
    29ae:	35650513          	add	a0,a0,854 # 6d00 <malloc+0x100c>
    ...
    29ca:	36a50513          	add	a0,a0,874 # 6d30 <malloc+0x103c>
    ...
    29ea:	38250513          	add	a0,a0,898 # 6d68 <malloc+0x1074>
...
0000000000002a00 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2a24:	37050513          	add	a0,a0,880 # 6d90 <malloc+0x109c>
    2a28:	00003097          	auipc	ra,0x3
    2a2c:	eec080e7          	jalr	-276(ra) # 5914 <open>
    2a30:	84aa                	mv	s1,a0
  unlink("sbrk");
    2a32:	00004517          	auipc	a0,0x4
    2a36:	35e50513          	add	a0,a0,862 # 6d90 <malloc+0x109c>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a8a:	31250513          	add	a0,a0,786 # 6d98 <malloc+0x10a4>
    ...
    2aa6:	30e50513          	add	a0,a0,782 # 6db0 <malloc+0x10bc>
    ...
    2ac2:	cd250513          	add	a0,a0,-814 # 6790 <malloc+0xa9c>
...
0000000000002ad8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2aec:	2e050513          	add	a0,a0,736 # 6dc8 <malloc+0x10d4>
  ...
  close(fd);
    ...
    2b34:	b7050513          	add	a0,a0,-1168 # 66a0 <malloc+0x9ac>
...
0000000000002b4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b82:	f2a50513          	add	a0,a0,-214 # 6aa8 <malloc+0xdb4>
  ...
  if(pid == 0){
    ...
    2bd8:	ed450513          	add	a0,a0,-300 # 6aa8 <malloc+0xdb4>
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addw	a5,a5,-2048 # a800 <uninit+0x10a8>
    ...
    2c38:	e7450513          	add	a0,a0,-396 # 6aa8 <malloc+0xdb4>
...
0000000000002d34 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2d40:	0511                	add	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff118c>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2dac:	d0050513          	add	a0,a0,-768 # 6aa8 <malloc+0xdb4>
    ...
    2e00:	03450513          	add	a0,a0,52 # 5e30 <malloc+0x13c>
    2e04:	faa43c23          	sd	a0,-72(s0)
    2e08:	00003797          	auipc	a5,0x3
    2e0c:	09878793          	add	a5,a5,152 # 5ea0 <malloc+0x1ac>
...
0000000000002e2e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2e3e:	16650513          	add	a0,a0,358 # 6fa0 <malloc+0x12ac>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e50:	fac50513          	add	a0,a0,-84 # 6df8 <malloc+0x1104>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e66:	fee50513          	add	a0,a0,-18 # 6e50 <malloc+0x115c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e84:	04850513          	add	a0,a0,72 # 6ec8 <malloc+0x11d4>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2ea0:	09c50513          	add	a0,a0,156 # 6f38 <malloc+0x1244>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2eb2:	0e250513          	add	a0,a0,226 # 6f90 <malloc+0x129c>
  ...
  unlink("12345678901234");
    ...
    2f30:	ea450513          	add	a0,a0,-348 # 6dd0 <malloc+0x10dc>
    ...
    2f4c:	ed050513          	add	a0,a0,-304 # 6e18 <malloc+0x1124>
    ...
    2f68:	f1c50513          	add	a0,a0,-228 # 6e80 <malloc+0x118c>
    ...
    2f84:	f7850513          	add	a0,a0,-136 # 6ef8 <malloc+0x1204>
    ...
    2fa0:	fbc50513          	add	a0,a0,-68 # 6f58 <malloc+0x1264>
    ...
    2fbc:	ff850513          	add	a0,a0,-8 # 6fb0 <malloc+0x12bc>
...
0000000000002fd2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2fe2:	00a50513          	add	a0,a0,10 # 6fe8 <malloc+0x12f4>
  ...
  if(chdir("iputdir") < 0){
    ...
    2ff6:	ff650513          	add	a0,a0,-10 # 6fe8 <malloc+0x12f4>
  ...
  if(unlink("../iputdir") < 0){
    ...
    300a:	02250513          	add	a0,a0,34 # 7028 <malloc+0x1334>
  ...
  if(chdir("/") < 0){
    ...
    301e:	03e50513          	add	a0,a0,62 # 7058 <malloc+0x1364>
    ...
    303e:	fb650513          	add	a0,a0,-74 # 6ff0 <malloc+0x12fc>
    ...
    305a:	fb250513          	add	a0,a0,-78 # 7008 <malloc+0x1314>
    ...
    3076:	fc650513          	add	a0,a0,-58 # 7038 <malloc+0x1344>
    ...
    3092:	fd250513          	add	a0,a0,-46 # 7060 <malloc+0x136c>
...
00000000000030a8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    30c6:	f2650513          	add	a0,a0,-218 # 6fe8 <malloc+0x12f4>
    ...
    30da:	f1250513          	add	a0,a0,-238 # 6fe8 <malloc+0x12f4>
    ...
    30ee:	f3e50513          	add	a0,a0,-194 # 7028 <malloc+0x1334>
    ...
    310e:	57e50513          	add	a0,a0,1406 # 6688 <malloc+0x994>
    ...
    312a:	eca50513          	add	a0,a0,-310 # 6ff0 <malloc+0x12fc>
    ...
    3146:	f3650513          	add	a0,a0,-202 # 7078 <malloc+0x1384>
    ...
    3162:	eda50513          	add	a0,a0,-294 # 7038 <malloc+0x1344>
...
0000000000003190 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    31a0:	ef450513          	add	a0,a0,-268 # 7090 <malloc+0x139c>
  ...
  if(chdir("dir0") < 0){
    ...
    31b4:	ee050513          	add	a0,a0,-288 # 7090 <malloc+0x139c>
  ...
  if(chdir("..") < 0){
    ...
    31c8:	eec50513          	add	a0,a0,-276 # 70b0 <malloc+0x13bc>
  ...
  if(unlink("dir0") < 0){
    ...
    31dc:	eb850513          	add	a0,a0,-328 # 7090 <malloc+0x139c>
    ...
    31fc:	df850513          	add	a0,a0,-520 # 6ff0 <malloc+0x12fc>
    ...
    3218:	e8450513          	add	a0,a0,-380 # 7098 <malloc+0x13a4>
    ...
    3234:	e8850513          	add	a0,a0,-376 # 70b8 <malloc+0x13c4>
    ...
    3250:	e8450513          	add	a0,a0,-380 # 70d0 <malloc+0x13dc>
...
0000000000003266 <subdir>:
{
  ...
  unlink("ff");
    ...
    3278:	fa450513          	add	a0,a0,-92 # 7218 <malloc+0x1524>
    327c:	00002097          	auipc	ra,0x2
    3280:	6a8080e7          	jalr	1704(ra) # 5924 <unlink>
  if(mkdir("dd") != 0){
    3284:	00004517          	auipc	a0,0x4
    3288:	e6450513          	add	a0,a0,-412 # 70e8 <malloc+0x13f4>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e6c50513          	add	a0,a0,-404 # 7108 <malloc+0x1414>
  ...
  write(fd, "ff", 2);
    ...
    32b8:	f6458593          	add	a1,a1,-156 # 7218 <malloc+0x1524>
  ...
  if(unlink("dd") >= 0){
    ...
    32d2:	e1a50513          	add	a0,a0,-486 # 70e8 <malloc+0x13f4>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    32e6:	e7e50513          	add	a0,a0,-386 # 7160 <malloc+0x146c>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32fe:	e8e50513          	add	a0,a0,-370 # 7188 <malloc+0x1494>
  ...
  write(fd, "FF", 2);
    ...
    3316:	ea658593          	add	a1,a1,-346 # 71b8 <malloc+0x14c4>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3332:	e9250513          	add	a0,a0,-366 # 71c0 <malloc+0x14cc>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	b2258593          	add	a1,a1,-1246 # be68 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    337a:	e9a58593          	add	a1,a1,-358 # 7210 <malloc+0x151c>
    337e:	00004517          	auipc	a0,0x4
    3382:	e0a50513          	add	a0,a0,-502 # 7188 <malloc+0x1494>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3396:	df650513          	add	a0,a0,-522 # 7188 <malloc+0x1494>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ac:	de050513          	add	a0,a0,-544 # 7188 <malloc+0x1494>
  ...
  if(chdir("dd") != 0){
    ...
    33c0:	d2c50513          	add	a0,a0,-724 # 70e8 <malloc+0x13f4>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    33d4:	ed850513          	add	a0,a0,-296 # 72a8 <malloc+0x15b4>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    33e8:	ef450513          	add	a0,a0,-268 # 72d8 <malloc+0x15e4>
  ...
  if(chdir("./..") != 0){
    ...
    33fc:	f1050513          	add	a0,a0,-240 # 7308 <malloc+0x1614>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3412:	e0250513          	add	a0,a0,-510 # 7210 <malloc+0x151c>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	a4258593          	add	a1,a1,-1470 # be68 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    344c:	d4050513          	add	a0,a0,-704 # 7188 <malloc+0x1494>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3464:	f3850513          	add	a0,a0,-200 # 7398 <malloc+0x16a4>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    347c:	f5050513          	add	a0,a0,-176 # 73c8 <malloc+0x16d4>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3494:	c5850513          	add	a0,a0,-936 # 70e8 <malloc+0x13f4>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    34aa:	c4250513          	add	a0,a0,-958 # 70e8 <malloc+0x13f4>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    34c0:	c2c50513          	add	a0,a0,-980 # 70e8 <malloc+0x13f4>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    34d4:	f8858593          	add	a1,a1,-120 # 7458 <malloc+0x1764>
    34d8:	00004517          	auipc	a0,0x4
    34dc:	ec050513          	add	a0,a0,-320 # 7398 <malloc+0x16a4>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34f0:	f6c58593          	add	a1,a1,-148 # 7458 <malloc+0x1764>
    34f4:	00004517          	auipc	a0,0x4
    34f8:	ed450513          	add	a0,a0,-300 # 73c8 <malloc+0x16d4>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    350c:	d0858593          	add	a1,a1,-760 # 7210 <malloc+0x151c>
    3510:	00004517          	auipc	a0,0x4
    3514:	bf850513          	add	a0,a0,-1032 # 7108 <malloc+0x1414>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3528:	e7450513          	add	a0,a0,-396 # 7398 <malloc+0x16a4>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    353c:	e9050513          	add	a0,a0,-368 # 73c8 <malloc+0x16d4>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3550:	cc450513          	add	a0,a0,-828 # 7210 <malloc+0x151c>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3564:	e6850513          	add	a0,a0,-408 # 73c8 <malloc+0x16d4>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3578:	e2450513          	add	a0,a0,-476 # 7398 <malloc+0x16a4>
  ...
  if(chdir("dd/ff") == 0){
    ...
    358c:	b8050513          	add	a0,a0,-1152 # 7108 <malloc+0x1414>
  ...
  if(chdir("dd/xx") == 0){
    ...
    35a0:	00c50513          	add	a0,a0,12 # 75a8 <malloc+0x18b4>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    35b4:	c6050513          	add	a0,a0,-928 # 7210 <malloc+0x151c>
  ...
  if(unlink("dd/ff") != 0){
    ...
    35c8:	b4450513          	add	a0,a0,-1212 # 7108 <malloc+0x1414>
  ...
  if(unlink("dd") == 0){
    ...
    35dc:	b1050513          	add	a0,a0,-1264 # 70e8 <malloc+0x13f4>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35f0:	02c50513          	add	a0,a0,44 # 7618 <malloc+0x1924>
  ...
  if(unlink("dd") < 0){
    ...
    3604:	ae850513          	add	a0,a0,-1304 # 70e8 <malloc+0x13f4>
    ...
    3626:	ace50513          	add	a0,a0,-1330 # 70f0 <malloc+0x13fc>
    ...
    3642:	ad250513          	add	a0,a0,-1326 # 7110 <malloc+0x141c>
    ...
    365e:	ad650513          	add	a0,a0,-1322 # 7130 <malloc+0x143c>
    ...
    367a:	af250513          	add	a0,a0,-1294 # 7168 <malloc+0x1474>
    ...
    3696:	b0650513          	add	a0,a0,-1274 # 7198 <malloc+0x14a4>
    ...
    36b2:	b2250513          	add	a0,a0,-1246 # 71d0 <malloc+0x14dc>
    ...
    36ce:	b2650513          	add	a0,a0,-1242 # 71f0 <malloc+0x14fc>
    ...
    36ea:	b3a50513          	add	a0,a0,-1222 # 7220 <malloc+0x152c>
    ...
    3706:	b4650513          	add	a0,a0,-1210 # 7248 <malloc+0x1554>
    ...
    3722:	b4a50513          	add	a0,a0,-1206 # 7268 <malloc+0x1574>
    ...
    373e:	b5650513          	add	a0,a0,-1194 # 7290 <malloc+0x159c>
    ...
    375a:	b6250513          	add	a0,a0,-1182 # 72b8 <malloc+0x15c4>
    ...
    3776:	b7650513          	add	a0,a0,-1162 # 72e8 <malloc+0x15f4>
    ...
    3792:	b8250513          	add	a0,a0,-1150 # 7310 <malloc+0x161c>
    ...
    37ae:	b7e50513          	add	a0,a0,-1154 # 7328 <malloc+0x1634>
    ...
    37ca:	b8250513          	add	a0,a0,-1150 # 7348 <malloc+0x1654>
    ...
    37e6:	b8650513          	add	a0,a0,-1146 # 7368 <malloc+0x1674>
    ...
    3802:	baa50513          	add	a0,a0,-1110 # 73a8 <malloc+0x16b4>
    ...
    381e:	bbe50513          	add	a0,a0,-1090 # 73d8 <malloc+0x16e4>
    ...
    383a:	bc250513          	add	a0,a0,-1086 # 73f8 <malloc+0x1704>
    ...
    3856:	bc650513          	add	a0,a0,-1082 # 7418 <malloc+0x1724>
    ...
    3872:	bca50513          	add	a0,a0,-1078 # 7438 <malloc+0x1744>
    ...
    388e:	bde50513          	add	a0,a0,-1058 # 7468 <malloc+0x1774>
    ...
    38aa:	bea50513          	add	a0,a0,-1046 # 7490 <malloc+0x179c>
    ...
    38c6:	bf650513          	add	a0,a0,-1034 # 74b8 <malloc+0x17c4>
    ...
    38e2:	c0250513          	add	a0,a0,-1022 # 74e0 <malloc+0x17ec>
    ...
    38fe:	c0650513          	add	a0,a0,-1018 # 7500 <malloc+0x180c>
    ...
    391a:	c0a50513          	add	a0,a0,-1014 # 7520 <malloc+0x182c>
    ...
    3936:	c1650513          	add	a0,a0,-1002 # 7548 <malloc+0x1854>
    ...
    3952:	c1a50513          	add	a0,a0,-998 # 7568 <malloc+0x1874>
    ...
    396e:	c1e50513          	add	a0,a0,-994 # 7588 <malloc+0x1894>
    ...
    398a:	c2a50513          	add	a0,a0,-982 # 75b0 <malloc+0x18bc>
    ...
    39a6:	8a650513          	add	a0,a0,-1882 # 7248 <malloc+0x1554>
    ...
    39c2:	c1250513          	add	a0,a0,-1006 # 75d0 <malloc+0x18dc>
    ...
    39de:	c1650513          	add	a0,a0,-1002 # 75f0 <malloc+0x18fc>
    ...
    39fa:	c2a50513          	add	a0,a0,-982 # 7620 <malloc+0x192c>
    ...
    3a16:	c2e50513          	add	a0,a0,-978 # 7640 <malloc+0x194c>
...
0000000000003a2c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3a3c:	c2050513          	add	a0,a0,-992 # 7658 <malloc+0x1964>
  ...
  if(chdir("dots") != 0){
    ...
    3a4e:	c0e50513          	add	a0,a0,-1010 # 7658 <malloc+0x1964>
  ...
  if(unlink(".") == 0){
    ...
    3a60:	a8c50513          	add	a0,a0,-1396 # 64e8 <malloc+0x7f4>
  ...
  if(unlink("..") == 0){
    ...
    3a72:	64250513          	add	a0,a0,1602 # 70b0 <malloc+0x13bc>
  ...
  if(chdir("/") != 0){
    ...
    3a84:	5d850513          	add	a0,a0,1496 # 7058 <malloc+0x1364>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a96:	c2e50513          	add	a0,a0,-978 # 76c0 <malloc+0x19cc>
  ...
  if(unlink("dots/..") == 0){
    ...
    3aa8:	c4450513          	add	a0,a0,-956 # 76e8 <malloc+0x19f4>
  ...
  if(unlink("dots") != 0){
    ...
    3aba:	ba250513          	add	a0,a0,-1118 # 7658 <malloc+0x1964>
    ...
    3ad8:	b8c50513          	add	a0,a0,-1140 # 7660 <malloc+0x196c>
    ...
    3af4:	b8850513          	add	a0,a0,-1144 # 7678 <malloc+0x1984>
    ...
    3b10:	b8450513          	add	a0,a0,-1148 # 7690 <malloc+0x199c>
    ...
    3b2c:	b8050513          	add	a0,a0,-1152 # 76a8 <malloc+0x19b4>
    ...
    3b48:	51c50513          	add	a0,a0,1308 # 7060 <malloc+0x136c>
    ...
    3b64:	b6850513          	add	a0,a0,-1176 # 76c8 <malloc+0x19d4>
    ...
    3b80:	b7450513          	add	a0,a0,-1164 # 76f0 <malloc+0x19fc>
    ...
    3b9c:	b7850513          	add	a0,a0,-1160 # 7710 <malloc+0x1a1c>
...
0000000000003bb2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3bc8:	b6c50513          	add	a0,a0,-1172 # 7730 <malloc+0x1a3c>
  ...
  if(chdir("dirfile") == 0){
    ...
    3be4:	b5050513          	add	a0,a0,-1200 # 7730 <malloc+0x1a3c>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3bf8:	b8450513          	add	a0,a0,-1148 # 7778 <malloc+0x1a84>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3c10:	b6c50513          	add	a0,a0,-1172 # 7778 <malloc+0x1a84>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3c24:	b5850513          	add	a0,a0,-1192 # 7778 <malloc+0x1a84>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3c38:	b4450513          	add	a0,a0,-1212 # 7778 <malloc+0x1a84>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c4c:	b3058593          	add	a1,a1,-1232 # 7778 <malloc+0x1a84>
    3c50:	00002517          	auipc	a0,0x2
    3c54:	38850513          	add	a0,a0,904 # 5fd8 <malloc+0x2e4>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c68:	acc50513          	add	a0,a0,-1332 # 7730 <malloc+0x1a3c>
  ...
  fd = open(".", O_RDWR);
    ...
    3c7e:	86e50513          	add	a0,a0,-1938 # 64e8 <malloc+0x7f4>
  ...
  fd = open(".", 0);
    ...
    3c94:	85850513          	add	a0,a0,-1960 # 64e8 <malloc+0x7f4>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ca8:	1fc58593          	add	a1,a1,508 # 5ea0 <malloc+0x1ac>
  ...
  close(fd);
    ...
    3cd4:	a6850513          	add	a0,a0,-1432 # 7738 <malloc+0x1a44>
    ...
    3cf0:	a6c50513          	add	a0,a0,-1428 # 7758 <malloc+0x1a64>
    ...
    3d0c:	a8050513          	add	a0,a0,-1408 # 7788 <malloc+0x1a94>
    ...
    3d28:	a6450513          	add	a0,a0,-1436 # 7788 <malloc+0x1a94>
    ...
    3d44:	a7050513          	add	a0,a0,-1424 # 77b0 <malloc+0x1abc>
    ...
    3d60:	a7c50513          	add	a0,a0,-1412 # 77d8 <malloc+0x1ae4>
    ...
    3d7c:	a8850513          	add	a0,a0,-1400 # 7800 <malloc+0x1b0c>
    ...
    3d98:	a9450513          	add	a0,a0,-1388 # 7828 <malloc+0x1b34>
    ...
    3db4:	a9850513          	add	a0,a0,-1384 # 7848 <malloc+0x1b54>
    ...
    3dd0:	aa450513          	add	a0,a0,-1372 # 7870 <malloc+0x1b7c>
...
0000000000003de6 <iref>:
{
    ...
    3e04:	a88a0a13          	add	s4,s4,-1400 # 7888 <malloc+0x1b94>
    mkdir("");
    3e08:	00003497          	auipc	s1,0x3
    3e0c:	58848493          	add	s1,s1,1416 # 7390 <malloc+0x169c>
    link("README", "");
    3e10:	00002a97          	auipc	s5,0x2
    3e14:	1c8a8a93          	add	s5,s5,456 # 5fd8 <malloc+0x2e4>
    fd = open("xx", O_CREATE);
    3e18:	00004997          	auipc	s3,0x4
    3e1c:	96898993          	add	s3,s3,-1688 # 7780 <malloc+0x1a8c>
    3e20:	a891                	j	3e74 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3e22:	85da                	mv	a1,s6
    3e24:	00004517          	auipc	a0,0x4
    3e28:	a6c50513          	add	a0,a0,-1428 # 7890 <malloc+0x1b9c>
    ...
    3e44:	a6850513          	add	a0,a0,-1432 # 78a8 <malloc+0x1bb4>
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3ed8:	1dc98993          	add	s3,s3,476 # 70b0 <malloc+0x13bc>
    unlink("irefd");
    3edc:	00004917          	auipc	s2,0x4
    3ee0:	9ac90913          	add	s2,s2,-1620 # 7888 <malloc+0x1b94>
    chdir("..");
    3ee4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3f00:	15c50513          	add	a0,a0,348 # 7058 <malloc+0x1364>
...
0000000000003f20 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3f30:	99450513          	add	a0,a0,-1644 # 78c0 <malloc+0x1bcc>
  ...
  if(pid == 0){
    ...
    3f54:	97050513          	add	a0,a0,-1680 # 78c0 <malloc+0x1bcc>
    ...
    3f6a:	97a50513          	add	a0,a0,-1670 # 78e0 <malloc+0x1bec>
    ...
    3f86:	94650513          	add	a0,a0,-1722 # 78c8 <malloc+0x1bd4>
    ...
    3fa2:	6ea50513          	add	a0,a0,1770 # 6688 <malloc+0x994>
  ...
  if(unlink("oidir") != 0){
    ...
    3fd0:	8f450513          	add	a0,a0,-1804 # 78c0 <malloc+0x1bcc>
    ...
    3fe4:	89850513          	add	a0,a0,-1896 # 6878 <malloc+0xb84>
...
0000000000004012 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4022:	8ea50513          	add	a0,a0,-1814 # 7908 <malloc+0x1c14>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    404e:	8be50513          	add	a0,a0,-1858 # 7908 <malloc+0x1c14>
  ...
  sleep(10); // one second
    ...
    4086:	7c650513          	add	a0,a0,1990 # 6848 <malloc+0xb54>
    ...
    40a0:	86c48493          	add	s1,s1,-1940 # 7908 <malloc+0x1c14>
    40a4:	4581                	li	a1,0
    40a6:	8526                	mv	a0,s1
    ...
    40c8:	84450513          	add	a0,a0,-1980 # 7908 <malloc+0x1c14>
...
00000000000040e8 <killstatus>:
{
  ...
  exit(0);
    ...
    414e:	53e50513          	add	a0,a0,1342 # 6688 <malloc+0x994>
    ...
    4174:	7a850513          	add	a0,a0,1960 # 7918 <malloc+0x1c24>
...
000000000000418a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    41b4:	69850513          	add	a0,a0,1688 # 6848 <malloc+0xb54>
  ...
  if(pid2 == 0)
    ...
    41e2:	4aa50513          	add	a0,a0,1194 # 6688 <malloc+0x994>
  ...
  if(pid3 == 0){
    ...
    4226:	c7e58593          	add	a1,a1,-898 # 5ea0 <malloc+0x1ac>
    ...
    4250:	43c50513          	add	a0,a0,1084 # 6688 <malloc+0x994>
    ...
    426c:	6d050513          	add	a0,a0,1744 # 7938 <malloc+0x1c44>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	be058593          	add	a1,a1,-1056 # be68 <buf>
    ...
    42a8:	6ac50513          	add	a0,a0,1708 # 7950 <malloc+0x1c5c>
  ...
  printf("kill... ");
    ...
    42d4:	69850513          	add	a0,a0,1688 # 7968 <malloc+0x1c74>
  ...
  printf("wait... ");
    ...
    4302:	67a50513          	add	a0,a0,1658 # 7978 <malloc+0x1c84>
...
000000000000432e <reparent>:
{
  ...
  exit(0);
    ...
    4382:	30a50513          	add	a0,a0,778 # 6688 <malloc+0x994>
    ...
    439e:	47650513          	add	a0,a0,1142 # 6810 <malloc+0xb1c>
...
00000000000043de <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4414:	38050513          	add	a0,a0,896 # 6790 <malloc+0xa9c>
    ...
    4448:	a5c58593          	add	a1,a1,-1444 # 5ea0 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    450c:	48050513          	add	a0,a0,1152 # 7988 <malloc+0x1c94>
    ...
    4528:	16450513          	add	a0,a0,356 # 6688 <malloc+0x994>
    ...
    4574:	43850513          	add	a0,a0,1080 # 79a8 <malloc+0x1cb4>
...
0000000000004594 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    4618:	3c450513          	add	a0,a0,964 # 79d8 <malloc+0x1ce4>
...
0000000000004638 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    46da:	33250513          	add	a0,a0,818 # 7a08 <malloc+0x1d14>
    ...
    46f6:	33e50513          	add	a0,a0,830 # 7a30 <malloc+0x1d3c>
  ...
  fd = open("sharedfd", 0);
    ...
    473a:	2c250513          	add	a0,a0,706 # 79f8 <malloc+0x1d04>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    477a:	2da50513          	add	a0,a0,730 # 7a50 <malloc+0x1d5c>
  ...
  unlink("sharedfd");
    ...
    47b6:	24650513          	add	a0,a0,582 # 79f8 <malloc+0x1d04>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    47dc:	2a050513          	add	a0,a0,672 # 7a78 <malloc+0x1d84>
...
00000000000047fc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4820:	27478793          	add	a5,a5,628 # 7a90 <malloc+0x1d9c>
    4824:	f6f43823          	sd	a5,-144(s0)
    4828:	00003797          	auipc	a5,0x3
    482c:	27078793          	add	a5,a5,624 # 7a98 <malloc+0x1da4>
    4830:	f6f43c23          	sd	a5,-136(s0)
    4834:	00003797          	auipc	a5,0x3
    4838:	26c78793          	add	a5,a5,620 # 7aa0 <malloc+0x1dac>
    483c:	f8f43023          	sd	a5,-128(s0)
    4840:	00003797          	auipc	a5,0x3
    4844:	26878793          	add	a5,a5,616 # 7aa8 <malloc+0x1db4>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    489c:	5d0a0a13          	add	s4,s4,1488 # be68 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    48b2:	1fa50513          	add	a0,a0,506 # 6aa8 <malloc+0xdb4>
    ...
    492c:	18850513          	add	a0,a0,392 # 7ab0 <malloc+0x1dbc>
    ...
    4946:	17e50513          	add	a0,a0,382 # 7ac0 <malloc+0x1dcc>
    ...
    496c:	17050513          	add	a0,a0,368 # 7ad8 <malloc+0x1de4>
    ...
    499c:	4d078793          	add	a5,a5,1232 # be68 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49f4:	0f850513          	add	a0,a0,248 # 7ae8 <malloc+0x1df4>
...
0000000000004a28 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a56:	0aeb8b93          	add	s7,s7,174 # 7b00 <malloc+0x1e0c>
  for(i = 0; i < N; i++){
    ...
    4a98:	07450513          	add	a0,a0,116 # 7b08 <malloc+0x1e14>
    ...
    4ab6:	04e50513          	add	a0,a0,78 # 7b00 <malloc+0x1e0c>
  ...
  fd = open(".", 0);
    ...
    4aee:	9fe50513          	add	a0,a0,-1538 # 64e8 <malloc+0x7f4>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b66:	fc650513          	add	a0,a0,-58 # 7b28 <malloc+0x1e34>
    ...
    4b86:	fc650513          	add	a0,a0,-58 # 7b48 <malloc+0x1e54>
  ...
  for(i = 0; i < N; i++){
    ...
    4bbe:	fb650513          	add	a0,a0,-74 # 7b70 <malloc+0x1e7c>
    ...
    4bda:	ab250513          	add	a0,a0,-1358 # 6688 <malloc+0x994>
...
0000000000004d84 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	0a890913          	add	s2,s2,168 # be68 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4e0c:	da050513          	add	a0,a0,-608 # 7ba8 <malloc+0x1eb4>
  ...
  for(i = 0; ; i++){
    ...
    4e22:	04a90913          	add	s2,s2,74 # be68 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e70:	d4c50513          	add	a0,a0,-692 # 7bb8 <malloc+0x1ec4>
    ...
    4e8c:	d5050513          	add	a0,a0,-688 # 7bd8 <malloc+0x1ee4>
    ...
    4ea8:	d5450513          	add	a0,a0,-684 # 7bf8 <malloc+0x1f04>
    ...
    4ec4:	d5850513          	add	a0,a0,-680 # 7c18 <malloc+0x1f24>
    ...
    4ee0:	d5c50513          	add	a0,a0,-676 # 7c38 <malloc+0x1f44>
    ...
    4efc:	d5850513          	add	a0,a0,-680 # 7c50 <malloc+0x1f5c>
  ...
  unlink("bigfile.dat");
    ...
    4f2a:	c8250513          	add	a0,a0,-894 # 7ba8 <malloc+0x1eb4>
    ...
    4f4e:	d2650513          	add	a0,a0,-730 # 7c70 <malloc+0x1f7c>
...
0000000000004f64 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f84:	d1050513          	add	a0,a0,-752 # 7c90 <malloc+0x1f9c>
  ...
  for(nfiles = 0; ; nfiles++){
    ...
    4fa4:	d00c8c93          	add	s9,s9,-768 # 7ca0 <malloc+0x1fac>
    name[0] = 'f';
    ...
    5014:	ca050513          	add	a0,a0,-864 # 7cb0 <malloc+0x1fbc>
  ...
  printf("fsfull test finished\n");
    ...
    508a:	c4a50513          	add	a0,a0,-950 # 7cd0 <malloc+0x1fdc>
    ...
    50b8:	db4a8a93          	add	s5,s5,-588 # be68 <buf>
      if(cc < BSIZE)
    ...
    50e0:	be450513          	add	a0,a0,-1052 # 7cc0 <malloc+0x1fcc>
...
00000000000050fe <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5172:	b7a50513          	add	a0,a0,-1158 # 7ce8 <malloc+0x1ff4>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    518a:	d1a58593          	add	a1,a1,-742 # 5ea0 <malloc+0x1ac>
    ...
    51a0:	b6c50513          	add	a0,a0,-1172 # 7d08 <malloc+0x2014>
    ...
    51ba:	b3a50513          	add	a0,a0,-1222 # 7cf0 <malloc+0x1ffc>
    ...
    51d4:	b2050513          	add	a0,a0,-1248 # 7cf0 <malloc+0x1ffc>
  ...
  unlink("junk");
    ...
    51f8:	af450513          	add	a0,a0,-1292 # 7ce8 <malloc+0x1ff4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    524e:	c5698993          	add	s3,s3,-938 # 5ea0 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    5280:	adc50513          	add	a0,a0,-1316 # 7d58 <malloc+0x2064>
    ...
    52a0:	a7c50513          	add	a0,a0,-1412 # 7d18 <malloc+0x2024>
    ...
    52c0:	a7c50513          	add	a0,a0,-1412 # 7d38 <malloc+0x2044>
  ...
  while(1){
    ...
    5314:	a6850513          	add	a0,a0,-1432 # 7d78 <malloc+0x2084>
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5360:	a3c50513          	add	a0,a0,-1476 # 7d98 <malloc+0x20a4>
  ...
  if(pid == 0) {
    ...
    5390:	a3450513          	add	a0,a0,-1484 # 7dc0 <malloc+0x20cc>
    ...
    53b4:	9f850513          	add	a0,a0,-1544 # 7da8 <malloc+0x20b4>
    ...
    53dc:	9f050513          	add	a0,a0,-1552 # 7dc8 <malloc+0x20d4>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5426:	dc678793          	add	a5,a5,-570 # 81e8 <malloc+0x24f4>
    542a:	bd040713          	add	a4,s0,-1072
    542e:	00003317          	auipc	t1,0x3
    5432:	1aa30313          	add	t1,t1,426 # 85d8 <malloc+0x28e4>
  ...
  printf("usertests starting\n");
    ...
    5466:	a2650513          	add	a0,a0,-1498 # 7e88 <malloc+0x2194>
  ...
  if(fail){
    ...
    54a0:	9a450513          	add	a0,a0,-1628 # 7e40 <malloc+0x214c>
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54d0:	90458593          	add	a1,a1,-1788 # 7dd0 <malloc+0x20dc>
    ...
    54e6:	d0678793          	add	a5,a5,-762 # 81e8 <malloc+0x24f4>
    54ea:	bd040713          	add	a4,s0,-1072
    54ee:	00003317          	auipc	t1,0x3
    54f2:	0ea30313          	add	t1,t1,234 # 85d8 <malloc+0x28e4>
    ...
    5526:	97e50513          	add	a0,a0,-1666 # 7ea0 <malloc+0x21ac>
    552a:	00000097          	auipc	ra,0x0
    552e:	712080e7          	jalr	1810(ra) # 5c3c <printf>
        printf("SOME TESTS FAILED\n");
    5532:	00003a97          	auipc	s5,0x3
    5536:	8f6a8a93          	add	s5,s5,-1802 # 7e28 <malloc+0x2134>
        if(continuous != 2)
    553a:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    553c:	00003b17          	auipc	s6,0x3
    5540:	8ccb0b13          	add	s6,s6,-1844 # 7e08 <malloc+0x2114>
    5544:	a8f5                	j	5640 <main+0x256>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    5546:	00003597          	auipc	a1,0x3
    554a:	89258593          	add	a1,a1,-1902 # 7dd8 <malloc+0x20e4>
    ...
    5584:	86050513          	add	a0,a0,-1952 # 7de0 <malloc+0x20ec>
  ...
  if(fail){
    ...
    55f6:	83650513          	add	a0,a0,-1994 # 7e28 <malloc+0x2134>
    ...
    5610:	86450513          	add	a0,a0,-1948 # 7e70 <malloc+0x217c>
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    ...
    59b8:	c7c50513          	add	a0,a0,-900 # 8630 <digits>
    59bc:	883a                	mv	a6,a4
    59be:	2705                	addw	a4,a4,1
    59c0:	02c5f7bb          	remuw	a5,a1,a2
    59c4:	1782                	sll	a5,a5,0x20
    59c6:	9381                	srl	a5,a5,0x20
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  putc(fd, 'x');
    ...
    5b4a:	aeab8b93          	add	s7,s7,-1302 # 8630 <digits>
    5b4e:	03c9d793          	srl	a5,s3,0x3c
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b62:	0992                	sll	s3,s3,0x4
    5b64:	397d                	addw	s2,s2,-1
    ...
    5ba0:	62490913          	add	s2,s2,1572 # 81c0 <malloc+0x24cc>
        while(*s != 0){
    5ba4:	02800593          	li	a1,40
    5ba8:	bff1                	j	5b84 <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5baa:	008b8913          	add	s2,s7,8
...
{
    5c0e:	715d                	add	sp,sp,-80
    5c10:	ec06                	sd	ra,24(sp)
    5c12:	e822                	sd	s0,16(sp)
    5c14:	1000                	add	s0,sp,32
...
{
    5c3c:	711d                	add	sp,sp,-96
    5c3e:	ec06                	sd	ra,24(sp)
    5c40:	e822                	sd	s0,16(sp)
    5c42:	1000                	add	s0,sp,32
...
free(void *ap)
{
    5c72:	1141                	add	sp,sp,-16
    5c74:	e422                	sd	s0,8(sp)
    5c76:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c78:	ff050693          	add	a3,a0,-16
    ...
    5ca8:	00e6ea63          	bltu	a3,a4,5cbc <free+0x4a>
{
  ...
  if(bp + bp->s.size == p->s.ptr){
    ...
    5cc2:	02059813          	sll	a6,a1,0x20
    5cc6:	01c85713          	srl	a4,a6,0x1c
  ...
  if(p + p->s.size == bp){
    ...
    5cd6:	02061593          	sll	a1,a2,0x20
    5cda:	01c5d713          	srl	a4,a1,0x1c
...
malloc(uint nbytes)
{
  ...
  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5d00:	02051493          	sll	s1,a0,0x20
    5d04:	9081                	srl	s1,s1,0x20
    5d06:	04bd                	add	s1,s1,15
    5d08:	8091                	srl	s1,s1,0x4
    5d0a:	0014899b          	addw	s3,s1,1
    5d0e:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d44:	90890913          	add	s2,s2,-1784 # 8648 <freep>
  if(p == (char*)-1)
    5d48:	5afd                	li	s5,-1
    ...
    5d58:	11478793          	add	a5,a5,276 # ee68 <base>
  ...
  if(p == (char*)-1)
    ...
    5dc2:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5dc4:	02071693          	sll	a3,a4,0x20
    5dc8:	01c6d713          	srl	a4,a3,0x1c
