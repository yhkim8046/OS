...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	dd250513          	add	a0,a0,-558 # 5e10 <malloc+0x104>
      46:	00006097          	auipc	ra,0x6
      4a:	c0e080e7          	jalr	-1010(ra) # 5c54 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	71878793          	add	a5,a5,1816 # 9770 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	e2068693          	add	a3,a3,-480 # be80 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	db050513          	add	a0,a0,-592 # 5e30 <malloc+0x124>
      88:	00006097          	auipc	ra,0x6
      8c:	bcc080e7          	jalr	-1076(ra) # 5c54 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	da050513          	add	a0,a0,-608 # 5e48 <malloc+0x13c>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	da250513          	add	a0,a0,-606 # 5e68 <malloc+0x15c>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d6a50513          	add	a0,a0,-662 # 5e50 <malloc+0x144>
      ee:	00006097          	auipc	ra,0x6
      f2:	b66080e7          	jalr	-1178(ra) # 5c54 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d7650513          	add	a0,a0,-650 # 5e78 <malloc+0x16c>
     10a:	00006097          	auipc	ra,0x6
     10e:	b4a080e7          	jalr	-1206(ra) # 5c54 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d7450513          	add	a0,a0,-652 # 5ea0 <malloc+0x194>
     134:	00005097          	auipc	ra,0x5
     138:	7f0080e7          	jalr	2032(ra) # 5924 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	d6050513          	add	a0,a0,-672 # 5ea0 <malloc+0x194>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	d5c58593          	add	a1,a1,-676 # 5eb0 <malloc+0x1a4>
     15c:	00005097          	auipc	ra,0x5
     160:	798080e7          	jalr	1944(ra) # 58f4 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	d3850513          	add	a0,a0,-712 # 5ea0 <malloc+0x194>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	d3c58593          	add	a1,a1,-708 # 5eb8 <malloc+0x1ac>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	d0c50513          	add	a0,a0,-756 # 5ea0 <malloc+0x194>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	cf650513          	add	a0,a0,-778 # 5ec0 <malloc+0x1b4>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a82080e7          	jalr	-1406(ra) # 5c54 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c6c50513          	add	a0,a0,-916 # 5ee8 <malloc+0x1dc>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	c58a8a93          	add	s5,s5,-936 # 5ee8 <malloc+0x1dc>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	be8a0a13          	add	s4,s4,-1048 # be80 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	be650513          	add	a0,a0,-1050 # 5ef8 <malloc+0x1ec>
     31a:	00006097          	auipc	ra,0x6
     31e:	93a080e7          	jalr	-1734(ra) # 5c54 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	be450513          	add	a0,a0,-1052 # 5f18 <malloc+0x20c>
     33c:	00006097          	auipc	ra,0x6
     340:	918080e7          	jalr	-1768(ra) # 5c54 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	bc0a0a13          	add	s4,s4,-1088 # 5f30 <malloc+0x224>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	b1c50513          	add	a0,a0,-1252 # 5f38 <malloc+0x22c>
     424:	00006097          	auipc	ra,0x6
     428:	830080e7          	jalr	-2000(ra) # 5c54 <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	b1650513          	add	a0,a0,-1258 # 5f50 <malloc+0x244>
     442:	00006097          	auipc	ra,0x6
     446:	812080e7          	jalr	-2030(ra) # 5c54 <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	b2850513          	add	a0,a0,-1240 # 5f80 <malloc+0x274>
     460:	00005097          	auipc	ra,0x5
     464:	7f4080e7          	jalr	2036(ra) # 5c54 <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	b3e50513          	add	a0,a0,-1218 # 5fb0 <malloc+0x2a4>
     47a:	00005097          	auipc	ra,0x5
     47e:	7da080e7          	jalr	2010(ra) # 5c54 <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	b3050513          	add	a0,a0,-1232 # 5fc0 <malloc+0x2b4>
     498:	00005097          	auipc	ra,0x5
     49c:	7bc080e7          	jalr	1980(ra) # 5c54 <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	b22a0a13          	add	s4,s4,-1246 # 5ff0 <malloc+0x2e4>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	9e2a8a93          	add	s5,s5,-1566 # 5eb8 <malloc+0x1ac>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a7c50513          	add	a0,a0,-1412 # 5ff8 <malloc+0x2ec>
     584:	00005097          	auipc	ra,0x5
     588:	6d0080e7          	jalr	1744(ra) # 5c54 <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	a7650513          	add	a0,a0,-1418 # 6010 <malloc+0x304>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	6b2080e7          	jalr	1714(ra) # 5c54 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	9fc50513          	add	a0,a0,-1540 # 5fb0 <malloc+0x2a4>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	698080e7          	jalr	1688(ra) # 5c54 <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	a7250513          	add	a0,a0,-1422 # 6040 <malloc+0x334>
     5d6:	00005097          	auipc	ra,0x5
     5da:	67e080e7          	jalr	1662(ra) # 5c54 <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	a6c50513          	add	a0,a0,-1428 # 6058 <malloc+0x34c>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	660080e7          	jalr	1632(ra) # 5c54 <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	86e58593          	add	a1,a1,-1938 # 5eb0 <malloc+0x1a4>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	84250513          	add	a0,a0,-1982 # 5ea0 <malloc+0x194>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	81650513          	add	a0,a0,-2026 # 5ea0 <malloc+0x194>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	80250513          	add	a0,a0,-2046 # 5ea0 <malloc+0x194>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	a0c58593          	add	a1,a1,-1524 # 60e8 <malloc+0x3dc>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	78250513          	add	a0,a0,1922 # 5ea0 <malloc+0x194>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	92650513          	add	a0,a0,-1754 # 6088 <malloc+0x37c>
     76a:	00005097          	auipc	ra,0x5
     76e:	4ea080e7          	jalr	1258(ra) # 5c54 <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	92a50513          	add	a0,a0,-1750 # 60a8 <malloc+0x39c>
     786:	00005097          	auipc	ra,0x5
     78a:	4ce080e7          	jalr	1230(ra) # 5c54 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	92650513          	add	a0,a0,-1754 # 60b8 <malloc+0x3ac>
     79a:	00005097          	auipc	ra,0x5
     79e:	4ba080e7          	jalr	1210(ra) # 5c54 <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	92a50513          	add	a0,a0,-1750 # 60d8 <malloc+0x3cc>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	49e080e7          	jalr	1182(ra) # 5c54 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	8f650513          	add	a0,a0,-1802 # 60b8 <malloc+0x3ac>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	48a080e7          	jalr	1162(ra) # 5c54 <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	91050513          	add	a0,a0,-1776 # 60f0 <malloc+0x3e4>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	46c080e7          	jalr	1132(ra) # 5c54 <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	91250513          	add	a0,a0,-1774 # 6110 <malloc+0x404>
     806:	00005097          	auipc	ra,0x5
     80a:	44e080e7          	jalr	1102(ra) # 5c54 <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	8fe50513          	add	a0,a0,-1794 # 6130 <malloc+0x424>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	90e98993          	add	s3,s3,-1778 # 6158 <malloc+0x44c>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	93ea8a93          	add	s5,s5,-1730 # 6190 <malloc+0x484>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	89850513          	add	a0,a0,-1896 # 6130 <malloc+0x424>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	5ce58593          	add	a1,a1,1486 # be80 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	85c50513          	add	a0,a0,-1956 # 6130 <malloc+0x424>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	83a50513          	add	a0,a0,-1990 # 6138 <malloc+0x42c>
     906:	00005097          	auipc	ra,0x5
     90a:	34e080e7          	jalr	846(ra) # 5c54 <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	84c50513          	add	a0,a0,-1972 # 6168 <malloc+0x45c>
     924:	00005097          	auipc	ra,0x5
     928:	330080e7          	jalr	816(ra) # 5c54 <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	86650513          	add	a0,a0,-1946 # 61a0 <malloc+0x494>
     942:	00005097          	auipc	ra,0x5
     946:	312080e7          	jalr	786(ra) # 5c54 <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	87250513          	add	a0,a0,-1934 # 61c8 <malloc+0x4bc>
     95e:	00005097          	auipc	ra,0x5
     962:	2f6080e7          	jalr	758(ra) # 5c54 <printf>
    exit(1);
     966:	4505                	li	a0,1
    ...
    printf("%s: read failed\n", s);
     ...
     976:	87650513          	add	a0,a0,-1930 # 61e8 <malloc+0x4dc>
     97a:	00005097          	auipc	ra,0x5
     97e:	2da080e7          	jalr	730(ra) # 5c54 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	87250513          	add	a0,a0,-1934 # 6200 <malloc+0x4f4>
     996:	00005097          	auipc	ra,0x5
     99a:	2be080e7          	jalr	702(ra) # 5c54 <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	86050513          	add	a0,a0,-1952 # 6220 <malloc+0x514>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	4ac90913          	add	s2,s2,1196 # be80 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	80e50513          	add	a0,a0,-2034 # 6220 <malloc+0x514>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	45a90913          	add	s2,s2,1114 # be80 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	7ce50513          	add	a0,a0,1998 # 6228 <malloc+0x51c>
     a62:	00005097          	auipc	ra,0x5
     a66:	1f2080e7          	jalr	498(ra) # 5c54 <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	7d050513          	add	a0,a0,2000 # 6248 <malloc+0x53c>
     a80:	00005097          	auipc	ra,0x5
     a84:	1d4080e7          	jalr	468(ra) # 5c54 <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	7dc50513          	add	a0,a0,2012 # 6270 <malloc+0x564>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	1b8080e7          	jalr	440(ra) # 5c54 <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	76050513          	add	a0,a0,1888 # 6220 <malloc+0x514>
     ...
     af0:	7a450513          	add	a0,a0,1956 # 6290 <malloc+0x584>
     af4:	00005097          	auipc	ra,0x5
     af8:	160080e7          	jalr	352(ra) # 5c54 <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	7ae50513          	add	a0,a0,1966 # 62b8 <malloc+0x5ac>
     b12:	00005097          	auipc	ra,0x5
     b16:	142080e7          	jalr	322(ra) # 5c54 <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	7a850513          	add	a0,a0,1960 # 62d0 <malloc+0x5c4>
     b30:	00005097          	auipc	ra,0x5
     b34:	124080e7          	jalr	292(ra) # 5c54 <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	7b450513          	add	a0,a0,1972 # 62f8 <malloc+0x5ec>
     b4c:	00005097          	auipc	ra,0x5
     b50:	108080e7          	jalr	264(ra) # 5c54 <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	79e50513          	add	a0,a0,1950 # 6310 <malloc+0x604>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	7b658593          	add	a1,a1,1974 # 6340 <malloc+0x634>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	76a50513          	add	a0,a0,1898 # 6310 <malloc+0x604>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	75450513          	add	a0,a0,1876 # 6310 <malloc+0x604>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	73e50513          	add	a0,a0,1854 # 6310 <malloc+0x604>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	7a258593          	add	a1,a1,1954 # 6388 <malloc+0x67c>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	27e58593          	add	a1,a1,638 # be80 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  if(write(fd, buf, 10) != 10){
     ...
     c30:	25458593          	add	a1,a1,596 # be80 <buf>
     c34:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	6c250513          	add	a0,a0,1730 # 6310 <malloc+0x604>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	6b250513          	add	a0,a0,1714 # 6320 <malloc+0x614>
     c76:	00005097          	auipc	ra,0x5
     c7a:	fde080e7          	jalr	-34(ra) # 5c54 <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	6be50513          	add	a0,a0,1726 # 6348 <malloc+0x63c>
     c92:	00005097          	auipc	ra,0x5
     c96:	fc2080e7          	jalr	-62(ra) # 5c54 <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	6c250513          	add	a0,a0,1730 # 6368 <malloc+0x65c>
     cae:	00005097          	auipc	ra,0x5
     cb2:	fa6080e7          	jalr	-90(ra) # 5c54 <printf>
    exit(1);
     cb6:	4505                	li	a0,1
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	6ce50513          	add	a0,a0,1742 # 6390 <malloc+0x684>
     cca:	00005097          	auipc	ra,0x5
     cce:	f8a080e7          	jalr	-118(ra) # 5c54 <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	6d250513          	add	a0,a0,1746 # 63b0 <malloc+0x6a4>
     ce6:	00005097          	auipc	ra,0x5
     cea:	f6e080e7          	jalr	-146(ra) # 5c54 <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	6d650513          	add	a0,a0,1750 # 63d0 <malloc+0x6c4>
     d02:	00005097          	auipc	ra,0x5
     d06:	f52080e7          	jalr	-174(ra) # 5c54 <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	5e258593          	add	a1,a1,1506 # 6340 <malloc+0x634>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	67a58593          	add	a1,a1,1658 # 63f8 <malloc+0x6ec>
     d86:	00005517          	auipc	a0,0x5
     d8a:	66a50513          	add	a0,a0,1642 # 63f0 <malloc+0x6e4>
  ...
  unlink("lf1");
     ...
     d9e:	65650513          	add	a0,a0,1622 # 63f0 <malloc+0x6e4>
     da2:	00005097          	auipc	ra,0x5
     da6:	b82080e7          	jalr	-1150(ra) # 5924 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	64450513          	add	a0,a0,1604 # 63f0 <malloc+0x6e4>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	63650513          	add	a0,a0,1590 # 63f8 <malloc+0x6ec>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	0a658593          	add	a1,a1,166 # be80 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	5fe58593          	add	a1,a1,1534 # 63f8 <malloc+0x6ec>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	5e850513          	add	a0,a0,1512 # 63f8 <malloc+0x6ec>
     e18:	00005097          	auipc	ra,0x5
     e1c:	b0c080e7          	jalr	-1268(ra) # 5924 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	5d058593          	add	a1,a1,1488 # 63f0 <malloc+0x6e4>
     e28:	00005517          	auipc	a0,0x5
     e2c:	5d050513          	add	a0,a0,1488 # 63f8 <malloc+0x6ec>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	5b458593          	add	a1,a1,1460 # 63f0 <malloc+0x6e4>
     e44:	00005517          	auipc	a0,0x5
     e48:	6bc50513          	add	a0,a0,1724 # 6500 <malloc+0x7f4>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	59a50513          	add	a0,a0,1434 # 6400 <malloc+0x6f4>
     e6e:	00005097          	auipc	ra,0x5
     e72:	de6080e7          	jalr	-538(ra) # 5c54 <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	59650513          	add	a0,a0,1430 # 6418 <malloc+0x70c>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	dca080e7          	jalr	-566(ra) # 5c54 <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	59250513          	add	a0,a0,1426 # 6430 <malloc+0x724>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	dae080e7          	jalr	-594(ra) # 5c54 <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	59650513          	add	a0,a0,1430 # 6450 <malloc+0x744>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	d92080e7          	jalr	-622(ra) # 5c54 <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	5aa50513          	add	a0,a0,1450 # 6480 <malloc+0x774>
     ede:	00005097          	auipc	ra,0x5
     ee2:	d76080e7          	jalr	-650(ra) # 5c54 <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	5a650513          	add	a0,a0,1446 # 6498 <malloc+0x78c>
     efa:	00005097          	auipc	ra,0x5
     efe:	d5a080e7          	jalr	-678(ra) # 5c54 <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	5a250513          	add	a0,a0,1442 # 64b0 <malloc+0x7a4>
     f16:	00005097          	auipc	ra,0x5
     f1a:	d3e080e7          	jalr	-706(ra) # 5c54 <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	5ae50513          	add	a0,a0,1454 # 64d8 <malloc+0x7cc>
     f32:	00005097          	auipc	ra,0x5
     f36:	d22080e7          	jalr	-734(ra) # 5c54 <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	5c250513          	add	a0,a0,1474 # 6508 <malloc+0x7fc>
     f4e:	00005097          	auipc	ra,0x5
     f52:	d06080e7          	jalr	-762(ra) # 5c54 <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	57ca0a13          	add	s4,s4,1404 # 6528 <malloc+0x81c>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	52a50513          	add	a0,a0,1322 # 6528 <malloc+0x81c>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	4c250513          	add	a0,a0,1218 # 6530 <malloc+0x824>
    1076:	00005097          	auipc	ra,0x5
    107a:	bde080e7          	jalr	-1058(ra) # 5c54 <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	4c250513          	add	a0,a0,1218 # 6550 <malloc+0x844>
    1096:	00005097          	auipc	ra,0x5
    109a:	bbe080e7          	jalr	-1090(ra) # 5c54 <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	4c650513          	add	a0,a0,1222 # 6570 <malloc+0x864>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	ba2080e7          	jalr	-1118(ra) # 5c54 <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	4b498993          	add	s3,s3,1204 # 6590 <malloc+0x884>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	48850513          	add	a0,a0,1160 # 65a0 <malloc+0x894>
    1120:	00005097          	auipc	ra,0x5
    1124:	b34080e7          	jalr	-1228(ra) # 5c54 <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	b5b48493          	add	s1,s1,-1189 # ffffffffeaeb0b5b <__BSS_END__+0xffffffffeaea1ccb>
...
badarg(char *s)
{
    ...
    1184:	35048493          	add	s1,s1,848 # c350 <buf+0x4d0>
  for(int i = 0; i < 50000; i++){
    ...
    1192:	cba98993          	add	s3,s3,-838 # 5e48 <malloc+0x13c>
    argv[0] = (char*)0xffffffff;
...
00000000000011ba <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    121c:	58078793          	add	a5,a5,1408 # 7798 <malloc+0x1a8c>
  ...
  if(pid == 0){
    ...
    1252:	51a78793          	add	a5,a5,1306 # 8768 <big.0>
    1256:	00008697          	auipc	a3,0x8
    125a:	51268693          	add	a3,a3,1298 # 9768 <__global_pointer$+0x90f>
      big[i] = 'x';
    ...
    1270:	4e078e23          	sb	zero,1276(a5) # 9768 <__global_pointer$+0x90f>
    char *args2[] = { big, big, big, 0 };
    1274:	00007797          	auipc	a5,0x7
    1278:	f6c78793          	add	a5,a5,-148 # 81e0 <malloc+0x24d4>
    ...
    129c:	bb050513          	add	a0,a0,-1104 # 5e48 <malloc+0x13c>
    ...
    12b4:	39850513          	add	a0,a0,920 # 6648 <malloc+0x93c>
    12b8:	00005097          	auipc	ra,0x5
    12bc:	99c080e7          	jalr	-1636(ra) # 5c54 <printf>
      exit(1);
    12c0:	4505                	li	a0,1
    ...
    12d4:	2f050513          	add	a0,a0,752 # 65c0 <malloc+0x8b4>
    12d8:	00005097          	auipc	ra,0x5
    12dc:	97c080e7          	jalr	-1668(ra) # 5c54 <printf>
    exit(1);
    12e0:	4505                	li	a0,1
    ...
    12f4:	2f050513          	add	a0,a0,752 # 65e0 <malloc+0x8d4>
    12f8:	00005097          	auipc	ra,0x5
    12fc:	95c080e7          	jalr	-1700(ra) # 5c54 <printf>
    exit(1);
    1300:	4505                	li	a0,1
    ...
    1316:	2ee50513          	add	a0,a0,750 # 6600 <malloc+0x8f4>
    131a:	00005097          	auipc	ra,0x5
    131e:	93a080e7          	jalr	-1734(ra) # 5c54 <printf>
    exit(1);
    1322:	4505                	li	a0,1
    ...
    1336:	2f650513          	add	a0,a0,758 # 6628 <malloc+0x91c>
    133a:	00005097          	auipc	ra,0x5
    133e:	91a080e7          	jalr	-1766(ra) # 5c54 <printf>
    exit(1);
    1342:	4505                	li	a0,1
    ...
    1350:	77450513          	add	a0,a0,1908 # 6ac0 <malloc+0xdb4>
    1354:	00005097          	auipc	ra,0x5
    1358:	900080e7          	jalr	-1792(ra) # 5c54 <printf>
    exit(1);
    135c:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    139a:	2da50513          	add	a0,a0,730 # 6670 <malloc+0x964>
    139e:	00005097          	auipc	ra,0x5
    13a2:	8b6080e7          	jalr	-1866(ra) # 5c54 <printf>
    exit(1);
    13a6:	4505                	li	a0,1
...
00000000000013b0 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c4:	ae050513          	add	a0,a0,-1312 # 5ea0 <malloc+0x194>
  ...
  if(pid == 0){
    ...
    13f6:	aaea0a13          	add	s4,s4,-1362 # 5ea0 <malloc+0x194>
      int n = write(fd, "1234567890", 10);
    13fa:	00005a97          	auipc	s5,0x5
    13fe:	2d6a8a93          	add	s5,s5,726 # 66d0 <malloc+0x9c4>
      int fd = open("truncfile", O_WRONLY);
    1402:	4585                	li	a1,1
    1404:	8552                	mv	a0,s4
    ...
    1476:	22e50513          	add	a0,a0,558 # 66a0 <malloc+0x994>
    147a:	00004097          	auipc	ra,0x4
    147e:	7da080e7          	jalr	2010(ra) # 5c54 <printf>
    exit(1);
    1482:	4505                	li	a0,1
    ...
    1492:	22a50513          	add	a0,a0,554 # 66b8 <malloc+0x9ac>
    1496:	00004097          	auipc	ra,0x4
    149a:	7be080e7          	jalr	1982(ra) # 5c54 <printf>
        exit(1);
    149e:	4505                	li	a0,1
    ...
    14b0:	23450513          	add	a0,a0,564 # 66e0 <malloc+0x9d4>
    14b4:	00004097          	auipc	ra,0x4
    14b8:	7a0080e7          	jalr	1952(ra) # 5c54 <printf>
        exit(1);
    14bc:	4505                	li	a0,1
    ...
    14d6:	9cea0a13          	add	s4,s4,-1586 # 5ea0 <malloc+0x194>
    int n = write(fd, "xxx", 3);
    14da:	00005a97          	auipc	s5,0x5
    14de:	226a8a93          	add	s5,s5,550 # 6700 <malloc+0x9f4>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    1528:	97c50513          	add	a0,a0,-1668 # 5ea0 <malloc+0x194>
  ...
  exit(xstatus);
    ...
    1546:	17650513          	add	a0,a0,374 # 66b8 <malloc+0x9ac>
    154a:	00004097          	auipc	ra,0x4
    154e:	70a080e7          	jalr	1802(ra) # 5c54 <printf>
      exit(1);
    1552:	4505                	li	a0,1
    ...
    1564:	1a850513          	add	a0,a0,424 # 6708 <malloc+0x9fc>
    1568:	00004097          	auipc	ra,0x4
    156c:	6ec080e7          	jalr	1772(ra) # 5c54 <printf>
      exit(1);
    1570:	4505                	li	a0,1
...
000000000000157a <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    158a:	8c278793          	add	a5,a5,-1854 # 5e48 <malloc+0x13c>
    158e:	fcf43023          	sd	a5,-64(s0)
    1592:	00005797          	auipc	a5,0x5
    1596:	19678793          	add	a5,a5,406 # 6728 <malloc+0xa1c>
    159a:	fcf43423          	sd	a5,-56(s0)
    159e:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    15a2:	00005517          	auipc	a0,0x5
    15a6:	18e50513          	add	a0,a0,398 # 6730 <malloc+0xa24>
  ...
  if(pid == 0) {
    ...
    15d6:	15e50513          	add	a0,a0,350 # 6730 <malloc+0xa24>
    ...
    15f2:	16250513          	add	a0,a0,354 # 6750 <malloc+0xa44>
    15f6:	00004097          	auipc	ra,0x4
    15fa:	65e080e7          	jalr	1630(ra) # 5c54 <printf>
      exit(1);
    15fe:	4505                	li	a0,1
    ...
    1610:	09450513          	add	a0,a0,148 # 66a0 <malloc+0x994>
    1614:	00004097          	auipc	ra,0x4
    1618:	640080e7          	jalr	1600(ra) # 5c54 <printf>
     exit(1);
    161c:	4505                	li	a0,1
    ...
    162c:	11050513          	add	a0,a0,272 # 6738 <malloc+0xa2c>
    1630:	00004097          	auipc	ra,0x4
    1634:	624080e7          	jalr	1572(ra) # 5c54 <printf>
      exit(1);
    1638:	4505                	li	a0,1
    ...
    164a:	80250513          	add	a0,a0,-2046 # 5e48 <malloc+0x13c>
  ...
  if(xstatus != 0)
    ...
    167e:	0e650513          	add	a0,a0,230 # 6760 <malloc+0xa54>
    1682:	00004097          	auipc	ra,0x4
    1686:	5d2080e7          	jalr	1490(ra) # 5c54 <printf>
      exit(1);
    168a:	4505                	li	a0,1
    ...
    169a:	0e250513          	add	a0,a0,226 # 6778 <malloc+0xa6c>
    169e:	00004097          	auipc	ra,0x4
    16a2:	5b6080e7          	jalr	1462(ra) # 5c54 <printf>
    16a6:	b7d1                	j	166a <exectest+0xf0>
  fd = open("echo-ok", O_RDONLY);
    16a8:	4581                	li	a1,0
    16aa:	00005517          	auipc	a0,0x5
    16ae:	08650513          	add	a0,a0,134 # 6730 <malloc+0xa24>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16d8:	b1450513          	add	a0,a0,-1260 # 61e8 <malloc+0x4dc>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	578080e7          	jalr	1400(ra) # 5c54 <printf>
    exit(1);
    16e4:	4505                	li	a0,1
    ...
    16f4:	fc850513          	add	a0,a0,-56 # 66b8 <malloc+0x9ac>
    16f8:	00004097          	auipc	ra,0x4
    16fc:	55c080e7          	jalr	1372(ra) # 5c54 <printf>
    exit(1);
    1700:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    170e:	02650513          	add	a0,a0,38 # 6730 <malloc+0xa24>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    1738:	05c50513          	add	a0,a0,92 # 6790 <malloc+0xa84>
    173c:	00004097          	auipc	ra,0x4
    1740:	518080e7          	jalr	1304(ra) # 5c54 <printf>
    exit(1);
    1744:	4505                	li	a0,1
...
0000000000001758 <pipe1>:
{
  ...
  if(pid == 0){
    ...
    17a0:	6e4a8a93          	add	s5,s5,1764 # be80 <buf>
    17a4:	864a                	mv	a2,s2
    17a6:	85d6                	mv	a1,s5
    ...
    17bc:	6c870713          	add	a4,a4,1736 # be80 <buf>
    ...
    1800:	fac50513          	add	a0,a0,-84 # 67a8 <malloc+0xa9c>
    1804:	00004097          	auipc	ra,0x4
    1808:	450080e7          	jalr	1104(ra) # 5c54 <printf>
    exit(1);
    180c:	4505                	li	a0,1
    ...
    182e:	656b0b13          	add	s6,s6,1622 # be80 <buf>
    ...
    1842:	42da8a93          	add	s5,s5,1069 # 142d <truncate3+0x7d>
{
    ...
    188e:	f3650513          	add	a0,a0,-202 # 67c0 <malloc+0xab4>
    1892:	00004097          	auipc	ra,0x4
    1896:	3c2080e7          	jalr	962(ra) # 5c54 <printf>
        exit(1);
    189a:	4505                	li	a0,1
    ...
    18aa:	f3250513          	add	a0,a0,-206 # 67d8 <malloc+0xacc>
    18ae:	00004097          	auipc	ra,0x4
    18b2:	3a6080e7          	jalr	934(ra) # 5c54 <printf>
          return;
    ...
    18dc:	f1850513          	add	a0,a0,-232 # 67f0 <malloc+0xae4>
    18e0:	00004097          	auipc	ra,0x4
    18e4:	374080e7          	jalr	884(ra) # 5c54 <printf>
      exit(1);
    18e8:	4505                	li	a0,1
    ...
    1928:	eec50513          	add	a0,a0,-276 # 6810 <malloc+0xb04>
    192c:	00004097          	auipc	ra,0x4
    1930:	328080e7          	jalr	808(ra) # 5c54 <printf>
    exit(1);
    1934:	4505                	li	a0,1
...
000000000000193e <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    199a:	d0a50513          	add	a0,a0,-758 # 66a0 <malloc+0x994>
    199e:	00004097          	auipc	ra,0x4
    19a2:	2b6080e7          	jalr	694(ra) # 5c54 <printf>
      exit(1);
    19a6:	4505                	li	a0,1
    ...
    19b6:	e7650513          	add	a0,a0,-394 # 6828 <malloc+0xb1c>
    19ba:	00004097          	auipc	ra,0x4
    19be:	29a080e7          	jalr	666(ra) # 5c54 <printf>
        exit(1);
    19c2:	4505                	li	a0,1
    ...
    19d2:	e7250513          	add	a0,a0,-398 # 6840 <malloc+0xb34>
    19d6:	00004097          	auipc	ra,0x4
    19da:	27e080e7          	jalr	638(ra) # 5c54 <printf>
        exit(1);
    19de:	4505                	li	a0,1
...
00000000000019f2 <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a4a:	c5a50513          	add	a0,a0,-934 # 66a0 <malloc+0x994>
    1a4e:	00004097          	auipc	ra,0x4
    1a52:	206080e7          	jalr	518(ra) # 5c54 <printf>
      exit(1);
    1a56:	4505                	li	a0,1
    ...
    1a6e:	c3650513          	add	a0,a0,-970 # 66a0 <malloc+0x994>
    1a72:	00004097          	auipc	ra,0x4
    1a76:	1e2080e7          	jalr	482(ra) # 5c54 <printf>
        exit(1);
    1a7a:	4505                	li	a0,1
...
0000000000001a8c <forkfork>:
{
    ...
    1ae8:	d7c50513          	add	a0,a0,-644 # 6860 <malloc+0xb54>
    1aec:	00004097          	auipc	ra,0x4
    1af0:	168080e7          	jalr	360(ra) # 5c54 <printf>
      exit(1);
    1af4:	4505                	li	a0,1
    ...
    1afa:	dde080e7          	jalr	-546(ra) # 58d4 <exit>
{
    ...
    1b40:	d3450513          	add	a0,a0,-716 # 6870 <malloc+0xb64>
    1b44:	00004097          	auipc	ra,0x4
    1b48:	110080e7          	jalr	272(ra) # 5c54 <printf>
      exit(1);
    1b4c:	4505                	li	a0,1
...
0000000000001b56 <reparent2>:
{
  ...
  exit(0);
    ...
    1b8e:	f3650513          	add	a0,a0,-202 # 6ac0 <malloc+0xdb4>
    1b92:	00004097          	auipc	ra,0x4
    1b96:	0c2080e7          	jalr	194(ra) # 5c54 <printf>
      exit(1);
    1b9a:	4505                	li	a0,1
...
0000000000001bbe <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1c2c:	e9850513          	add	a0,a0,-360 # 6ac0 <malloc+0xdb4>
    1c30:	00004097          	auipc	ra,0x4
    1c34:	024080e7          	jalr	36(ra) # 5c54 <printf>
      exit(1);
    1c38:	4505                	li	a0,1
    ...
    1c58:	ae450513          	add	a0,a0,-1308 # 6738 <malloc+0xa2c>
    1c5c:	00004097          	auipc	ra,0x4
    1c60:	ff8080e7          	jalr	-8(ra) # 5c54 <printf>
          exit(1);
    1c64:	4505                	li	a0,1
    ...
    1cca:	bca50513          	add	a0,a0,-1078 # 6890 <malloc+0xb84>
    1cce:	00004097          	auipc	ra,0x4
    1cd2:	f86080e7          	jalr	-122(ra) # 5c54 <printf>
            exit(1);
    1cd6:	4505                	li	a0,1
    ...
    1cfe:	bae50513          	add	a0,a0,-1106 # 68a8 <malloc+0xb9c>
    1d02:	00004097          	auipc	ra,0x4
    1d06:	f52080e7          	jalr	-174(ra) # 5c54 <printf>
        exit(1);
    1d0a:	4505                	li	a0,1
    ...
    1d60:	b7450513          	add	a0,a0,-1164 # 68d0 <malloc+0xbc4>
    1d64:	00004097          	auipc	ra,0x4
    1d68:	ef0080e7          	jalr	-272(ra) # 5c54 <printf>
        exit(1);
    1d6c:	4505                	li	a0,1
...
0000000000001de4 <linkunlink>:
{
  ...
  unlink("x");
    ...
    1e04:	0b850513          	add	a0,a0,184 # 5eb8 <malloc+0x1ac>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1e2e:	e6da0a1b          	addw	s4,s4,-403 # 41c64e6d <__BSS_END__+0x41c55fdd>
    ...
    1e40:	07cb0b13          	add	s6,s6,124 # 5eb8 <malloc+0x1ac>
      link("cat", "x");
    1e44:	00005c17          	auipc	s8,0x5
    1e48:	ab4c0c13          	add	s8,s8,-1356 # 68f8 <malloc+0xbec>
    1e4c:	a825                	j	1e84 <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e4e:	85a6                	mv	a1,s1
    1e50:	00005517          	auipc	a0,0x5
    1e54:	85050513          	add	a0,a0,-1968 # 66a0 <malloc+0x994>
    1e58:	00004097          	auipc	ra,0x4
    1e5c:	dfc080e7          	jalr	-516(ra) # 5c54 <printf>
    exit(1);
    1e60:	4505                	li	a0,1
...
0000000000001ee8 <manywrites>:
{
  ...
  exit(0);
    ...
    1f4c:	b7850513          	add	a0,a0,-1160 # 6ac0 <malloc+0xdb4>
    1f50:	00004097          	auipc	ra,0x4
    1f54:	d04080e7          	jalr	-764(ra) # 5c54 <printf>
      exit(1);
    1f58:	4505                	li	a0,1
    ...
    1f8e:	ef6b0b13          	add	s6,s6,-266 # be80 <buf>
    ...
    2002:	90250513          	add	a0,a0,-1790 # 6900 <malloc+0xbf4>
    2006:	00004097          	auipc	ra,0x4
    200a:	c4e080e7          	jalr	-946(ra) # 5c54 <printf>
            exit(1);
    200e:	4505                	li	a0,1
    ...
    2022:	efa50513          	add	a0,a0,-262 # 5f18 <malloc+0x20c>
    2026:	00004097          	auipc	ra,0x4
    202a:	c2e080e7          	jalr	-978(ra) # 5c54 <printf>
            exit(1);
    202e:	4505                	li	a0,1
...
0000000000002040 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2070:	8f450513          	add	a0,a0,-1804 # 6960 <malloc+0xc54>
    2074:	00004097          	auipc	ra,0x4
    2078:	be0080e7          	jalr	-1056(ra) # 5c54 <printf>
    exit(1);
    207c:	4505                	li	a0,1
    ...
    2094:	88850513          	add	a0,a0,-1912 # 6918 <malloc+0xc0c>
    2098:	00004097          	auipc	ra,0x4
    209c:	bbc080e7          	jalr	-1092(ra) # 5c54 <printf>
    exit(1);
    20a0:	4505                	li	a0,1
    ...
    20b0:	88450513          	add	a0,a0,-1916 # 6930 <malloc+0xc24>
    20b4:	00004097          	auipc	ra,0x4
    20b8:	ba0080e7          	jalr	-1120(ra) # 5c54 <printf>
      exit(1);
    20bc:	4505                	li	a0,1
    ...
    20cc:	88050513          	add	a0,a0,-1920 # 6948 <malloc+0xc3c>
    20d0:	00004097          	auipc	ra,0x4
    20d4:	b84080e7          	jalr	-1148(ra) # 5c54 <printf>
    exit(1);
    20d8:	4505                	li	a0,1
...
0000000000002118 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2134:	35098993          	add	s3,s3,848 # c350 <buf+0x4d0>
    2138:	1003d937          	lui	s2,0x1003d
    213c:	090e                	sll	s2,s2,0x3
    213e:	48090913          	add	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e5f0>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2182:	52250513          	add	a0,a0,1314 # 66a0 <malloc+0x994>
    2186:	00004097          	auipc	ra,0x4
    218a:	ace080e7          	jalr	-1330(ra) # 5c54 <printf>
      exit(1);
    218e:	4505                	li	a0,1
    ...
    21a4:	7e850513          	add	a0,a0,2024 # 6988 <malloc+0xc7c>
    21a8:	00004097          	auipc	ra,0x4
    21ac:	aac080e7          	jalr	-1364(ra) # 5c54 <printf>
      exit(1);
    21b0:	4505                	li	a0,1
...
00000000000021c4 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    2226:	47e50513          	add	a0,a0,1150 # 66a0 <malloc+0x994>
    222a:	00004097          	auipc	ra,0x4
    222e:	a2a080e7          	jalr	-1494(ra) # 5c54 <printf>
      exit(1);
    2232:	4505                	li	a0,1
    ...
    2252:	75a50513          	add	a0,a0,1882 # 69a8 <malloc+0xc9c>
    2256:	00004097          	auipc	ra,0x4
    225a:	9fe080e7          	jalr	-1538(ra) # 5c54 <printf>
      exit(1);
    225e:	4505                	li	a0,1
...
0000000000002272 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2282:	74250513          	add	a0,a0,1858 # 69c0 <malloc+0xcb4>
  ...
  fd = open("bigarg-ok", 0);
    ...
    22b4:	71050513          	add	a0,a0,1808 # 69c0 <malloc+0xcb4>
  ...
  close(fd);
    ...
    22da:	39278793          	add	a5,a5,914 # 8668 <args.1>
    22de:	00006697          	auipc	a3,0x6
    22e2:	48268693          	add	a3,a3,1154 # 8760 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22e6:	00004717          	auipc	a4,0x4
    22ea:	6ea70713          	add	a4,a4,1770 # 69d0 <malloc+0xcc4>
    ...
    233e:	77650513          	add	a0,a0,1910 # 6ab0 <malloc+0xda4>
    2342:	00004097          	auipc	ra,0x4
    2346:	912080e7          	jalr	-1774(ra) # 5c54 <printf>
    exit(1);
    234a:	4505                	li	a0,1
    ...
    2362:	77250513          	add	a0,a0,1906 # 6ad0 <malloc+0xdc4>
    2366:	00004097          	auipc	ra,0x4
    236a:	8ee080e7          	jalr	-1810(ra) # 5c54 <printf>
    exit(1);
    236e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    23b6:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff0170>
    23ba:	85a6                	mv	a1,s1
    23bc:	00004517          	auipc	a0,0x4
    23c0:	73450513          	add	a0,a0,1844 # 6af0 <malloc+0xde4>
    23c4:	00004097          	auipc	ra,0x4
    23c8:	890080e7          	jalr	-1904(ra) # 5c54 <printf>
    exit(1);
    23cc:	4505                	li	a0,1
    ...
    23dc:	2c850513          	add	a0,a0,712 # 66a0 <malloc+0x994>
    23e0:	00004097          	auipc	ra,0x4
    23e4:	874080e7          	jalr	-1932(ra) # 5c54 <printf>
    exit(1);
    23e8:	4505                	li	a0,1
...
00000000000023fc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2476:	32678793          	add	a5,a5,806 # 7798 <malloc+0x1a8c>
  ...
  if(ret != -1){
    ...
    24b8:	66450513          	add	a0,a0,1636 # 6b18 <malloc+0xe0c>
    24bc:	00003097          	auipc	ra,0x3
    24c0:	798080e7          	jalr	1944(ra) # 5c54 <printf>
    exit(1);
    24c4:	4505                	li	a0,1
    ...
    24d6:	0ee50513          	add	a0,a0,238 # 65c0 <malloc+0x8b4>
    24da:	00003097          	auipc	ra,0x3
    24de:	77a080e7          	jalr	1914(ra) # 5c54 <printf>
    exit(1);
    24e2:	4505                	li	a0,1
    ...
    24f4:	0f050513          	add	a0,a0,240 # 65e0 <malloc+0x8d4>
    24f8:	00003097          	auipc	ra,0x3
    24fc:	75c080e7          	jalr	1884(ra) # 5c54 <printf>
    exit(1);
    2500:	4505                	li	a0,1
    ...
    2514:	0f050513          	add	a0,a0,240 # 6600 <malloc+0x8f4>
    2518:	00003097          	auipc	ra,0x3
    251c:	73c080e7          	jalr	1852(ra) # 5c54 <printf>
    exit(1);
    2520:	4505                	li	a0,1
    ...
    2532:	0fa50513          	add	a0,a0,250 # 6628 <malloc+0x91c>
    2536:	00003097          	auipc	ra,0x3
    253a:	71e080e7          	jalr	1822(ra) # 5c54 <printf>
    exit(1);
    253e:	4505                	li	a0,1
...
0000000000002548 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    257e:	5de50513          	add	a0,a0,1502 # 6b58 <malloc+0xe4c>
  ...
  if(n >= 0){
    ...
    25ae:	5ce50513          	add	a0,a0,1486 # 6b78 <malloc+0xe6c>
    25b2:	00003097          	auipc	ra,0x3
    25b6:	6a2080e7          	jalr	1698(ra) # 5c54 <printf>
    exit(1);
    25ba:	4505                	li	a0,1
    ...
    25cc:	55850513          	add	a0,a0,1368 # 6b20 <malloc+0xe14>
    25d0:	00003097          	auipc	ra,0x3
    25d4:	684080e7          	jalr	1668(ra) # 5c54 <printf>
    exit(1);
    25d8:	4505                	li	a0,1
    ...
    25e8:	55450513          	add	a0,a0,1364 # 6b38 <malloc+0xe2c>
    25ec:	00003097          	auipc	ra,0x3
    25f0:	668080e7          	jalr	1640(ra) # 5c54 <printf>
    exit(1);
    25f4:	4505                	li	a0,1
    ...
    2602:	56250513          	add	a0,a0,1378 # 6b60 <malloc+0xe54>
    2606:	00003097          	auipc	ra,0x3
    260a:	64e080e7          	jalr	1614(ra) # 5c54 <printf>
    exit(1);
    260e:	4505                	li	a0,1
  ...
  if(n >= 0){
    ...
    2662:	54a50513          	add	a0,a0,1354 # 6ba8 <malloc+0xe9c>
    2666:	00003097          	auipc	ra,0x3
    266a:	5ee080e7          	jalr	1518(ra) # 5c54 <printf>
    exit(1);
    266e:	4505                	li	a0,1
    ...
    267c:	4e850513          	add	a0,a0,1256 # 6b60 <malloc+0xe54>
    2680:	00003097          	auipc	ra,0x3
    2684:	5d4080e7          	jalr	1492(ra) # 5c54 <printf>
    exit(1);
    2688:	4505                	li	a0,1
...
00000000000026a6 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    26e2:	6705                	lui	a4,0x1
      *b = 99;
    26e4:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff1170>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    2702:	4d250513          	add	a0,a0,1234 # 6bd0 <malloc+0xec4>
    2706:	00003097          	auipc	ra,0x3
    270a:	54e080e7          	jalr	1358(ra) # 5c54 <printf>
    exit(1);
    270e:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2766:	48e50513          	add	a0,a0,1166 # 6bf0 <malloc+0xee4>
    276a:	00003097          	auipc	ra,0x3
    276e:	4ea080e7          	jalr	1258(ra) # 5c54 <printf>
    exit(1);
    2772:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    27ca:	48a50513          	add	a0,a0,1162 # 6c50 <malloc+0xf44>
    27ce:	00003097          	auipc	ra,0x3
    27d2:	486080e7          	jalr	1158(ra) # 5c54 <printf>
    exit(1);
    27d6:	4505                	li	a0,1
    ...
    27ec:	42850513          	add	a0,a0,1064 # 6c10 <malloc+0xf04>
    27f0:	00003097          	auipc	ra,0x3
    27f4:	464080e7          	jalr	1124(ra) # 5c54 <printf>
      exit(1);
    27f8:	4505                	li	a0,1
    ...
    2808:	42c50513          	add	a0,a0,1068 # 6c30 <malloc+0xf24>
    280c:	00003097          	auipc	ra,0x3
    2810:	448080e7          	jalr	1096(ra) # 5c54 <printf>
    exit(1);
    2814:	4505                	li	a0,1
...
0000000000002844 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    28a6:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f116f>
  a = sbrk(0);
    28aa:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    290a:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f116f>
  ...
  if(c != a){
    ...
    2952:	32250513          	add	a0,a0,802 # 6c70 <malloc+0xf64>
    2956:	00003097          	auipc	ra,0x3
    295a:	2fe080e7          	jalr	766(ra) # 5c54 <printf>
    exit(1);
    295e:	4505                	li	a0,1
    ...
    296e:	34e50513          	add	a0,a0,846 # 6cb8 <malloc+0xfac>
    2972:	00003097          	auipc	ra,0x3
    2976:	2e2080e7          	jalr	738(ra) # 5c54 <printf>
    exit(1);
    297a:	4505                	li	a0,1
    ...
    298e:	34e50513          	add	a0,a0,846 # 6cd8 <malloc+0xfcc>
    2992:	00003097          	auipc	ra,0x3
    2996:	2c2080e7          	jalr	706(ra) # 5c54 <printf>
    exit(1);
    299a:	4505                	li	a0,1
    ...
    29ae:	36e50513          	add	a0,a0,878 # 6d18 <malloc+0x100c>
    29b2:	00003097          	auipc	ra,0x3
    29b6:	2a2080e7          	jalr	674(ra) # 5c54 <printf>
    exit(1);
    29ba:	4505                	li	a0,1
    ...
    29ca:	38250513          	add	a0,a0,898 # 6d48 <malloc+0x103c>
    29ce:	00003097          	auipc	ra,0x3
    29d2:	286080e7          	jalr	646(ra) # 5c54 <printf>
    exit(1);
    29d6:	4505                	li	a0,1
    ...
    29ea:	39a50513          	add	a0,a0,922 # 6d80 <malloc+0x1074>
    29ee:	00003097          	auipc	ra,0x3
    29f2:	266080e7          	jalr	614(ra) # 5c54 <printf>
    exit(1);
    29f6:	4505                	li	a0,1
...
0000000000002a00 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    2a24:	38850513          	add	a0,a0,904 # 6da8 <malloc+0x109c>
    2a28:	00003097          	auipc	ra,0x3
    2a2c:	eec080e7          	jalr	-276(ra) # 5914 <open>
    2a30:	84aa                	mv	s1,a0
  unlink("sbrk");
    2a32:	00004517          	auipc	a0,0x4
    2a36:	37650513          	add	a0,a0,886 # 6da8 <malloc+0x109c>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a8a:	32a50513          	add	a0,a0,810 # 6db0 <malloc+0x10a4>
    2a8e:	00003097          	auipc	ra,0x3
    2a92:	1c6080e7          	jalr	454(ra) # 5c54 <printf>
    exit(1);
    2a96:	4505                	li	a0,1
    ...
    2aa6:	32650513          	add	a0,a0,806 # 6dc8 <malloc+0x10bc>
    2aaa:	00003097          	auipc	ra,0x3
    2aae:	1aa080e7          	jalr	426(ra) # 5c54 <printf>
    exit(1);
    2ab2:	4505                	li	a0,1
    ...
    2ac2:	cea50513          	add	a0,a0,-790 # 67a8 <malloc+0xa9c>
    2ac6:	00003097          	auipc	ra,0x3
    2aca:	18e080e7          	jalr	398(ra) # 5c54 <printf>
    exit(1);
    2ace:	4505                	li	a0,1
...
0000000000002ad8 <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2aec:	2f850513          	add	a0,a0,760 # 6de0 <malloc+0x10d4>
  ...
  close(fd);
    ...
    2b34:	b8850513          	add	a0,a0,-1144 # 66b8 <malloc+0x9ac>
    2b38:	00003097          	auipc	ra,0x3
    2b3c:	11c080e7          	jalr	284(ra) # 5c54 <printf>
    exit(1);
    2b40:	4505                	li	a0,1
...
0000000000002b4a <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b82:	f4250513          	add	a0,a0,-190 # 6ac0 <malloc+0xdb4>
    2b86:	00003097          	auipc	ra,0x3
    2b8a:	0ce080e7          	jalr	206(ra) # 5c54 <printf>
    exit(1);
    2b8e:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bd8:	eec50513          	add	a0,a0,-276 # 6ac0 <malloc+0xdb4>
    2bdc:	00003097          	auipc	ra,0x3
    2be0:	078080e7          	jalr	120(ra) # 5c54 <printf>
    exit(1);
    2be4:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2c10:	8007879b          	addw	a5,a5,-2048 # a800 <uninit+0x1090>
    ...
    2c38:	e8c50513          	add	a0,a0,-372 # 6ac0 <malloc+0xdb4>
    2c3c:	00003097          	auipc	ra,0x3
    2c40:	018080e7          	jalr	24(ra) # 5c54 <printf>
    exit(1);
    2c44:	4505                	li	a0,1
...
0000000000002d34 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2d40:	0511                	add	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff1174>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2dac:	d1850513          	add	a0,a0,-744 # 6ac0 <malloc+0xdb4>
    2db0:	00003097          	auipc	ra,0x3
    2db4:	ea4080e7          	jalr	-348(ra) # 5c54 <printf>
      exit(1);
    2db8:	4505                	li	a0,1
    ...
    2e00:	04c50513          	add	a0,a0,76 # 5e48 <malloc+0x13c>
    2e04:	faa43c23          	sd	a0,-72(s0)
    2e08:	00003797          	auipc	a5,0x3
    2e0c:	0b078793          	add	a5,a5,176 # 5eb8 <malloc+0x1ac>
...
0000000000002e2e <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2e3e:	17e50513          	add	a0,a0,382 # 6fb8 <malloc+0x12ac>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2e50:	fc450513          	add	a0,a0,-60 # 6e10 <malloc+0x1104>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e66:	00650513          	add	a0,a0,6 # 6e68 <malloc+0x115c>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e84:	06050513          	add	a0,a0,96 # 6ee0 <malloc+0x11d4>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2ea0:	0b450513          	add	a0,a0,180 # 6f50 <malloc+0x1244>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2eb2:	0fa50513          	add	a0,a0,250 # 6fa8 <malloc+0x129c>
  ...
  unlink("12345678901234");
    ...
    2f30:	ebc50513          	add	a0,a0,-324 # 6de8 <malloc+0x10dc>
    2f34:	00003097          	auipc	ra,0x3
    2f38:	d20080e7          	jalr	-736(ra) # 5c54 <printf>
    exit(1);
    2f3c:	4505                	li	a0,1
    ...
    2f4c:	ee850513          	add	a0,a0,-280 # 6e30 <malloc+0x1124>
    2f50:	00003097          	auipc	ra,0x3
    2f54:	d04080e7          	jalr	-764(ra) # 5c54 <printf>
    exit(1);
    2f58:	4505                	li	a0,1
    ...
    2f68:	f3450513          	add	a0,a0,-204 # 6e98 <malloc+0x118c>
    2f6c:	00003097          	auipc	ra,0x3
    2f70:	ce8080e7          	jalr	-792(ra) # 5c54 <printf>
    exit(1);
    2f74:	4505                	li	a0,1
    ...
    2f84:	f9050513          	add	a0,a0,-112 # 6f10 <malloc+0x1204>
    2f88:	00003097          	auipc	ra,0x3
    2f8c:	ccc080e7          	jalr	-820(ra) # 5c54 <printf>
    exit(1);
    2f90:	4505                	li	a0,1
    ...
    2fa0:	fd450513          	add	a0,a0,-44 # 6f70 <malloc+0x1264>
    2fa4:	00003097          	auipc	ra,0x3
    2fa8:	cb0080e7          	jalr	-848(ra) # 5c54 <printf>
    exit(1);
    2fac:	4505                	li	a0,1
    ...
    2fbc:	01050513          	add	a0,a0,16 # 6fc8 <malloc+0x12bc>
    2fc0:	00003097          	auipc	ra,0x3
    2fc4:	c94080e7          	jalr	-876(ra) # 5c54 <printf>
    exit(1);
    2fc8:	4505                	li	a0,1
...
0000000000002fd2 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2fe2:	02250513          	add	a0,a0,34 # 7000 <malloc+0x12f4>
  ...
  if(chdir("iputdir") < 0){
    ...
    2ff6:	00e50513          	add	a0,a0,14 # 7000 <malloc+0x12f4>
  ...
  if(unlink("../iputdir") < 0){
    ...
    300a:	03a50513          	add	a0,a0,58 # 7040 <malloc+0x1334>
  ...
  if(chdir("/") < 0){
    ...
    301e:	05650513          	add	a0,a0,86 # 7070 <malloc+0x1364>
    ...
    303e:	fce50513          	add	a0,a0,-50 # 7008 <malloc+0x12fc>
    3042:	00003097          	auipc	ra,0x3
    3046:	c12080e7          	jalr	-1006(ra) # 5c54 <printf>
    exit(1);
    304a:	4505                	li	a0,1
    ...
    305a:	fca50513          	add	a0,a0,-54 # 7020 <malloc+0x1314>
    305e:	00003097          	auipc	ra,0x3
    3062:	bf6080e7          	jalr	-1034(ra) # 5c54 <printf>
    exit(1);
    3066:	4505                	li	a0,1
    ...
    3076:	fde50513          	add	a0,a0,-34 # 7050 <malloc+0x1344>
    307a:	00003097          	auipc	ra,0x3
    307e:	bda080e7          	jalr	-1062(ra) # 5c54 <printf>
    exit(1);
    3082:	4505                	li	a0,1
    ...
    3092:	fea50513          	add	a0,a0,-22 # 7078 <malloc+0x136c>
    3096:	00003097          	auipc	ra,0x3
    309a:	bbe080e7          	jalr	-1090(ra) # 5c54 <printf>
    exit(1);
    309e:	4505                	li	a0,1
...
00000000000030a8 <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    30c6:	f3e50513          	add	a0,a0,-194 # 7000 <malloc+0x12f4>
    ...
    30da:	f2a50513          	add	a0,a0,-214 # 7000 <malloc+0x12f4>
    ...
    30ee:	f5650513          	add	a0,a0,-170 # 7040 <malloc+0x1334>
    ...
    310e:	59650513          	add	a0,a0,1430 # 66a0 <malloc+0x994>
    3112:	00003097          	auipc	ra,0x3
    3116:	b42080e7          	jalr	-1214(ra) # 5c54 <printf>
    exit(1);
    311a:	4505                	li	a0,1
    ...
    312a:	ee250513          	add	a0,a0,-286 # 7008 <malloc+0x12fc>
    312e:	00003097          	auipc	ra,0x3
    3132:	b26080e7          	jalr	-1242(ra) # 5c54 <printf>
      exit(1);
    3136:	4505                	li	a0,1
    ...
    3146:	f4e50513          	add	a0,a0,-178 # 7090 <malloc+0x1384>
    314a:	00003097          	auipc	ra,0x3
    314e:	b0a080e7          	jalr	-1270(ra) # 5c54 <printf>
      exit(1);
    3152:	4505                	li	a0,1
    ...
    3162:	ef250513          	add	a0,a0,-270 # 7050 <malloc+0x1344>
    3166:	00003097          	auipc	ra,0x3
    316a:	aee080e7          	jalr	-1298(ra) # 5c54 <printf>
      exit(1);
    316e:	4505                	li	a0,1
...
0000000000003190 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    31a0:	f0c50513          	add	a0,a0,-244 # 70a8 <malloc+0x139c>
  ...
  if(chdir("dir0") < 0){
    ...
    31b4:	ef850513          	add	a0,a0,-264 # 70a8 <malloc+0x139c>
  ...
  if(chdir("..") < 0){
    ...
    31c8:	f0450513          	add	a0,a0,-252 # 70c8 <malloc+0x13bc>
  ...
  if(unlink("dir0") < 0){
    ...
    31dc:	ed050513          	add	a0,a0,-304 # 70a8 <malloc+0x139c>
    ...
    31fc:	e1050513          	add	a0,a0,-496 # 7008 <malloc+0x12fc>
    3200:	00003097          	auipc	ra,0x3
    3204:	a54080e7          	jalr	-1452(ra) # 5c54 <printf>
    exit(1);
    3208:	4505                	li	a0,1
    ...
    3218:	e9c50513          	add	a0,a0,-356 # 70b0 <malloc+0x13a4>
    321c:	00003097          	auipc	ra,0x3
    3220:	a38080e7          	jalr	-1480(ra) # 5c54 <printf>
    exit(1);
    3224:	4505                	li	a0,1
    ...
    3234:	ea050513          	add	a0,a0,-352 # 70d0 <malloc+0x13c4>
    3238:	00003097          	auipc	ra,0x3
    323c:	a1c080e7          	jalr	-1508(ra) # 5c54 <printf>
    exit(1);
    3240:	4505                	li	a0,1
    ...
    3250:	e9c50513          	add	a0,a0,-356 # 70e8 <malloc+0x13dc>
    3254:	00003097          	auipc	ra,0x3
    3258:	a00080e7          	jalr	-1536(ra) # 5c54 <printf>
    exit(1);
    325c:	4505                	li	a0,1
...
0000000000003266 <subdir>:
{
  ...
  unlink("ff");
    ...
    3278:	fbc50513          	add	a0,a0,-68 # 7230 <malloc+0x1524>
    327c:	00002097          	auipc	ra,0x2
    3280:	6a8080e7          	jalr	1704(ra) # 5924 <unlink>
  if(mkdir("dd") != 0){
    3284:	00004517          	auipc	a0,0x4
    3288:	e7c50513          	add	a0,a0,-388 # 7100 <malloc+0x13f4>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e8450513          	add	a0,a0,-380 # 7120 <malloc+0x1414>
  ...
  write(fd, "ff", 2);
    ...
    32b8:	f7c58593          	add	a1,a1,-132 # 7230 <malloc+0x1524>
  ...
  if(unlink("dd") >= 0){
    ...
    32d2:	e3250513          	add	a0,a0,-462 # 7100 <malloc+0x13f4>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    32e6:	e9650513          	add	a0,a0,-362 # 7178 <malloc+0x146c>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32fe:	ea650513          	add	a0,a0,-346 # 71a0 <malloc+0x1494>
  ...
  write(fd, "FF", 2);
    ...
    3316:	ebe58593          	add	a1,a1,-322 # 71d0 <malloc+0x14c4>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    3332:	eaa50513          	add	a0,a0,-342 # 71d8 <malloc+0x14cc>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    334a:	b3a58593          	add	a1,a1,-1222 # be80 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3360:	b2474703          	lbu	a4,-1244(a4) # be80 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    337a:	eb258593          	add	a1,a1,-334 # 7228 <malloc+0x151c>
    337e:	00004517          	auipc	a0,0x4
    3382:	e2250513          	add	a0,a0,-478 # 71a0 <malloc+0x1494>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3396:	e0e50513          	add	a0,a0,-498 # 71a0 <malloc+0x1494>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ac:	df850513          	add	a0,a0,-520 # 71a0 <malloc+0x1494>
  ...
  if(chdir("dd") != 0){
    ...
    33c0:	d4450513          	add	a0,a0,-700 # 7100 <malloc+0x13f4>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    33d4:	ef050513          	add	a0,a0,-272 # 72c0 <malloc+0x15b4>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    33e8:	f0c50513          	add	a0,a0,-244 # 72f0 <malloc+0x15e4>
  ...
  if(chdir("./..") != 0){
    ...
    33fc:	f2850513          	add	a0,a0,-216 # 7320 <malloc+0x1614>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    3412:	e1a50513          	add	a0,a0,-486 # 7228 <malloc+0x151c>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    342a:	a5a58593          	add	a1,a1,-1446 # be80 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    344c:	d5850513          	add	a0,a0,-680 # 71a0 <malloc+0x1494>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3464:	f5050513          	add	a0,a0,-176 # 73b0 <malloc+0x16a4>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    347c:	f6850513          	add	a0,a0,-152 # 73e0 <malloc+0x16d4>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3494:	c7050513          	add	a0,a0,-912 # 7100 <malloc+0x13f4>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    34aa:	c5a50513          	add	a0,a0,-934 # 7100 <malloc+0x13f4>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    34c0:	c4450513          	add	a0,a0,-956 # 7100 <malloc+0x13f4>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    34d4:	fa058593          	add	a1,a1,-96 # 7470 <malloc+0x1764>
    34d8:	00004517          	auipc	a0,0x4
    34dc:	ed850513          	add	a0,a0,-296 # 73b0 <malloc+0x16a4>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    34f0:	f8458593          	add	a1,a1,-124 # 7470 <malloc+0x1764>
    34f4:	00004517          	auipc	a0,0x4
    34f8:	eec50513          	add	a0,a0,-276 # 73e0 <malloc+0x16d4>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    350c:	d2058593          	add	a1,a1,-736 # 7228 <malloc+0x151c>
    3510:	00004517          	auipc	a0,0x4
    3514:	c1050513          	add	a0,a0,-1008 # 7120 <malloc+0x1414>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    3528:	e8c50513          	add	a0,a0,-372 # 73b0 <malloc+0x16a4>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    353c:	ea850513          	add	a0,a0,-344 # 73e0 <malloc+0x16d4>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    3550:	cdc50513          	add	a0,a0,-804 # 7228 <malloc+0x151c>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3564:	e8050513          	add	a0,a0,-384 # 73e0 <malloc+0x16d4>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    3578:	e3c50513          	add	a0,a0,-452 # 73b0 <malloc+0x16a4>
  ...
  if(chdir("dd/ff") == 0){
    ...
    358c:	b9850513          	add	a0,a0,-1128 # 7120 <malloc+0x1414>
  ...
  if(chdir("dd/xx") == 0){
    ...
    35a0:	02450513          	add	a0,a0,36 # 75c0 <malloc+0x18b4>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    35b4:	c7850513          	add	a0,a0,-904 # 7228 <malloc+0x151c>
  ...
  if(unlink("dd/ff") != 0){
    ...
    35c8:	b5c50513          	add	a0,a0,-1188 # 7120 <malloc+0x1414>
  ...
  if(unlink("dd") == 0){
    ...
    35dc:	b2850513          	add	a0,a0,-1240 # 7100 <malloc+0x13f4>
  ...
  if(unlink("dd/dd") < 0){
    ...
    35f0:	04450513          	add	a0,a0,68 # 7630 <malloc+0x1924>
  ...
  if(unlink("dd") < 0){
    ...
    3604:	b0050513          	add	a0,a0,-1280 # 7100 <malloc+0x13f4>
    ...
    3626:	ae650513          	add	a0,a0,-1306 # 7108 <malloc+0x13fc>
    362a:	00002097          	auipc	ra,0x2
    362e:	62a080e7          	jalr	1578(ra) # 5c54 <printf>
    exit(1);
    3632:	4505                	li	a0,1
    ...
    3642:	aea50513          	add	a0,a0,-1302 # 7128 <malloc+0x141c>
    3646:	00002097          	auipc	ra,0x2
    364a:	60e080e7          	jalr	1550(ra) # 5c54 <printf>
    exit(1);
    364e:	4505                	li	a0,1
    ...
    365e:	aee50513          	add	a0,a0,-1298 # 7148 <malloc+0x143c>
    3662:	00002097          	auipc	ra,0x2
    3666:	5f2080e7          	jalr	1522(ra) # 5c54 <printf>
    exit(1);
    366a:	4505                	li	a0,1
    ...
    367a:	b0a50513          	add	a0,a0,-1270 # 7180 <malloc+0x1474>
    367e:	00002097          	auipc	ra,0x2
    3682:	5d6080e7          	jalr	1494(ra) # 5c54 <printf>
    exit(1);
    3686:	4505                	li	a0,1
    ...
    3696:	b1e50513          	add	a0,a0,-1250 # 71b0 <malloc+0x14a4>
    369a:	00002097          	auipc	ra,0x2
    369e:	5ba080e7          	jalr	1466(ra) # 5c54 <printf>
    exit(1);
    36a2:	4505                	li	a0,1
    ...
    36b2:	b3a50513          	add	a0,a0,-1222 # 71e8 <malloc+0x14dc>
    36b6:	00002097          	auipc	ra,0x2
    36ba:	59e080e7          	jalr	1438(ra) # 5c54 <printf>
    exit(1);
    36be:	4505                	li	a0,1
    ...
    36ce:	b3e50513          	add	a0,a0,-1218 # 7208 <malloc+0x14fc>
    36d2:	00002097          	auipc	ra,0x2
    36d6:	582080e7          	jalr	1410(ra) # 5c54 <printf>
    exit(1);
    36da:	4505                	li	a0,1
    ...
    36ea:	b5250513          	add	a0,a0,-1198 # 7238 <malloc+0x152c>
    36ee:	00002097          	auipc	ra,0x2
    36f2:	566080e7          	jalr	1382(ra) # 5c54 <printf>
    exit(1);
    36f6:	4505                	li	a0,1
    ...
    3706:	b5e50513          	add	a0,a0,-1186 # 7260 <malloc+0x1554>
    370a:	00002097          	auipc	ra,0x2
    370e:	54a080e7          	jalr	1354(ra) # 5c54 <printf>
    exit(1);
    3712:	4505                	li	a0,1
    ...
    3722:	b6250513          	add	a0,a0,-1182 # 7280 <malloc+0x1574>
    3726:	00002097          	auipc	ra,0x2
    372a:	52e080e7          	jalr	1326(ra) # 5c54 <printf>
    exit(1);
    372e:	4505                	li	a0,1
    ...
    373e:	b6e50513          	add	a0,a0,-1170 # 72a8 <malloc+0x159c>
    3742:	00002097          	auipc	ra,0x2
    3746:	512080e7          	jalr	1298(ra) # 5c54 <printf>
    exit(1);
    374a:	4505                	li	a0,1
    ...
    375a:	b7a50513          	add	a0,a0,-1158 # 72d0 <malloc+0x15c4>
    375e:	00002097          	auipc	ra,0x2
    3762:	4f6080e7          	jalr	1270(ra) # 5c54 <printf>
    exit(1);
    3766:	4505                	li	a0,1
    ...
    3776:	b8e50513          	add	a0,a0,-1138 # 7300 <malloc+0x15f4>
    377a:	00002097          	auipc	ra,0x2
    377e:	4da080e7          	jalr	1242(ra) # 5c54 <printf>
    exit(1);
    3782:	4505                	li	a0,1
    ...
    3792:	b9a50513          	add	a0,a0,-1126 # 7328 <malloc+0x161c>
    3796:	00002097          	auipc	ra,0x2
    379a:	4be080e7          	jalr	1214(ra) # 5c54 <printf>
    exit(1);
    379e:	4505                	li	a0,1
    ...
    37ae:	b9650513          	add	a0,a0,-1130 # 7340 <malloc+0x1634>
    37b2:	00002097          	auipc	ra,0x2
    37b6:	4a2080e7          	jalr	1186(ra) # 5c54 <printf>
    exit(1);
    37ba:	4505                	li	a0,1
    ...
    37ca:	b9a50513          	add	a0,a0,-1126 # 7360 <malloc+0x1654>
    37ce:	00002097          	auipc	ra,0x2
    37d2:	486080e7          	jalr	1158(ra) # 5c54 <printf>
    exit(1);
    37d6:	4505                	li	a0,1
    ...
    37e6:	b9e50513          	add	a0,a0,-1122 # 7380 <malloc+0x1674>
    37ea:	00002097          	auipc	ra,0x2
    37ee:	46a080e7          	jalr	1130(ra) # 5c54 <printf>
    exit(1);
    37f2:	4505                	li	a0,1
    ...
    3802:	bc250513          	add	a0,a0,-1086 # 73c0 <malloc+0x16b4>
    3806:	00002097          	auipc	ra,0x2
    380a:	44e080e7          	jalr	1102(ra) # 5c54 <printf>
    exit(1);
    380e:	4505                	li	a0,1
    ...
    381e:	bd650513          	add	a0,a0,-1066 # 73f0 <malloc+0x16e4>
    3822:	00002097          	auipc	ra,0x2
    3826:	432080e7          	jalr	1074(ra) # 5c54 <printf>
    exit(1);
    382a:	4505                	li	a0,1
    ...
    383a:	bda50513          	add	a0,a0,-1062 # 7410 <malloc+0x1704>
    383e:	00002097          	auipc	ra,0x2
    3842:	416080e7          	jalr	1046(ra) # 5c54 <printf>
    exit(1);
    3846:	4505                	li	a0,1
    ...
    3856:	bde50513          	add	a0,a0,-1058 # 7430 <malloc+0x1724>
    385a:	00002097          	auipc	ra,0x2
    385e:	3fa080e7          	jalr	1018(ra) # 5c54 <printf>
    exit(1);
    3862:	4505                	li	a0,1
    ...
    3872:	be250513          	add	a0,a0,-1054 # 7450 <malloc+0x1744>
    3876:	00002097          	auipc	ra,0x2
    387a:	3de080e7          	jalr	990(ra) # 5c54 <printf>
    exit(1);
    387e:	4505                	li	a0,1
    ...
    388e:	bf650513          	add	a0,a0,-1034 # 7480 <malloc+0x1774>
    3892:	00002097          	auipc	ra,0x2
    3896:	3c2080e7          	jalr	962(ra) # 5c54 <printf>
    exit(1);
    389a:	4505                	li	a0,1
    ...
    38aa:	c0250513          	add	a0,a0,-1022 # 74a8 <malloc+0x179c>
    38ae:	00002097          	auipc	ra,0x2
    38b2:	3a6080e7          	jalr	934(ra) # 5c54 <printf>
    exit(1);
    38b6:	4505                	li	a0,1
    ...
    38c6:	c0e50513          	add	a0,a0,-1010 # 74d0 <malloc+0x17c4>
    38ca:	00002097          	auipc	ra,0x2
    38ce:	38a080e7          	jalr	906(ra) # 5c54 <printf>
    exit(1);
    38d2:	4505                	li	a0,1
    ...
    38e2:	c1a50513          	add	a0,a0,-998 # 74f8 <malloc+0x17ec>
    38e6:	00002097          	auipc	ra,0x2
    38ea:	36e080e7          	jalr	878(ra) # 5c54 <printf>
    exit(1);
    38ee:	4505                	li	a0,1
    ...
    38fe:	c1e50513          	add	a0,a0,-994 # 7518 <malloc+0x180c>
    3902:	00002097          	auipc	ra,0x2
    3906:	352080e7          	jalr	850(ra) # 5c54 <printf>
    exit(1);
    390a:	4505                	li	a0,1
    ...
    391a:	c2250513          	add	a0,a0,-990 # 7538 <malloc+0x182c>
    391e:	00002097          	auipc	ra,0x2
    3922:	336080e7          	jalr	822(ra) # 5c54 <printf>
    exit(1);
    3926:	4505                	li	a0,1
    ...
    3936:	c2e50513          	add	a0,a0,-978 # 7560 <malloc+0x1854>
    393a:	00002097          	auipc	ra,0x2
    393e:	31a080e7          	jalr	794(ra) # 5c54 <printf>
    exit(1);
    3942:	4505                	li	a0,1
    ...
    3952:	c3250513          	add	a0,a0,-974 # 7580 <malloc+0x1874>
    3956:	00002097          	auipc	ra,0x2
    395a:	2fe080e7          	jalr	766(ra) # 5c54 <printf>
    exit(1);
    395e:	4505                	li	a0,1
    ...
    396e:	c3650513          	add	a0,a0,-970 # 75a0 <malloc+0x1894>
    3972:	00002097          	auipc	ra,0x2
    3976:	2e2080e7          	jalr	738(ra) # 5c54 <printf>
    exit(1);
    397a:	4505                	li	a0,1
    ...
    398a:	c4250513          	add	a0,a0,-958 # 75c8 <malloc+0x18bc>
    398e:	00002097          	auipc	ra,0x2
    3992:	2c6080e7          	jalr	710(ra) # 5c54 <printf>
    exit(1);
    3996:	4505                	li	a0,1
    ...
    39a6:	8be50513          	add	a0,a0,-1858 # 7260 <malloc+0x1554>
    39aa:	00002097          	auipc	ra,0x2
    39ae:	2aa080e7          	jalr	682(ra) # 5c54 <printf>
    exit(1);
    39b2:	4505                	li	a0,1
    ...
    39c2:	c2a50513          	add	a0,a0,-982 # 75e8 <malloc+0x18dc>
    39c6:	00002097          	auipc	ra,0x2
    39ca:	28e080e7          	jalr	654(ra) # 5c54 <printf>
    exit(1);
    39ce:	4505                	li	a0,1
    ...
    39de:	c2e50513          	add	a0,a0,-978 # 7608 <malloc+0x18fc>
    39e2:	00002097          	auipc	ra,0x2
    39e6:	272080e7          	jalr	626(ra) # 5c54 <printf>
    exit(1);
    39ea:	4505                	li	a0,1
    ...
    39fa:	c4250513          	add	a0,a0,-958 # 7638 <malloc+0x192c>
    39fe:	00002097          	auipc	ra,0x2
    3a02:	256080e7          	jalr	598(ra) # 5c54 <printf>
    exit(1);
    3a06:	4505                	li	a0,1
    ...
    3a16:	c4650513          	add	a0,a0,-954 # 7658 <malloc+0x194c>
    3a1a:	00002097          	auipc	ra,0x2
    3a1e:	23a080e7          	jalr	570(ra) # 5c54 <printf>
    exit(1);
    3a22:	4505                	li	a0,1
...
0000000000003a2c <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    3a3c:	c3850513          	add	a0,a0,-968 # 7670 <malloc+0x1964>
  ...
  if(chdir("dots") != 0){
    ...
    3a4e:	c2650513          	add	a0,a0,-986 # 7670 <malloc+0x1964>
  ...
  if(unlink(".") == 0){
    ...
    3a60:	aa450513          	add	a0,a0,-1372 # 6500 <malloc+0x7f4>
  ...
  if(unlink("..") == 0){
    ...
    3a72:	65a50513          	add	a0,a0,1626 # 70c8 <malloc+0x13bc>
  ...
  if(chdir("/") != 0){
    ...
    3a84:	5f050513          	add	a0,a0,1520 # 7070 <malloc+0x1364>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a96:	c4650513          	add	a0,a0,-954 # 76d8 <malloc+0x19cc>
  ...
  if(unlink("dots/..") == 0){
    ...
    3aa8:	c5c50513          	add	a0,a0,-932 # 7700 <malloc+0x19f4>
  ...
  if(unlink("dots") != 0){
    ...
    3aba:	bba50513          	add	a0,a0,-1094 # 7670 <malloc+0x1964>
    ...
    3ad8:	ba450513          	add	a0,a0,-1116 # 7678 <malloc+0x196c>
    3adc:	00002097          	auipc	ra,0x2
    3ae0:	178080e7          	jalr	376(ra) # 5c54 <printf>
    exit(1);
    3ae4:	4505                	li	a0,1
    ...
    3af4:	ba050513          	add	a0,a0,-1120 # 7690 <malloc+0x1984>
    3af8:	00002097          	auipc	ra,0x2
    3afc:	15c080e7          	jalr	348(ra) # 5c54 <printf>
    exit(1);
    3b00:	4505                	li	a0,1
    ...
    3b10:	b9c50513          	add	a0,a0,-1124 # 76a8 <malloc+0x199c>
    3b14:	00002097          	auipc	ra,0x2
    3b18:	140080e7          	jalr	320(ra) # 5c54 <printf>
    exit(1);
    3b1c:	4505                	li	a0,1
    ...
    3b2c:	b9850513          	add	a0,a0,-1128 # 76c0 <malloc+0x19b4>
    3b30:	00002097          	auipc	ra,0x2
    3b34:	124080e7          	jalr	292(ra) # 5c54 <printf>
    exit(1);
    3b38:	4505                	li	a0,1
    ...
    3b48:	53450513          	add	a0,a0,1332 # 7078 <malloc+0x136c>
    3b4c:	00002097          	auipc	ra,0x2
    3b50:	108080e7          	jalr	264(ra) # 5c54 <printf>
    exit(1);
    3b54:	4505                	li	a0,1
    ...
    3b64:	b8050513          	add	a0,a0,-1152 # 76e0 <malloc+0x19d4>
    3b68:	00002097          	auipc	ra,0x2
    3b6c:	0ec080e7          	jalr	236(ra) # 5c54 <printf>
    exit(1);
    3b70:	4505                	li	a0,1
    ...
    3b80:	b8c50513          	add	a0,a0,-1140 # 7708 <malloc+0x19fc>
    3b84:	00002097          	auipc	ra,0x2
    3b88:	0d0080e7          	jalr	208(ra) # 5c54 <printf>
    exit(1);
    3b8c:	4505                	li	a0,1
    ...
    3b9c:	b9050513          	add	a0,a0,-1136 # 7728 <malloc+0x1a1c>
    3ba0:	00002097          	auipc	ra,0x2
    3ba4:	0b4080e7          	jalr	180(ra) # 5c54 <printf>
    exit(1);
    3ba8:	4505                	li	a0,1
...
0000000000003bb2 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3bc8:	b8450513          	add	a0,a0,-1148 # 7748 <malloc+0x1a3c>
  ...
  if(chdir("dirfile") == 0){
    ...
    3be4:	b6850513          	add	a0,a0,-1176 # 7748 <malloc+0x1a3c>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3bf8:	b9c50513          	add	a0,a0,-1124 # 7790 <malloc+0x1a84>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3c10:	b8450513          	add	a0,a0,-1148 # 7790 <malloc+0x1a84>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3c24:	b7050513          	add	a0,a0,-1168 # 7790 <malloc+0x1a84>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3c38:	b5c50513          	add	a0,a0,-1188 # 7790 <malloc+0x1a84>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3c4c:	b4858593          	add	a1,a1,-1208 # 7790 <malloc+0x1a84>
    3c50:	00002517          	auipc	a0,0x2
    3c54:	3a050513          	add	a0,a0,928 # 5ff0 <malloc+0x2e4>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c68:	ae450513          	add	a0,a0,-1308 # 7748 <malloc+0x1a3c>
  ...
  fd = open(".", O_RDWR);
    ...
    3c7e:	88650513          	add	a0,a0,-1914 # 6500 <malloc+0x7f4>
  ...
  fd = open(".", 0);
    ...
    3c94:	87050513          	add	a0,a0,-1936 # 6500 <malloc+0x7f4>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3ca8:	21458593          	add	a1,a1,532 # 5eb8 <malloc+0x1ac>
  ...
  close(fd);
    ...
    3cd4:	a8050513          	add	a0,a0,-1408 # 7750 <malloc+0x1a44>
    3cd8:	00002097          	auipc	ra,0x2
    3cdc:	f7c080e7          	jalr	-132(ra) # 5c54 <printf>
    exit(1);
    3ce0:	4505                	li	a0,1
    ...
    3cf0:	a8450513          	add	a0,a0,-1404 # 7770 <malloc+0x1a64>
    3cf4:	00002097          	auipc	ra,0x2
    3cf8:	f60080e7          	jalr	-160(ra) # 5c54 <printf>
    exit(1);
    3cfc:	4505                	li	a0,1
    ...
    3d0c:	a9850513          	add	a0,a0,-1384 # 77a0 <malloc+0x1a94>
    3d10:	00002097          	auipc	ra,0x2
    3d14:	f44080e7          	jalr	-188(ra) # 5c54 <printf>
    exit(1);
    3d18:	4505                	li	a0,1
    ...
    3d28:	a7c50513          	add	a0,a0,-1412 # 77a0 <malloc+0x1a94>
    3d2c:	00002097          	auipc	ra,0x2
    3d30:	f28080e7          	jalr	-216(ra) # 5c54 <printf>
    exit(1);
    3d34:	4505                	li	a0,1
    ...
    3d44:	a8850513          	add	a0,a0,-1400 # 77c8 <malloc+0x1abc>
    3d48:	00002097          	auipc	ra,0x2
    3d4c:	f0c080e7          	jalr	-244(ra) # 5c54 <printf>
    exit(1);
    3d50:	4505                	li	a0,1
    ...
    3d60:	a9450513          	add	a0,a0,-1388 # 77f0 <malloc+0x1ae4>
    3d64:	00002097          	auipc	ra,0x2
    3d68:	ef0080e7          	jalr	-272(ra) # 5c54 <printf>
    exit(1);
    3d6c:	4505                	li	a0,1
    ...
    3d7c:	aa050513          	add	a0,a0,-1376 # 7818 <malloc+0x1b0c>
    3d80:	00002097          	auipc	ra,0x2
    3d84:	ed4080e7          	jalr	-300(ra) # 5c54 <printf>
    exit(1);
    3d88:	4505                	li	a0,1
    ...
    3d98:	aac50513          	add	a0,a0,-1364 # 7840 <malloc+0x1b34>
    3d9c:	00002097          	auipc	ra,0x2
    3da0:	eb8080e7          	jalr	-328(ra) # 5c54 <printf>
    exit(1);
    3da4:	4505                	li	a0,1
    ...
    3db4:	ab050513          	add	a0,a0,-1360 # 7860 <malloc+0x1b54>
    3db8:	00002097          	auipc	ra,0x2
    3dbc:	e9c080e7          	jalr	-356(ra) # 5c54 <printf>
    exit(1);
    3dc0:	4505                	li	a0,1
    ...
    3dd0:	abc50513          	add	a0,a0,-1348 # 7888 <malloc+0x1b7c>
    3dd4:	00002097          	auipc	ra,0x2
    3dd8:	e80080e7          	jalr	-384(ra) # 5c54 <printf>
    exit(1);
    3ddc:	4505                	li	a0,1
...
0000000000003de6 <iref>:
{
    ...
    3e04:	aa0a0a13          	add	s4,s4,-1376 # 78a0 <malloc+0x1b94>
    mkdir("");
    3e08:	00003497          	auipc	s1,0x3
    3e0c:	5a048493          	add	s1,s1,1440 # 73a8 <malloc+0x169c>
    link("README", "");
    3e10:	00002a97          	auipc	s5,0x2
    3e14:	1e0a8a93          	add	s5,s5,480 # 5ff0 <malloc+0x2e4>
    fd = open("xx", O_CREATE);
    3e18:	00004997          	auipc	s3,0x4
    3e1c:	98098993          	add	s3,s3,-1664 # 7798 <malloc+0x1a8c>
    3e20:	a891                	j	3e74 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3e22:	85da                	mv	a1,s6
    3e24:	00004517          	auipc	a0,0x4
    3e28:	a8450513          	add	a0,a0,-1404 # 78a8 <malloc+0x1b9c>
    3e2c:	00002097          	auipc	ra,0x2
    3e30:	e28080e7          	jalr	-472(ra) # 5c54 <printf>
      exit(1);
    3e34:	4505                	li	a0,1
    ...
    3e44:	a8050513          	add	a0,a0,-1408 # 78c0 <malloc+0x1bb4>
    3e48:	00002097          	auipc	ra,0x2
    3e4c:	e0c080e7          	jalr	-500(ra) # 5c54 <printf>
      exit(1);
    3e50:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3ed8:	1f498993          	add	s3,s3,500 # 70c8 <malloc+0x13bc>
    unlink("irefd");
    3edc:	00004917          	auipc	s2,0x4
    3ee0:	9c490913          	add	s2,s2,-1596 # 78a0 <malloc+0x1b94>
    chdir("..");
    3ee4:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3f00:	17450513          	add	a0,a0,372 # 7070 <malloc+0x1364>
...
0000000000003f20 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3f30:	9ac50513          	add	a0,a0,-1620 # 78d8 <malloc+0x1bcc>
  ...
  if(pid == 0){
    ...
    3f54:	98850513          	add	a0,a0,-1656 # 78d8 <malloc+0x1bcc>
    ...
    3f6a:	99250513          	add	a0,a0,-1646 # 78f8 <malloc+0x1bec>
    3f6e:	00002097          	auipc	ra,0x2
    3f72:	ce6080e7          	jalr	-794(ra) # 5c54 <printf>
      exit(1);
    3f76:	4505                	li	a0,1
    ...
    3f86:	95e50513          	add	a0,a0,-1698 # 78e0 <malloc+0x1bd4>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	cca080e7          	jalr	-822(ra) # 5c54 <printf>
    exit(1);
    3f92:	4505                	li	a0,1
    ...
    3fa2:	70250513          	add	a0,a0,1794 # 66a0 <malloc+0x994>
    3fa6:	00002097          	auipc	ra,0x2
    3faa:	cae080e7          	jalr	-850(ra) # 5c54 <printf>
    exit(1);
    3fae:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3fd0:	90c50513          	add	a0,a0,-1780 # 78d8 <malloc+0x1bcc>
    ...
    3fe4:	8b050513          	add	a0,a0,-1872 # 6890 <malloc+0xb84>
    3fe8:	00002097          	auipc	ra,0x2
    3fec:	c6c080e7          	jalr	-916(ra) # 5c54 <printf>
    exit(1);
    3ff0:	4505                	li	a0,1
...
0000000000004012 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    4022:	90250513          	add	a0,a0,-1790 # 7920 <malloc+0x1c14>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    404e:	8d650513          	add	a0,a0,-1834 # 7920 <malloc+0x1c14>
  ...
  sleep(10); // one second
    ...
    4086:	7de50513          	add	a0,a0,2014 # 6860 <malloc+0xb54>
    408a:	00002097          	auipc	ra,0x2
    408e:	bca080e7          	jalr	-1078(ra) # 5c54 <printf>
    exit(1);
    4092:	4505                	li	a0,1
    ...
    40a0:	88448493          	add	s1,s1,-1916 # 7920 <malloc+0x1c14>
    40a4:	4581                	li	a1,0
    40a6:	8526                	mv	a0,s1
    ...
    40c8:	85c50513          	add	a0,a0,-1956 # 7920 <malloc+0x1c14>
...
00000000000040e8 <killstatus>:
{
  ...
  exit(0);
    ...
    414e:	55650513          	add	a0,a0,1366 # 66a0 <malloc+0x994>
    4152:	00002097          	auipc	ra,0x2
    4156:	b02080e7          	jalr	-1278(ra) # 5c54 <printf>
      exit(1);
    415a:	4505                	li	a0,1
    ...
    4174:	7c050513          	add	a0,a0,1984 # 7930 <malloc+0x1c24>
    4178:	00002097          	auipc	ra,0x2
    417c:	adc080e7          	jalr	-1316(ra) # 5c54 <printf>
       exit(1);
    4180:	4505                	li	a0,1
...
000000000000418a <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    41b4:	6b050513          	add	a0,a0,1712 # 6860 <malloc+0xb54>
    41b8:	00002097          	auipc	ra,0x2
    41bc:	a9c080e7          	jalr	-1380(ra) # 5c54 <printf>
    exit(1);
    41c0:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    41e2:	4c250513          	add	a0,a0,1218 # 66a0 <malloc+0x994>
    41e6:	00002097          	auipc	ra,0x2
    41ea:	a6e080e7          	jalr	-1426(ra) # 5c54 <printf>
    exit(1);
    41ee:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    4226:	c9658593          	add	a1,a1,-874 # 5eb8 <malloc+0x1ac>
    ...
    4250:	45450513          	add	a0,a0,1108 # 66a0 <malloc+0x994>
    4254:	00002097          	auipc	ra,0x2
    4258:	a00080e7          	jalr	-1536(ra) # 5c54 <printf>
     exit(1);
    425c:	4505                	li	a0,1
    ...
    426c:	6e850513          	add	a0,a0,1768 # 7950 <malloc+0x1c44>
    4270:	00002097          	auipc	ra,0x2
    4274:	9e4080e7          	jalr	-1564(ra) # 5c54 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    428c:	bf858593          	add	a1,a1,-1032 # be80 <buf>
    ...
    42a8:	6c450513          	add	a0,a0,1732 # 7968 <malloc+0x1c5c>
    42ac:	00002097          	auipc	ra,0x2
    42b0:	9a8080e7          	jalr	-1624(ra) # 5c54 <printf>
}
  ...
  printf("kill... ");
    ...
    42d4:	6b050513          	add	a0,a0,1712 # 7980 <malloc+0x1c74>
    42d8:	00002097          	auipc	ra,0x2
    42dc:	97c080e7          	jalr	-1668(ra) # 5c54 <printf>
  kill(pid1);
    42e0:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    4302:	69250513          	add	a0,a0,1682 # 7990 <malloc+0x1c84>
    4306:	00002097          	auipc	ra,0x2
    430a:	94e080e7          	jalr	-1714(ra) # 5c54 <printf>
  wait(0);
    430e:	4501                	li	a0,0
...
000000000000432e <reparent>:
{
  ...
  exit(0);
    ...
    4382:	32250513          	add	a0,a0,802 # 66a0 <malloc+0x994>
    4386:	00002097          	auipc	ra,0x2
    438a:	8ce080e7          	jalr	-1842(ra) # 5c54 <printf>
      exit(1);
    438e:	4505                	li	a0,1
    ...
    439e:	48e50513          	add	a0,a0,1166 # 6828 <malloc+0xb1c>
    43a2:	00002097          	auipc	ra,0x2
    43a6:	8b2080e7          	jalr	-1870(ra) # 5c54 <printf>
        exit(1);
    43aa:	4505                	li	a0,1
...
00000000000043de <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    4414:	39850513          	add	a0,a0,920 # 67a8 <malloc+0xa9c>
    4418:	00002097          	auipc	ra,0x2
    441c:	83c080e7          	jalr	-1988(ra) # 5c54 <printf>
    exit(1);
    4420:	4505                	li	a0,1
    ...
    4448:	a7458593          	add	a1,a1,-1420 # 5eb8 <malloc+0x1ac>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    450c:	49850513          	add	a0,a0,1176 # 79a0 <malloc+0x1c94>
    4510:	00001097          	auipc	ra,0x1
    4514:	744080e7          	jalr	1860(ra) # 5c54 <printf>
    exit(1);
    4518:	4505                	li	a0,1
    ...
    4528:	17c50513          	add	a0,a0,380 # 66a0 <malloc+0x994>
    452c:	00001097          	auipc	ra,0x1
    4530:	728080e7          	jalr	1832(ra) # 5c54 <printf>
    exit(1);
    4534:	4505                	li	a0,1
    ...
    455e:	6705                	lui	a4,0x1
      n += *(a+i);
    4560:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f1170>
    ...
    4574:	45050513          	add	a0,a0,1104 # 79c0 <malloc+0x1cb4>
    4578:	00001097          	auipc	ra,0x1
    457c:	6dc080e7          	jalr	1756(ra) # 5c54 <printf>
    exit(1);
    4580:	4505                	li	a0,1
...
0000000000004594 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    45de:	732080e7          	jalr	1842(ra) # 5d0c <malloc>
    ...
    4618:	3dc50513          	add	a0,a0,988 # 79f0 <malloc+0x1ce4>
    461c:	00001097          	auipc	ra,0x1
    4620:	638080e7          	jalr	1592(ra) # 5c54 <printf>
      exit(1);
    4624:	4505                	li	a0,1
...
0000000000004638 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    46da:	34a50513          	add	a0,a0,842 # 7a20 <malloc+0x1d14>
    46de:	00001097          	auipc	ra,0x1
    46e2:	576080e7          	jalr	1398(ra) # 5c54 <printf>
    exit(1);
    46e6:	4505                	li	a0,1
    ...
    46f6:	35650513          	add	a0,a0,854 # 7a48 <malloc+0x1d3c>
    46fa:	00001097          	auipc	ra,0x1
    46fe:	55a080e7          	jalr	1370(ra) # 5c54 <printf>
      exit(1);
    4702:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    473a:	2da50513          	add	a0,a0,730 # 7a10 <malloc+0x1d04>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    477a:	2f250513          	add	a0,a0,754 # 7a68 <malloc+0x1d5c>
    477e:	00001097          	auipc	ra,0x1
    4782:	4d6080e7          	jalr	1238(ra) # 5c54 <printf>
    exit(1);
    4786:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    47b6:	25e50513          	add	a0,a0,606 # 7a10 <malloc+0x1d04>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    47dc:	2b850513          	add	a0,a0,696 # 7a90 <malloc+0x1d84>
    47e0:	00001097          	auipc	ra,0x1
    47e4:	474080e7          	jalr	1140(ra) # 5c54 <printf>
    exit(1);
    47e8:	4505                	li	a0,1
...
00000000000047fc <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    4820:	28c78793          	add	a5,a5,652 # 7aa8 <malloc+0x1d9c>
    4824:	f6f43823          	sd	a5,-144(s0)
    4828:	00003797          	auipc	a5,0x3
    482c:	28878793          	add	a5,a5,648 # 7ab0 <malloc+0x1da4>
    4830:	f6f43c23          	sd	a5,-136(s0)
    4834:	00003797          	auipc	a5,0x3
    4838:	28478793          	add	a5,a5,644 # 7ab8 <malloc+0x1dac>
    483c:	f8f43023          	sd	a5,-128(s0)
    4840:	00003797          	auipc	a5,0x3
    4844:	28078793          	add	a5,a5,640 # 7ac0 <malloc+0x1db4>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    489c:	5e8a0a13          	add	s4,s4,1512 # be80 <buf>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    48b2:	21250513          	add	a0,a0,530 # 6ac0 <malloc+0xdb4>
    48b6:	00001097          	auipc	ra,0x1
    48ba:	39e080e7          	jalr	926(ra) # 5c54 <printf>
      exit(1);
    48be:	4505                	li	a0,1
    ...
    492c:	1a050513          	add	a0,a0,416 # 7ac8 <malloc+0x1dbc>
    4930:	00001097          	auipc	ra,0x1
    4934:	324080e7          	jalr	804(ra) # 5c54 <printf>
        exit(1);
    4938:	4505                	li	a0,1
    ...
    4946:	19650513          	add	a0,a0,406 # 7ad8 <malloc+0x1dcc>
    494a:	00001097          	auipc	ra,0x1
    494e:	30a080e7          	jalr	778(ra) # 5c54 <printf>
          exit(1);
    4952:	4505                	li	a0,1
    ...
    496c:	18850513          	add	a0,a0,392 # 7af0 <malloc+0x1de4>
    4970:	00001097          	auipc	ra,0x1
    4974:	2e4080e7          	jalr	740(ra) # 5c54 <printf>
          exit(1);
    4978:	4505                	li	a0,1
    ...
    499c:	4e878793          	add	a5,a5,1256 # be80 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    49f4:	11050513          	add	a0,a0,272 # 7b00 <malloc+0x1df4>
    49f8:	00001097          	auipc	ra,0x1
    49fc:	25c080e7          	jalr	604(ra) # 5c54 <printf>
      exit(1);
    4a00:	4505                	li	a0,1
...
0000000000004a28 <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4a56:	0c6b8b93          	add	s7,s7,198 # 7b18 <malloc+0x1e0c>
  for(i = 0; i < N; i++){
    ...
    4a98:	08c50513          	add	a0,a0,140 # 7b20 <malloc+0x1e14>
    4a9c:	00001097          	auipc	ra,0x1
    4aa0:	1b8080e7          	jalr	440(ra) # 5c54 <printf>
        exit(1);
    4aa4:	4505                	li	a0,1
    ...
    4ab6:	06650513          	add	a0,a0,102 # 7b18 <malloc+0x1e0c>
  ...
  fd = open(".", 0);
    ...
    4aee:	a1650513          	add	a0,a0,-1514 # 6500 <malloc+0x7f4>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b66:	fde50513          	add	a0,a0,-34 # 7b40 <malloc+0x1e34>
    4b6a:	00001097          	auipc	ra,0x1
    4b6e:	0ea080e7          	jalr	234(ra) # 5c54 <printf>
        exit(1);
    4b72:	4505                	li	a0,1
    ...
    4b86:	fde50513          	add	a0,a0,-34 # 7b60 <malloc+0x1e54>
    4b8a:	00001097          	auipc	ra,0x1
    4b8e:	0ca080e7          	jalr	202(ra) # 5c54 <printf>
        exit(1);
    4b92:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4bbe:	fce50513          	add	a0,a0,-50 # 7b88 <malloc+0x1e7c>
    4bc2:	00001097          	auipc	ra,0x1
    4bc6:	092080e7          	jalr	146(ra) # 5c54 <printf>
    exit(1);
    4bca:	4505                	li	a0,1
    ...
    4bda:	aca50513          	add	a0,a0,-1334 # 66a0 <malloc+0x994>
    4bde:	00001097          	auipc	ra,0x1
    4be2:	076080e7          	jalr	118(ra) # 5c54 <printf>
      exit(1);
    4be6:	4505                	li	a0,1
...
0000000000004d84 <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4dc4:	0c090913          	add	s2,s2,192 # be80 <buf>
  for(i = 0; i < N; i++){
    4dc8:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4e0c:	db850513          	add	a0,a0,-584 # 7bc0 <malloc+0x1eb4>
  ...
  for(i = 0; ; i++){
    ...
    4e22:	06290913          	add	s2,s2,98 # be80 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e70:	d6450513          	add	a0,a0,-668 # 7bd0 <malloc+0x1ec4>
    4e74:	00001097          	auipc	ra,0x1
    4e78:	de0080e7          	jalr	-544(ra) # 5c54 <printf>
    exit(1);
    4e7c:	4505                	li	a0,1
    ...
    4e8c:	d6850513          	add	a0,a0,-664 # 7bf0 <malloc+0x1ee4>
    4e90:	00001097          	auipc	ra,0x1
    4e94:	dc4080e7          	jalr	-572(ra) # 5c54 <printf>
      exit(1);
    4e98:	4505                	li	a0,1
    ...
    4ea8:	d6c50513          	add	a0,a0,-660 # 7c10 <malloc+0x1f04>
    4eac:	00001097          	auipc	ra,0x1
    4eb0:	da8080e7          	jalr	-600(ra) # 5c54 <printf>
    exit(1);
    4eb4:	4505                	li	a0,1
    ...
    4ec4:	d7050513          	add	a0,a0,-656 # 7c30 <malloc+0x1f24>
    4ec8:	00001097          	auipc	ra,0x1
    4ecc:	d8c080e7          	jalr	-628(ra) # 5c54 <printf>
      exit(1);
    4ed0:	4505                	li	a0,1
    ...
    4ee0:	d7450513          	add	a0,a0,-652 # 7c50 <malloc+0x1f44>
    4ee4:	00001097          	auipc	ra,0x1
    4ee8:	d70080e7          	jalr	-656(ra) # 5c54 <printf>
      exit(1);
    4eec:	4505                	li	a0,1
    ...
    4efc:	d7050513          	add	a0,a0,-656 # 7c68 <malloc+0x1f5c>
    4f00:	00001097          	auipc	ra,0x1
    4f04:	d54080e7          	jalr	-684(ra) # 5c54 <printf>
      exit(1);
    4f08:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4f2a:	c9a50513          	add	a0,a0,-870 # 7bc0 <malloc+0x1eb4>
    ...
    4f4e:	d3e50513          	add	a0,a0,-706 # 7c88 <malloc+0x1f7c>
    4f52:	00001097          	auipc	ra,0x1
    4f56:	d02080e7          	jalr	-766(ra) # 5c54 <printf>
    exit(1);
    4f5a:	4505                	li	a0,1
...
0000000000004f64 <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f84:	d2850513          	add	a0,a0,-728 # 7ca8 <malloc+0x1f9c>
    4f88:	00001097          	auipc	ra,0x1
    4f8c:	ccc080e7          	jalr	-820(ra) # 5c54 <printf>
  for(nfiles = 0; ; nfiles++){
    4f90:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4fa4:	d18c8c93          	add	s9,s9,-744 # 7cb8 <malloc+0x1fac>
    name[0] = 'f';
    ...
    4ff2:	c66080e7          	jalr	-922(ra) # 5c54 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    5014:	cb850513          	add	a0,a0,-840 # 7cc8 <malloc+0x1fbc>
    5018:	00001097          	auipc	ra,0x1
    501c:	c3c080e7          	jalr	-964(ra) # 5c54 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    508a:	c6250513          	add	a0,a0,-926 # 7ce8 <malloc+0x1fdc>
    508e:	00001097          	auipc	ra,0x1
    5092:	bc6080e7          	jalr	-1082(ra) # 5c54 <printf>
}
    ...
    50b8:	dcca8a93          	add	s5,s5,-564 # be80 <buf>
      if(cc < BSIZE)
    ...
    50e0:	bfc50513          	add	a0,a0,-1028 # 7cd8 <malloc+0x1fcc>
    50e4:	00001097          	auipc	ra,0x1
    50e8:	b70080e7          	jalr	-1168(ra) # 5c54 <printf>
    close(fd);
    50ec:	854a                	mv	a0,s2
...
00000000000050fe <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    5172:	b9250513          	add	a0,a0,-1134 # 7d00 <malloc+0x1ff4>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    518a:	d3258593          	add	a1,a1,-718 # 5eb8 <malloc+0x1ac>
    ...
    51a0:	b8450513          	add	a0,a0,-1148 # 7d20 <malloc+0x2014>
    51a4:	00001097          	auipc	ra,0x1
    51a8:	ab0080e7          	jalr	-1360(ra) # 5c54 <printf>
    exit(1);
    51ac:	4505                	li	a0,1
    ...
    51ba:	b5250513          	add	a0,a0,-1198 # 7d08 <malloc+0x1ffc>
    51be:	00001097          	auipc	ra,0x1
    51c2:	a96080e7          	jalr	-1386(ra) # 5c54 <printf>
      exit(1);
    51c6:	4505                	li	a0,1
    ...
    51d4:	b3850513          	add	a0,a0,-1224 # 7d08 <malloc+0x1ffc>
    51d8:	00001097          	auipc	ra,0x1
    51dc:	a7c080e7          	jalr	-1412(ra) # 5c54 <printf>
    exit(1);
    51e0:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51f8:	b0c50513          	add	a0,a0,-1268 # 7d00 <malloc+0x1ff4>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    524e:	c6e98993          	add	s3,s3,-914 # 5eb8 <malloc+0x1ac>
      uint64 a = (uint64) sbrk(4096);
    ...
    5280:	af450513          	add	a0,a0,-1292 # 7d70 <malloc+0x2064>
    5284:	00001097          	auipc	ra,0x1
    5288:	9d0080e7          	jalr	-1584(ra) # 5c54 <printf>
        exit(1);
    528c:	4505                	li	a0,1
    ...
    52a0:	a9450513          	add	a0,a0,-1388 # 7d30 <malloc+0x2024>
    52a4:	00001097          	auipc	ra,0x1
    52a8:	9b0080e7          	jalr	-1616(ra) # 5c54 <printf>
    exit(1);
    52ac:	4505                	li	a0,1
    ...
    52c0:	a9450513          	add	a0,a0,-1388 # 7d50 <malloc+0x2044>
    52c4:	00001097          	auipc	ra,0x1
    52c8:	990080e7          	jalr	-1648(ra) # 5c54 <printf>
    exit(1);
    52cc:	4505                	li	a0,1
  ...
  while(1){
    ...
    5314:	a8050513          	add	a0,a0,-1408 # 7d90 <malloc+0x2084>
    5318:	00001097          	auipc	ra,0x1
    531c:	93c080e7          	jalr	-1732(ra) # 5c54 <printf>
      exit(1);
    5320:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    5360:	a5450513          	add	a0,a0,-1452 # 7db0 <malloc+0x20a4>
    5364:	00001097          	auipc	ra,0x1
    5368:	8f0080e7          	jalr	-1808(ra) # 5c54 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    5390:	a4c50513          	add	a0,a0,-1460 # 7dd8 <malloc+0x20cc>
    5394:	00001097          	auipc	ra,0x1
    5398:	8c0080e7          	jalr	-1856(ra) # 5c54 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    53b4:	a1050513          	add	a0,a0,-1520 # 7dc0 <malloc+0x20b4>
    53b8:	00001097          	auipc	ra,0x1
    53bc:	89c080e7          	jalr	-1892(ra) # 5c54 <printf>
    exit(1);
    53c0:	4505                	li	a0,1
    ...
    53dc:	a0850513          	add	a0,a0,-1528 # 7de0 <malloc+0x20d4>
    53e0:	00001097          	auipc	ra,0x1
    53e4:	874080e7          	jalr	-1932(ra) # 5c54 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    5426:	dde78793          	add	a5,a5,-546 # 8200 <malloc+0x24f4>
    542a:	bd040713          	add	a4,s0,-1072
    542e:	00003317          	auipc	t1,0x3
    5432:	1c230313          	add	t1,t1,450 # 85f0 <malloc+0x28e4>
  ...
  printf("usertests starting\n");
    ...
    5466:	a3e50513          	add	a0,a0,-1474 # 7ea0 <malloc+0x2194>
    546a:	00000097          	auipc	ra,0x0
    546e:	7ea080e7          	jalr	2026(ra) # 5c54 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    54a0:	9bc50513          	add	a0,a0,-1604 # 7e58 <malloc+0x214c>
    54a4:	00000097          	auipc	ra,0x0
    54a8:	7b0080e7          	jalr	1968(ra) # 5c54 <printf>
    exit(1);
    54ac:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    54d0:	91c58593          	add	a1,a1,-1764 # 7de8 <malloc+0x20dc>
    ...
    54e6:	d1e78793          	add	a5,a5,-738 # 8200 <malloc+0x24f4>
    54ea:	bd040713          	add	a4,s0,-1072
    54ee:	00003317          	auipc	t1,0x3
    54f2:	10230313          	add	t1,t1,258 # 85f0 <malloc+0x28e4>
    ...
    5526:	99650513          	add	a0,a0,-1642 # 7eb8 <malloc+0x21ac>
    552a:	00000097          	auipc	ra,0x0
    552e:	72a080e7          	jalr	1834(ra) # 5c54 <printf>
        printf("SOME TESTS FAILED\n");
    5532:	00003a97          	auipc	s5,0x3
    5536:	90ea8a93          	add	s5,s5,-1778 # 7e40 <malloc+0x2134>
        if(continuous != 2)
    553a:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    553c:	00003b17          	auipc	s6,0x3
    5540:	8e4b0b13          	add	s6,s6,-1820 # 7e20 <malloc+0x2114>
    5544:	a8f5                	j	5640 <main+0x256>
  } else if(argc == 2 && strcmp(argv[1], "-C") == 0){
    5546:	00003597          	auipc	a1,0x3
    554a:	8aa58593          	add	a1,a1,-1878 # 7df0 <malloc+0x20e4>
    ...
    5584:	87850513          	add	a0,a0,-1928 # 7df8 <malloc+0x20ec>
    5588:	00000097          	auipc	ra,0x0
    558c:	6cc080e7          	jalr	1740(ra) # 5c54 <printf>
    exit(1);
    5590:	4505                	li	a0,1
    ...
    55ae:	6aa080e7          	jalr	1706(ra) # 5c54 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    55f6:	84e50513          	add	a0,a0,-1970 # 7e40 <malloc+0x2134>
    55fa:	00000097          	auipc	ra,0x0
    55fe:	65a080e7          	jalr	1626(ra) # 5c54 <printf>
    exit(1);
    5602:	4505                	li	a0,1
    ...
    5610:	87c50513          	add	a0,a0,-1924 # 7e88 <malloc+0x217c>
    5614:	00000097          	auipc	ra,0x0
    5618:	640080e7          	jalr	1600(ra) # 5c54 <printf>
    exit(0);
    561c:	4501                	li	a0,0
    ...
    562c:	62c080e7          	jalr	1580(ra) # 5c54 <printf>
        if(continuous != 2)
...
putc(int fd, char c)
{
    598c:	1101                	add	sp,sp,-32
    598e:	ec06                	sd	ra,24(sp)
    5990:	e822                	sd	s0,16(sp)
    5992:	1000                	add	s0,sp,32
    5994:	feb407a3          	sb	a1,-17(s0)
  write(fd, &c, 1);
    5998:	4605                	li	a2,1
    599a:	fef40593          	add	a1,s0,-17
    599e:	00000097          	auipc	ra,0x0
    59a2:	f56080e7          	jalr	-170(ra) # 58f4 <write>
}
    59a6:	60e2                	ld	ra,24(sp)
    59a8:	6442                	ld	s0,16(sp)
    59aa:	6105                	add	sp,sp,32
    59ac:	8082                	ret

00000000000059ae <printint>:

static void
printint(int fd, int xx, int base, int sgn)
{
    59ae:	7139                	add	sp,sp,-64
    59b0:	fc06                	sd	ra,56(sp)
    59b2:	f822                	sd	s0,48(sp)
    59b4:	f426                	sd	s1,40(sp)
    59b6:	0080                	add	s0,sp,64
    59b8:	84aa                	mv	s1,a0
  char buf[16];
  int i, neg;
  uint x;
  ...
  neg = 0;
  if(sgn && xx < 0){
    59ba:	c299                	beqz	a3,59c0 <printint+0x12>
    59bc:	0805cb63          	bltz	a1,5a52 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
    59c0:	2581                	sext.w	a1,a1
  neg = 0;
    59c2:	4881                	li	a7,0
    59c4:	fc040693          	add	a3,s0,-64
  }
  ...
  do{
    buf[i++] = digits[x % base];
    59ca:	2601                	sext.w	a2,a2
    59cc:	00003517          	auipc	a0,0x3
    59d0:	c7c50513          	add	a0,a0,-900 # 8648 <digits>
    59d4:	883a                	mv	a6,a4
    59d6:	2705                	addw	a4,a4,1
    59d8:	02c5f7bb          	remuw	a5,a1,a2
    59dc:	1782                	sll	a5,a5,0x20
    59de:	9381                	srl	a5,a5,0x20
    59e0:	97aa                	add	a5,a5,a0
    59e2:	0007c783          	lbu	a5,0(a5)
    59e6:	00f68023          	sb	a5,0(a3)
  }while((x /= base) != 0);
    59ea:	0005879b          	sext.w	a5,a1
    59ee:	02c5d5bb          	divuw	a1,a1,a2
    59f2:	0685                	add	a3,a3,1
    59f4:	fec7f0e3          	bgeu	a5,a2,59d4 <printint+0x26>
  if(neg)
    59f8:	00088c63          	beqz	a7,5a10 <printint+0x62>
    buf[i++] = '-';
    59fc:	fd070793          	add	a5,a4,-48
    5a00:	00878733          	add	a4,a5,s0
    5a04:	02d00793          	li	a5,45
    5a08:	fef70823          	sb	a5,-16(a4)
    5a0c:	0028071b          	addw	a4,a6,2

  while(--i >= 0)
    5a10:	02e05c63          	blez	a4,5a48 <printint+0x9a>
    5a14:	f04a                	sd	s2,32(sp)
    5a16:	ec4e                	sd	s3,24(sp)
    5a18:	fc040793          	add	a5,s0,-64
    5a1c:	00e78933          	add	s2,a5,a4
    5a20:	fff78993          	add	s3,a5,-1
    5a24:	99ba                	add	s3,s3,a4
    5a26:	377d                	addw	a4,a4,-1
    5a28:	1702                	sll	a4,a4,0x20
    5a2a:	9301                	srl	a4,a4,0x20
    5a2c:	40e989b3          	sub	s3,s3,a4
    putc(fd, buf[i]);
    5a30:	fff94583          	lbu	a1,-1(s2)
    5a34:	8526                	mv	a0,s1
    5a36:	00000097          	auipc	ra,0x0
    5a3a:	f56080e7          	jalr	-170(ra) # 598c <putc>
  while(--i >= 0)
    5a3e:	197d                	add	s2,s2,-1
    5a40:	ff3918e3          	bne	s2,s3,5a30 <printint+0x82>
    5a44:	7902                	ld	s2,32(sp)
    5a46:	69e2                	ld	s3,24(sp)
}
    5a48:	70e2                	ld	ra,56(sp)
    5a4a:	7442                	ld	s0,48(sp)
    5a4c:	74a2                	ld	s1,40(sp)
    5a4e:	6121                	add	sp,sp,64
    5a50:	8082                	ret
    x = -xx;
    5a52:	40b005bb          	negw	a1,a1
    neg = 1;
    5a56:	4885                	li	a7,1
    x = -xx;
    5a58:	b7b5                	j	59c4 <printint+0x16>

0000000000005a5a <vprintf>:
}
...
{
    5a5a:	715d                	add	sp,sp,-80
    5a5c:	e486                	sd	ra,72(sp)
    5a5e:	e0a2                	sd	s0,64(sp)
    5a60:	f84a                	sd	s2,48(sp)
    5a62:	0880                	add	s0,sp,80
  char *s;
  int c, i, state;

  state = 0;
  for(i = 0; fmt[i]; i++){
    5a64:	0005c903          	lbu	s2,0(a1)
    5a68:	1a090a63          	beqz	s2,5c1c <vprintf+0x1c2>
    5a6c:	fc26                	sd	s1,56(sp)
    5a6e:	f44e                	sd	s3,40(sp)
    5a70:	f052                	sd	s4,32(sp)
    5a72:	ec56                	sd	s5,24(sp)
    5a74:	e85a                	sd	s6,16(sp)
    5a76:	e45e                	sd	s7,8(sp)
    5a78:	8aaa                	mv	s5,a0
    5a7a:	8bb2                	mv	s7,a2
    5a7c:	00158493          	add	s1,a1,1
  state = 0;
    5a80:	4981                	li	s3,0
      if(c == '%'){
        state = '%';
    ...
    5a82:	02500a13          	li	s4,37
    5a86:	4b55                	li	s6,21
    5a88:	a839                	j	5aa6 <vprintf+0x4c>
        putc(fd, c);
    5a8a:	85ca                	mv	a1,s2
    5a8c:	8556                	mv	a0,s5
    5a8e:	00000097          	auipc	ra,0x0
    5a92:	efe080e7          	jalr	-258(ra) # 598c <putc>
    5a96:	a019                	j	5a9c <vprintf+0x42>
    } else if(state == '%'){
    5a98:	01498d63          	beq	s3,s4,5ab2 <vprintf+0x58>
  for(i = 0; fmt[i]; i++){
    5a9c:	0485                	add	s1,s1,1
    5a9e:	fff4c903          	lbu	s2,-1(s1)
    5aa2:	16090763          	beqz	s2,5c10 <vprintf+0x1b6>
    if(state == 0){
    5aa6:	fe0999e3          	bnez	s3,5a98 <vprintf+0x3e>
      if(c == '%'){
    5aaa:	ff4910e3          	bne	s2,s4,5a8a <vprintf+0x30>
        state = '%';
    5aae:	89d2                	mv	s3,s4
    5ab0:	b7f5                	j	5a9c <vprintf+0x42>
      if(c == 'd'){
    5ab2:	13490463          	beq	s2,s4,5bda <vprintf+0x180>
    5ab6:	f9d9079b          	addw	a5,s2,-99
    5aba:	0ff7f793          	zext.b	a5,a5
    5abe:	12fb6763          	bltu	s6,a5,5bec <vprintf+0x192>
    5ac2:	f9d9079b          	addw	a5,s2,-99
    5ac6:	0ff7f713          	zext.b	a4,a5
    5aca:	12eb6163          	bltu	s6,a4,5bec <vprintf+0x192>
    5ace:	00271793          	sll	a5,a4,0x2
    5ad2:	00003717          	auipc	a4,0x3
    5ad6:	b1e70713          	add	a4,a4,-1250 # 85f0 <malloc+0x28e4>
    5ada:	97ba                	add	a5,a5,a4
    5adc:	439c                	lw	a5,0(a5)
    5ade:	97ba                	add	a5,a5,a4
    5ae0:	8782                	jr	a5
        printint(fd, va_arg(ap, int), 10, 1);
    5ae2:	008b8913          	add	s2,s7,8
    5ae6:	4685                	li	a3,1
    5ae8:	4629                	li	a2,10
    5aea:	000ba583          	lw	a1,0(s7)
    5aee:	8556                	mv	a0,s5
    5af0:	00000097          	auipc	ra,0x0
    5af4:	ebe080e7          	jalr	-322(ra) # 59ae <printint>
    5af8:	8bca                	mv	s7,s2
      } else {
      ...
      state = 0;
    5afa:	4981                	li	s3,0
    5afc:	b745                	j	5a9c <vprintf+0x42>
        printint(fd, va_arg(ap, uint64), 10, 0);
    5afe:	008b8913          	add	s2,s7,8
    5b02:	4681                	li	a3,0
    5b04:	4629                	li	a2,10
    5b06:	000ba583          	lw	a1,0(s7)
    5b0a:	8556                	mv	a0,s5
    5b0c:	00000097          	auipc	ra,0x0
    5b10:	ea2080e7          	jalr	-350(ra) # 59ae <printint>
    5b14:	8bca                	mv	s7,s2
      state = 0;
    5b16:	4981                	li	s3,0
    5b18:	b751                	j	5a9c <vprintf+0x42>
        printint(fd, va_arg(ap, int), 16, 0);
    5b1a:	008b8913          	add	s2,s7,8
    5b1e:	4681                	li	a3,0
    5b20:	4641                	li	a2,16
    5b22:	000ba583          	lw	a1,0(s7)
    5b26:	8556                	mv	a0,s5
    5b28:	00000097          	auipc	ra,0x0
    5b2c:	e86080e7          	jalr	-378(ra) # 59ae <printint>
    5b30:	8bca                	mv	s7,s2
      state = 0;
    5b32:	4981                	li	s3,0
    5b34:	b7a5                	j	5a9c <vprintf+0x42>
    5b36:	e062                	sd	s8,0(sp)
        printptr(fd, va_arg(ap, uint64));
    5b38:	008b8c13          	add	s8,s7,8
    5b3c:	000bb983          	ld	s3,0(s7)
  putc(fd, '0');
    5b40:	03000593          	li	a1,48
    5b44:	8556                	mv	a0,s5
    5b46:	00000097          	auipc	ra,0x0
    5b4a:	e46080e7          	jalr	-442(ra) # 598c <putc>
  putc(fd, 'x');
    5b4e:	07800593          	li	a1,120
    5b52:	8556                	mv	a0,s5
    5b54:	00000097          	auipc	ra,0x0
    5b58:	e38080e7          	jalr	-456(ra) # 598c <putc>
    5b5c:	4941                	li	s2,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5b5e:	00003b97          	auipc	s7,0x3
    5b62:	aeab8b93          	add	s7,s7,-1302 # 8648 <digits>
    5b66:	03c9d793          	srl	a5,s3,0x3c
    5b6a:	97de                	add	a5,a5,s7
    5b6c:	0007c583          	lbu	a1,0(a5)
    5b70:	8556                	mv	a0,s5
    5b72:	00000097          	auipc	ra,0x0
    5b76:	e1a080e7          	jalr	-486(ra) # 598c <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b7a:	0992                	sll	s3,s3,0x4
    5b7c:	397d                	addw	s2,s2,-1
    5b7e:	fe0914e3          	bnez	s2,5b66 <vprintf+0x10c>
        printptr(fd, va_arg(ap, uint64));
    5b82:	8be2                	mv	s7,s8
      state = 0;
    5b84:	4981                	li	s3,0
    5b86:	6c02                	ld	s8,0(sp)
    5b88:	bf11                	j	5a9c <vprintf+0x42>
        s = va_arg(ap, char*);
    5b8a:	008b8993          	add	s3,s7,8
    5b8e:	000bb903          	ld	s2,0(s7)
        if(s == 0)
    5b92:	02090163          	beqz	s2,5bb4 <vprintf+0x15a>
        while(*s != 0){
    5b96:	00094583          	lbu	a1,0(s2)
    5b9a:	c9a5                	beqz	a1,5c0a <vprintf+0x1b0>
          putc(fd, *s);
    5b9c:	8556                	mv	a0,s5
    5b9e:	00000097          	auipc	ra,0x0
    5ba2:	dee080e7          	jalr	-530(ra) # 598c <putc>
          s++;
    5ba6:	0905                	add	s2,s2,1
        while(*s != 0){
    5ba8:	00094583          	lbu	a1,0(s2)
    5bac:	f9e5                	bnez	a1,5b9c <vprintf+0x142>
        s = va_arg(ap, char*);
    5bae:	8bce                	mv	s7,s3
      state = 0;
    5bb0:	4981                	li	s3,0
    5bb2:	b5ed                	j	5a9c <vprintf+0x42>
          s = "(null)";
    5bb4:	00002917          	auipc	s2,0x2
    5bb8:	62490913          	add	s2,s2,1572 # 81d8 <malloc+0x24cc>
        while(*s != 0){
    5bbc:	02800593          	li	a1,40
    5bc0:	bff1                	j	5b9c <vprintf+0x142>
        putc(fd, va_arg(ap, uint));
    5bc2:	008b8913          	add	s2,s7,8
    5bc6:	000bc583          	lbu	a1,0(s7)
    5bca:	8556                	mv	a0,s5
    5bcc:	00000097          	auipc	ra,0x0
    5bd0:	dc0080e7          	jalr	-576(ra) # 598c <putc>
    5bd4:	8bca                	mv	s7,s2
      state = 0;
    5bd6:	4981                	li	s3,0
    5bd8:	b5d1                	j	5a9c <vprintf+0x42>
        putc(fd, c);
    5bda:	02500593          	li	a1,37
    5bde:	8556                	mv	a0,s5
    5be0:	00000097          	auipc	ra,0x0
    5be4:	dac080e7          	jalr	-596(ra) # 598c <putc>
      state = 0;
    5be8:	4981                	li	s3,0
    5bea:	bd4d                	j	5a9c <vprintf+0x42>
        putc(fd, '%');
    5bec:	02500593          	li	a1,37
    5bf0:	8556                	mv	a0,s5
    5bf2:	00000097          	auipc	ra,0x0
    5bf6:	d9a080e7          	jalr	-614(ra) # 598c <putc>
        putc(fd, c);
    5bfa:	85ca                	mv	a1,s2
    5bfc:	8556                	mv	a0,s5
    5bfe:	00000097          	auipc	ra,0x0
    5c02:	d8e080e7          	jalr	-626(ra) # 598c <putc>
      state = 0;
    5c06:	4981                	li	s3,0
    5c08:	bd51                	j	5a9c <vprintf+0x42>
        s = va_arg(ap, char*);
    5c0a:	8bce                	mv	s7,s3
      state = 0;
    5c0c:	4981                	li	s3,0
    5c0e:	b579                	j	5a9c <vprintf+0x42>
    5c10:	74e2                	ld	s1,56(sp)
    5c12:	79a2                	ld	s3,40(sp)
    5c14:	7a02                	ld	s4,32(sp)
    5c16:	6ae2                	ld	s5,24(sp)
    5c18:	6b42                	ld	s6,16(sp)
    5c1a:	6ba2                	ld	s7,8(sp)
    }
  }
}
    5c1c:	60a6                	ld	ra,72(sp)
    5c1e:	6406                	ld	s0,64(sp)
    5c20:	7942                	ld	s2,48(sp)
    5c22:	6161                	add	sp,sp,80
    5c24:	8082                	ret

0000000000005c26 <fprintf>:

void
fprintf(int fd, const char *fmt, ...)
{
    5c26:	715d                	add	sp,sp,-80
    5c28:	ec06                	sd	ra,24(sp)
    5c2a:	e822                	sd	s0,16(sp)
    5c2c:	1000                	add	s0,sp,32
    5c2e:	e010                	sd	a2,0(s0)
    5c30:	e414                	sd	a3,8(s0)
    5c32:	e818                	sd	a4,16(s0)
    5c34:	ec1c                	sd	a5,24(s0)
    5c36:	03043023          	sd	a6,32(s0)
    5c3a:	03143423          	sd	a7,40(s0)
  va_list ap;

  va_start(ap, fmt);
    5c3e:	fe843423          	sd	s0,-24(s0)
  vprintf(fd, fmt, ap);
    5c42:	8622                	mv	a2,s0
    5c44:	00000097          	auipc	ra,0x0
    5c48:	e16080e7          	jalr	-490(ra) # 5a5a <vprintf>
}
    5c4c:	60e2                	ld	ra,24(sp)
    5c4e:	6442                	ld	s0,16(sp)
    5c50:	6161                	add	sp,sp,80
    5c52:	8082                	ret

0000000000005c54 <printf>:

void
printf(const char *fmt, ...)
{
    5c54:	711d                	add	sp,sp,-96
    5c56:	ec06                	sd	ra,24(sp)
    5c58:	e822                	sd	s0,16(sp)
    5c5a:	1000                	add	s0,sp,32
    5c5c:	e40c                	sd	a1,8(s0)
    5c5e:	e810                	sd	a2,16(s0)
    5c60:	ec14                	sd	a3,24(s0)
    5c62:	f018                	sd	a4,32(s0)
    5c64:	f41c                	sd	a5,40(s0)
    5c66:	03043823          	sd	a6,48(s0)
    5c6a:	03143c23          	sd	a7,56(s0)
  va_list ap;

  va_start(ap, fmt);
    5c6e:	00840613          	add	a2,s0,8
    5c72:	fec43423          	sd	a2,-24(s0)
  vprintf(1, fmt, ap);
    5c76:	85aa                	mv	a1,a0
    5c78:	4505                	li	a0,1
    5c7a:	00000097          	auipc	ra,0x0
    5c7e:	de0080e7          	jalr	-544(ra) # 5a5a <vprintf>
}
    5c82:	60e2                	ld	ra,24(sp)
    5c84:	6442                	ld	s0,16(sp)
    5c86:	6125                	add	sp,sp,96
    5c88:	8082                	ret

0000000000005c8a <free>:
static Header base;
static Header *freep;
...
free(void *ap)
{
    5c8a:	1141                	add	sp,sp,-16
    5c8c:	e422                	sd	s0,8(sp)
    5c8e:	0800                	add	s0,sp,16
  Header *bp, *p;

  bp = (Header*)ap - 1;
    5c90:	ff050693          	add	a3,a0,-16
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c94:	00003797          	auipc	a5,0x3
    5c98:	9cc7b783          	ld	a5,-1588(a5) # 8660 <freep>
    5c9c:	a02d                	j	5cc6 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c9e:	4618                	lw	a4,8(a2)
    5ca0:	9f2d                	addw	a4,a4,a1
    5ca2:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5ca6:	6398                	ld	a4,0(a5)
    5ca8:	6310                	ld	a2,0(a4)
    5caa:	a83d                	j	5ce8 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5cac:	ff852703          	lw	a4,-8(a0)
    5cb0:	9f31                	addw	a4,a4,a2
    5cb2:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5cb4:	ff053683          	ld	a3,-16(a0)
    5cb8:	a091                	j	5cfc <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5cba:	6398                	ld	a4,0(a5)
    5cbc:	00e7e463          	bltu	a5,a4,5cc4 <free+0x3a>
    5cc0:	00e6ea63          	bltu	a3,a4,5cd4 <free+0x4a>
{
    5cc4:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5cc6:	fed7fae3          	bgeu	a5,a3,5cba <free+0x30>
    5cca:	6398                	ld	a4,0(a5)
    5ccc:	00e6e463          	bltu	a3,a4,5cd4 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5cd0:	fee7eae3          	bltu	a5,a4,5cc4 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5cd4:	ff852583          	lw	a1,-8(a0)
    5cd8:	6390                	ld	a2,0(a5)
    5cda:	02059813          	sll	a6,a1,0x20
    5cde:	01c85713          	srl	a4,a6,0x1c
    5ce2:	9736                	add	a4,a4,a3
    5ce4:	fae60de3          	beq	a2,a4,5c9e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5ce8:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5cec:	4790                	lw	a2,8(a5)
    5cee:	02061593          	sll	a1,a2,0x20
    5cf2:	01c5d713          	srl	a4,a1,0x1c
    5cf6:	973e                	add	a4,a4,a5
    5cf8:	fae68ae3          	beq	a3,a4,5cac <free+0x22>
    p->s.ptr = bp->s.ptr;
    5cfc:	e394                	sd	a3,0(a5)
  } else
    p->s.ptr = bp;
  freep = p;
    5cfe:	00003717          	auipc	a4,0x3
    5d02:	96f73123          	sd	a5,-1694(a4) # 8660 <freep>
}
    5d06:	6422                	ld	s0,8(sp)
    5d08:	0141                	add	sp,sp,16
    5d0a:	8082                	ret

0000000000005d0c <malloc>:
  return freep;
}
...
malloc(uint nbytes)
{
    5d0c:	7139                	add	sp,sp,-64
    5d0e:	fc06                	sd	ra,56(sp)
    5d10:	f822                	sd	s0,48(sp)
    5d12:	f426                	sd	s1,40(sp)
    5d14:	ec4e                	sd	s3,24(sp)
    5d16:	0080                	add	s0,sp,64
  Header *p, *prevp;
  uint nunits;

  nunits = (nbytes + sizeof(Header) - 1)/sizeof(Header) + 1;
    5d18:	02051493          	sll	s1,a0,0x20
    5d1c:	9081                	srl	s1,s1,0x20
    5d1e:	04bd                	add	s1,s1,15
    5d20:	8091                	srl	s1,s1,0x4
    5d22:	0014899b          	addw	s3,s1,1
    5d26:	0485                	add	s1,s1,1
  if((prevp = freep) == 0){
    5d28:	00003517          	auipc	a0,0x3
    5d2c:	93853503          	ld	a0,-1736(a0) # 8660 <freep>
    5d30:	c915                	beqz	a0,5d64 <malloc+0x58>
  ...
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    ...
    5d36:	08977e63          	bgeu	a4,s1,5dd2 <malloc+0xc6>
    5d3a:	f04a                	sd	s2,32(sp)
    5d3c:	e852                	sd	s4,16(sp)
    5d3e:	e456                	sd	s5,8(sp)
    5d40:	e05a                	sd	s6,0(sp)
  if(nu < 4096)
    5d42:	8a4e                	mv	s4,s3
    5d44:	0009871b          	sext.w	a4,s3
    5d48:	6685                	lui	a3,0x1
    5d4a:	00d77363          	bgeu	a4,a3,5d50 <malloc+0x44>
    5d4e:	6a05                	lui	s4,0x1
    5d50:	000a0b1b          	sext.w	s6,s4
  p = sbrk(nu * sizeof(Header));
    5d54:	004a1a1b          	sllw	s4,s4,0x4
        p->s.size = nunits;
      }
      freep = prevp;
      return (void*)(p + 1);
    ...
    if(p == freep)
    5d58:	00003917          	auipc	s2,0x3
    5d5c:	90890913          	add	s2,s2,-1784 # 8660 <freep>
  if(p == (char*)-1)
    5d60:	5afd                	li	s5,-1
    5d62:	a091                	j	5da6 <malloc+0x9a>
    5d64:	f04a                	sd	s2,32(sp)
    5d66:	e852                	sd	s4,16(sp)
    5d68:	e456                	sd	s5,8(sp)
    5d6a:	e05a                	sd	s6,0(sp)
    base.s.ptr = freep = prevp = &base;
    5d6c:	00009797          	auipc	a5,0x9
    5d70:	11478793          	add	a5,a5,276 # ee80 <base>
    5d74:	00003717          	auipc	a4,0x3
    5d78:	8ef73623          	sd	a5,-1812(a4) # 8660 <freep>
    5d7c:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
    5d7e:	0007a423          	sw	zero,8(a5)
    if(p->s.size >= nunits){
    5d82:	b7c1                	j	5d42 <malloc+0x36>
        prevp->s.ptr = p->s.ptr;
    5d84:	6398                	ld	a4,0(a5)
    5d86:	e118                	sd	a4,0(a0)
    5d88:	a08d                	j	5dea <malloc+0xde>
  hp->s.size = nu;
    5d8a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d8e:	0541                	add	a0,a0,16
    5d90:	00000097          	auipc	ra,0x0
    5d94:	efa080e7          	jalr	-262(ra) # 5c8a <free>
  return freep;
    5d98:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d9c:	c13d                	beqz	a0,5e02 <malloc+0xf6>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d9e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5da0:	4798                	lw	a4,8(a5)
    5da2:	02977463          	bgeu	a4,s1,5dca <malloc+0xbe>
    if(p == freep)
    5da6:	00093703          	ld	a4,0(s2)
    5daa:	853e                	mv	a0,a5
    5dac:	fef719e3          	bne	a4,a5,5d9e <malloc+0x92>
  p = sbrk(nu * sizeof(Header));
    5db0:	8552                	mv	a0,s4
    5db2:	00000097          	auipc	ra,0x0
    5db6:	baa080e7          	jalr	-1110(ra) # 595c <sbrk>
  if(p == (char*)-1)
    5dba:	fd5518e3          	bne	a0,s5,5d8a <malloc+0x7e>
        return 0;
    5dbe:	4501                	li	a0,0
    5dc0:	7902                	ld	s2,32(sp)
    5dc2:	6a42                	ld	s4,16(sp)
    5dc4:	6aa2                	ld	s5,8(sp)
    5dc6:	6b02                	ld	s6,0(sp)
    5dc8:	a03d                	j	5df6 <malloc+0xea>
    5dca:	7902                	ld	s2,32(sp)
    5dcc:	6a42                	ld	s4,16(sp)
    5dce:	6aa2                	ld	s5,8(sp)
    5dd0:	6b02                	ld	s6,0(sp)
      if(p->s.size == nunits)
    5dd2:	fae489e3          	beq	s1,a4,5d84 <malloc+0x78>
        p->s.size -= nunits;
    5dd6:	4137073b          	subw	a4,a4,s3
    5dda:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5ddc:	02071693          	sll	a3,a4,0x20
    5de0:	01c6d713          	srl	a4,a3,0x1c
    5de4:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5de6:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5dea:	00003717          	auipc	a4,0x3
    5dee:	86a73b23          	sd	a0,-1930(a4) # 8660 <freep>
      return (void*)(p + 1);
    5df2:	01078513          	add	a0,a5,16
  }
}
    5df6:	70e2                	ld	ra,56(sp)
    5df8:	7442                	ld	s0,48(sp)
    5dfa:	74a2                	ld	s1,40(sp)
    5dfc:	69e2                	ld	s3,24(sp)
    5dfe:	6121                	add	sp,sp,64
    5e00:	8082                	ret
    5e02:	7902                	ld	s2,32(sp)
    5e04:	6a42                	ld	s4,16(sp)
    5e06:	6aa2                	ld	s5,8(sp)
    5e08:	6b02                	ld	s6,0(sp)
    5e0a:	b7f5                	j	5df6 <malloc+0xea>
