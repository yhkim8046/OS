...
main(int argc, char *argv[])
{
  ...
  1a:	8b278793          	add	a5,a5,-1870 # 8c8 <malloc+0x130>
  1e:	6398                	ld	a4,0(a5)
  ...
  30:	86c50513          	add	a0,a0,-1940 # 898 <malloc+0x100>
  ...
  6c:	84850513          	add	a0,a0,-1976 # 8b0 <malloc+0x118>
...
//    printf(fd, "%d\n", i);
  ...
  ba:	80a50513          	add	a0,a0,-2038 # 8c0 <malloc+0x128>
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 45c:	4e050513          	add	a0,a0,1248 # 938 <digits>
 460:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 562:	38270713          	add	a4,a4,898 # 8e0 <malloc+0x148>
 ...
 5ee:	34eb8b93          	add	s7,s7,846 # 938 <digits>
 ...
 644:	29890913          	add	s2,s2,664 # 8d8 <malloc+0x140>
        while(*s != 0){
...
malloc(uint nbytes)
{
 ...
 7e8:	16c90913          	add	s2,s2,364 # 950 <freep>
  if(p == (char*)-1)
 7ec:	5afd                	li	s5,-1
 ...
 7fc:	16078793          	add	a5,a5,352 # 958 <base>
 ...
 866:	c798                	sw	a4,8(a5)
        p += p->s.size;
 868:	02071693          	sll	a3,a4,0x20
 86c:	01c6d713          	srl	a4,a3,0x1c
